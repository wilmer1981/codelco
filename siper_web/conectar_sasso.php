...
$link = mysql_connect(CONEXION_HOST_BD,CONEXION_HOST_USER,CONEXION_HOST_PWD);
	...
	if (isset($CookieRut))
	{
		...
		$RespPass=mysql_query($ConsultaPass);
		if ($FilaPass=mysql_fetch_array($RespPass))
		{
			...
			$RespPass2=mysql_query($ConsultaPass2);			
			if ($FilaPass2=mysql_fetch_array($RespPass2))
			{
