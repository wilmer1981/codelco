    ...
    <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0">
	  <tr>
	    <td width="20%" align="center" class="TituloCabecera">Funcionario</td>
		 ...
		 <td width="20%" align="center" class="TituloCabecera">Observaci�n</td>
		 <td width="20%" align="center" class="TituloCabecera">Observaci�n (Solo Modificaci�n)</td>
		 <td width="20%" align="center" class="TituloCabecera">Observaci�n (Eliminaci�n)</td>
		 <td width="20%" align="center" class="TituloCabecera">Observaci�n (Sustituci�n)</td>
        </tr>
      <?
			...
			while ($Fila=mysql_fetch_array($Resp))
			{
				...
				else
				{
					...
					{
						if($Fila[Tipo_Eli_Sust]==1)//ELIMINACI�N
						{
