...
<table width="71%" align="center"  border="0" cellpadding="0"  cellspacing="0">
  ...
  <tr>
   ...
   <td align="center"><table width="96%" border="0" cellpadding="0"  cellspacing="0">
     <tr>
	 <td align="center" colspan="2" class="TituloCabecera2">Mantenedor de Exámenes</td>
	 </tr>
	 <tr>       
    ...
    <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0">
      <tr>
	    ...
	    <td width="65%" align="center" class="TituloCabecera">Descripci&oacute;n </td>
          <td width="10%" align="center" class="TituloCabecera">Parámetro</td>
      ...
      <?php
		...
		?>
			 	<tr>
				<td align="center" ><?php echo "<input name='CheckRut' class='SinBorde' type='checkbox'  value='".$Fila["CTEXAMEN"]."'"; ?></td>
				<td ><?php echo $Fila["NEXAMEN"]."&nbsp;"; ?></td>
				<td align="center" ><?php echo $Fila["QPARAMETRO"]; ?>&nbsp;</td>
  ...
  <tr>
    ...
    <td align="center"><table width="403" border="0" cellpadding="0" cellspacing="0">
	  ...
	  ?>
	    ...
	    <tr>
        <td class="formulario">Parámetro</td>
		<td > <input name="TxtQPARAMETRO" type="text" value="<?php echo $TxtQPARAMETRO; ?>" size="15"  maxlength="5" ><span class="InputRojo">(*)</span></td>
      </tr>
	   <tr>
