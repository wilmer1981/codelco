...
function BuscaHijos(Codigo,Filtro)
{
	...
	f.action='organica_operaciones.php';
	f.submit();
}
function BuscaItem()
{
	...
	if(top.frames['Cabecera'].document.FrmCabecera.CmbTareas.value!='S')
	{
		...
		top.frames['Procesos'].location='procesos_operaciones.php?&MostrarCmb=S&CodSelTarea='+f.SelTarea.value+'&TipoPestana='+top.frames['Cabecera'].document.FrmCabecera.PestanaActiva.value;
		f.submit();	
	}	
}
function BuscaItem2(Cod,Msj)
{
	...
	//BuscaHijos(Cod,'S')
	top.frames['Procesos'].location='procesos_operaciones.php?MostrarCmb=S&CodSelTarea='+f.SelTarea.value+'&TipoPestana='+top.frames['Cabecera'].document.FrmCabecera.PestanaActiva.value+'&Msj='+Msj;
	f.submit();	
...
function ItemSelec(Codigo)
{
	...
	if(top.frames['Cabecera'].document.FrmCabecera.PestanaActiva.value==2||top.frames['Cabecera'].document.FrmCabecera.PestanaActiva.value==3)
	{
	...
	top.frames['Procesos'].location='procesos_operaciones.php?CodSelTarea='+f.SelTarea.value+'&MostrarCmb=S&TipoPestana='+top.frames['Cabecera'].document.FrmCabecera.PestanaActiva.value;
	f.submit();	
}
</script>
</head>
