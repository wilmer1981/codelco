...
<td align="right">
 ...
 <tr>
   <td align="center" colspan="2">
		...
		<tr>
			<td width="50%" colspan="2" class="TituloCabecera" >Familia de Verificadores&nbsp;&nbsp;<a href=JavaScript:ObsVeri()><img src='imagenes/obs.png' alt="Descripci�n de los Verificadores" border=0 width='17' height='17'></a>
			&nbsp;&nbsp;&nbsp;
			<?
			...
			?>	
			<td width="40%" align="center" class="TituloCabecera" >Especificaci�n del Verificador</td>
		 </tr>		 
		 <?
		 ...
		 <?
			...
			while($Fila1=mysql_fetch_array($Resp1))
			{
			   ...
			   echo "</td>";			   
				...
				?>
				<td align='left'>
				<a href="JavaScript:AgregaObs('<? echo $Fila1[COD_VERIFICADOR];?>','<? echo $Cod;?>','<? echo $CodSelTarea;?>','<? echo $CodCCONTACTO;?>','AG')"><img src="imagenes/add.png" alt="Agregar Nueva Especificaci�n" border=0 width="10" height="10"></a><br />
				<!--<a href="JavaScript:AgregaObs('<? //echo $Fila[CCONTROL];?>','<? //echo $Cod;?>','<? //echo $CodSelTarea;?>','<? //echo $CodCCONTACTO;?>','AG')"><img src="imagenes/add.png" alt="Agregar Nueva Especificaci�n" border=0 width="10" height="10"></a><br />-->
				<table width="100%">
				<?
				$EncontroObs='N';
				...
				{	
					...
					<td width="10%" align="left"><a href="JavaScript:EliminaObs('<? echo $FilaC[CIDVERIFICADOR];?>','<? echo $Fila1[COD_VERIFICADOR];?>','<? echo $Cod;?>','<? echo $CodSelTarea;?>','<? echo $CodCCONTACTO;?>','EO')"><img src="imagenes/btn_eliminar2.png" alt='Elimina especificaci�n' border=0 width="18" height="18"></a></td>
					</tr>
					<?
					$ContObs=$ContObs+1;
				}
...
/*			   $Consulta="SELECT * from sgrs_siperverificadores_obs where COD_VERIFICADOR ='".$Fila1[COD_VERIFICADOR]."' and CPELIGRO='".$CmbPeligros."' and CAREA='".$Cod."' order by COD_VERIFICADOR asc";
			   ...
			   if($FilaC=mysql_fetch_array($ResultadoC))
			   {
					...
					{
						?>
						<td align='left'><a href="JavaScript:AgregaObs('<? echo $Fila1[COD_VERIFICADOR];?>','<? echo $Cod;?>','<? echo $CodSelTarea;?>','<? echo $CodCCONTACTO;?>','AG')"><img src="imagenes/add.png" alt="Agregar Nueva Especificaci�n" border=0 width="10" height="10"></a>			   
						<?
					}
			   }
			   else
				 ...
				 if($FilaE=mysql_fetch_array($RespE))
				 {
				   ...
				   ?>
					   <tr>
					   	...
					   	<td width="10%"><a href="javascript:ModObs('<? echo $FilaE2[CIDVERIFICADOR];?>','<? echo $Fila1[COD_VERIFICADOR];?>','<? echo $Cod;?>','<? echo $CodSelTarea;?>','<? echo $CodCCONTACTO;?>','MO','<? echo $ContObs;?>')"><img src='imagenes/btn_modificar.png' alt='Modificar Especificaci�n' border='0' width='25' align='absmiddle'></a>&nbsp;<a href="JavaScript:EliminaObs('<? echo $FilaE2[CIDVERIFICADOR];?>','<? echo $Fila1[COD_VERIFICADOR];?>','<? echo $Cod;?>','<? echo $CodSelTarea;?>','<? echo $CodCCONTACTO;?>','EO')"><img src="imagenes/btn_eliminar2.png" alt='Elimina Especificaci�n' border=0 width="18" height="18"></a></td>
					   </tr>
				   <?
				   		$ContObs=$ContObs+1;
				   	 }	
