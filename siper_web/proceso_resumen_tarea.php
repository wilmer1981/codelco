	    ...
	    <div id='Resumen'  style='overflow:auto;WIDTH: 100%; height:360px;left: 15px; top: 45px;'>
          <table width="140%" border="1" cellpadding="0" cellspacing="0" align="left">
			<tr>
				...
				<td align='left' width='30%' class='TituloCabecera' ><table width="100%" class="TituloCabecera"><td width="70%">Famila de Controles</td><td width="30%">Especificaci�n</td></table></td>
				<td width="35%" class="TituloCabecera"><table width="100%" class="TituloCabecera"><td width="70%">Familia de Verificadores</td><td width="30%">Especificaci�n</td></table></td>
