...
/*			if($MR!='T')
			...
			while($Fila=mysql_fetch_array($Resp))
			{
				...
				echo "<td align='center' width='20%' class='TituloCabecera' ><b>Descripci�n</b></td>";
				...
				echo "<td align='left' width='30%' class='TituloCabecera' ><table width='96%' border='1' cellspacing='0' cellpadding='0'><td><b>Familia de Controles </b></td><td><b>Especificaci�n del Control </b></td></table></td>";
				//echo "<td align='left' width='30%' class='TituloCabecera' ><table width='96%' border='1' cellspacing='0' cellpadding='0'><td><b>Familia del Verificadores </b></td><td><b>Especificaci�n del Verificador </b></td></table></td>";
				echo "<td align='center' width='5%' class='TituloCabecera' ><b>P</b></td>";
				echo "<td align='center' width='5%' class='TituloCabecera'><b>C</b></td>";
