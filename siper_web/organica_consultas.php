...
function BuscaHijos(Codigo,Filtro)
{
	...
	f.action='organica_consultas.php';
	f.submit();
	top.frames['Procesos'].location='procesos_consultas.php';
	f.submit();		
}
function BuscaItem()
{
	...
	if(top.frames['Cabecera'].document.FrmCabecera.CmbTareas.value!='S')
	{
		...
		top.frames['Procesos'].location='procesos_consultas.php?&MostrarCmb=S&CodSelTarea='+f.SelTarea.value+'&TipoPestana='+top.frames['Cabecera'].document.FrmCabecera.PestanaActiva.value;
		f.submit();	
	}	
}
function BuscaItem2(Cod,Msj)
{
	...
	//BuscaHijos(Cod,'S')
	top.frames['Procesos'].location='procesos_consultas.php?MostrarCmb=S&CodSelTarea='+f.SelTarea.value+'&TipoPestana='+top.frames['Cabecera'].document.FrmCabecera.PestanaActiva.value+'&Msj='+Msj;
	f.submit();	
...
function ItemSelec(Codigo)
{
	...
	top.frames['Procesos'].location='procesos_consultas.php?CodSelTarea='+f.SelTarea.value+'&MostrarCmb=S&TipoPestana='+top.frames['Cabecera'].document.FrmCabecera.PestanaActiva.value;
	f.submit();	
}
</script>
</head>
