...
function Proceso(Opc)
{
	...
	switch(Opc)
	{
		case "G":
			if(f.SelTarea.value=='')
			{
				alert('Debe Seleccionar �rea a Consultar');
				return;
			}
			//f.action='consulta_registro.php?SelTarea='+f.SelTarea.value;
			//f.submit();
			window.opener.document.FrmPrincipal.action ='consulta_registro_historico_peligros.php?Pro=R&NivelOrg='+f.SelTarea.value;
			window.opener.document.FrmPrincipal.submit();
			window.close();
		break;
		case "S":
			window.opener.document.FrmPrincipal.action ='consulta_registro_historico_peligros.php';
			window.opener.document.FrmPrincipal.submit();
			window.close();
		break;
	}	
...
function BuscaHijos(Codigo,Filtro)
{
	...
	f.action='consulta_registro_historico_arbol_peligros.php';
	f.submit();
}
...
function ItemSelec(Codigo)
{
	...
	f.location='consulta_registro_historico_arbol_peligros.php?CodSelTarea='+f.SelTarea.value;
	f.submit();	
}
...
function ItemSelec2(Codigo)
{
	...
	f.location='consulta_registro_historico_arbol_peligros.php?CodSelTarea='+f.SelTarea2.value;
	f.submit();	
}
