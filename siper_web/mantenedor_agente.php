...
function Proceso(Opc)
{
	...
	switch(Opc)
	{
		...
		break;
		case "C":
				f.action='mantenedor_agente.php?Buscar=S';
				f.submit();		
		break;
		case "E":
			if(SoloUnElemento(f.name,'CheckRut','E'))
			{
				...
				if(mensaje==true)
				{
					...
					f.action='mantenedor_agente01.php?Proceso=E&DatosUni='+DatosUni;
					f.submit();
				}
			}	
		break;
...
<table width="71%" align="center"  border="0" cellpadding="0"  cellspacing="0">
  ...
  <tr>
   ...
   <td align="center"><table width="96%" border="0" cellpadding="0"  cellspacing="0">
     <tr>
	 <td align="center" colspan="2" class="TituloCabecera2">Mantenedor de Agentes</td>
	 </tr>
	 <tr>       
