<?php
	...
	if($MRCAL=='1'&&$Carga=='S'&&isset($Opc))
	{
		...
		mysqli_query($link,$ActualizaContacto);
	}	
...
<title>Validación de Tarea</title>
<style type="text/css">
<!--
...
<table width="100%" border="0" cellpadding="0" cellspacing="4">
  ...
  ?>
	...
	<td width="39%" height="36" align="left"><font class="formulario">Usuario:&nbsp;<?php echo strtoupper($NombreJEFE);?>&nbsp;&nbsp;&nbsp;Perfil:&nbsp;<?php echo strtoupper($Perfil);?></font></td>
	...
	if($MRCAL=='1')
	{
		...
		{
		?>
		<!--<a href="javascript:EnviaCorreo('<?php //echo $CODAREA;?>','<?php //echo $CodCont?>','<?php //echo $MRCAL;?>','<?php //echo $CodSelTarea;?>');"><img src="imagenes/btn_mail.gif" width="30" height="30" border="0" alt="Envia Correo no Acuerdo"></a>-->
		<?php
		}
	}
	?>
...
<tr>
	...
	<td width="9%" class="TituloCabecera" align="center">Descripción</td>
	<td align='center' width='2%' class='TituloCabecera' >MRi</td>
	<td align='left' width='45%' class='TituloCabecera' ><table width="100%" border="0" cellpadding="0" cellspacing="0"><td width="60%">Familia de Controles</td><td width="40%" align="left">Especificación de Controles</td></table>	
	<td align='left' width='45%' class='TituloCabecera' ><table width="100%" border="0" cellpadding="0" cellspacing="0"><td width="50%">Familia de Verificadores</td><td width="50%" align="left">Especificación de Verificador</td></table>	
...
{	
	...
	$Asunto='No acuerdo en validación de tarea '.$NOMAREA.'.';
	...
	$Mensaje="<font face='Arial, Helvetica, sans-serif' size='2'>Estimados:<br> Debido a la diferencia de magnitud de los peligros, es necesario llegar a un acuerdo de magnitud.<br></font>";	
         $Mensaje.="Para su validación contáctese con Jefe y/o Experto, para reevaluar la aplicación de los controles necesarios para asegurar que la tarea se pueda realizar.<br>";
		 $Mensaje.="<table width='100%' border='1' cellpadding='0' cellspacing='0' align='left'>";
			$Mensaje.="<tr>";
				...
				$Mensaje.="<td align='left' width='30%' bgcolor='#CCCCCC' ><font face='Arial, Helvetica, sans-serif' color='#9c3031' size='1'><table width='100%' border='1' cellspacing='0' cellpadding='0'><tr><td><font face='Arial, Helvetica, sans-serif' color='#9c3031' size='1'>Famila de Controles</font></td><td><font face='Arial, Helvetica, sans-serif' color='#9c3031' size='1'>Especificación</font></td></tr></font></table></td>";
				$Mensaje.="<td width='35%' bgcolor='#CCCCCC'><font face='Arial, Helvetica, sans-serif' color='#9c3031' size='1'><table width='100%' border='1' cellspacing='0' cellpadding='0'><tr><td><font face='Arial, Helvetica, sans-serif' color='#9c3031' size='1'>Famila de Verificadores</font></td><td><font face='Arial, Helvetica, sans-serif' color='#9c3031' size='1'>Especificación</font></td></tr></font></table></td>";
...
*/				//$Mensaje.="<td align='center' width='4%'><font face='Arial, Helvetica, sans-serif' size='1'>".$Descrip."</font></td>";
	...
	$cuerpoMsj.= '<table  width="100%"  border="0" align="center">';
	$cuerpoMsj.= '<tr><td>';
	$cuerpoMsj.= "<font face='Arial, Helvetica, sans-serif' size='2'>Seguir el link para revisar diferencia en evaluación de la Magnitud de Riesgo Residual. : <a href='http://".$NomServ."/proyecto/siper_web/proceso_magnitud_riesgo.php?CodSelTarea=".$CodSelTarea."&NUE=S&MRCAL=".$MRCAL."&U=".$User."'><font size='2'>MRr.</font></a>";
	$cuerpoMsj.= "<br><br>";
