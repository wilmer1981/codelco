...
<form name="frmPrincipal" action="" method="post">
  <table width="500" border="0" cellspacing="0" cellpadding="3" class="TablaInterior">
    <tr class="ColorTabla01"> 
      <td colspan="2"><strong><font>CONSULTA DE LEYES DE IMPUREZA POR LOTES</font></strong> 
      </td>
    </tr>
    <tr> 
      <td colspan="2">&nbsp;</td>
  ...
  <br>//-->
<table width="690" border="0" align="center" cellpadding="0" cellspacing="0" class="TablaDetalle">
          <tr> 
            <td> <table width="690" border="0" cellpadding="1" cellspacing="1">                
		<?php			
		$LeyesUsadas = array();
		...
		{
			case "021":
				echo "<td width=60 align='center'><font color='#000000'><strong>HORN.</strong></font></td>\n";
				break;
			default:
				echo "<td width=60 align='center'><font color='#000000'><strong>LOTES</strong></font></td>\n";
				break;
		}        
		switch ($TipoProd)
		{
		...
		while ($Row = mysqli_fetch_array($result))
		{
			...
			if ($Row["ind"] == "&")
				...
				echo "&nbsp;";
			echo "</font></td>\n";
			echo "<td width=60 align='right'><font color='#ffff33'>".$Row["lote_agencia"]."</font></td>\n";
...
?>
    ...
    <tr> 
      <td><table width="100" border="0" align="center" cellpadding="7" cellspacing="1">
          <tr> 
            ...
            <td align="center" valign="middle"><input type="button" name="BtnCerrar" value="Cerrar Ventana" style="width:110" onClick="JavaScript:Proceso('C');">
            </td>
          </tr>
        </table></td>
    </tr>
