...
function Proceso(opcion)
{
	...
	{
		case "S":
			f.action = "imp_con_leyes_historicas_mensual.php?CmbAnoIni=<?php echo $CmbAnoIni; ?>&CmbAnoFin=<?php echo $CmbAnoFin; ?>&CmbSubProducto=<?php echo $CmbSubProducto; ?>&CmbProveedor=<?php echo $CmbProveedor; ?>&Plantilla=<?php echo $Plantilla; ?>";			
			f.submit();
			break;	
		case "E":
			f.action = "imp_con_leyes_historicas_lote_excel.php";			
			f.submit();
			break;
		case "I":
...
<?php		
		...
		foreach ($ArrLeyes as $k => $v) 
		{
			...
			{
				if (isset($ArrLimites[$k]["usada"]) && $ArrLimites[$k]["usada"]=="S")
				{
...
{
	if (isset($Limites[$CodLey]["usada"]) && $Limites[$CodLey]["usada"]=="S")
	{
		switch ($Tipo)
		{
			case "": //LAS DEL MES				
