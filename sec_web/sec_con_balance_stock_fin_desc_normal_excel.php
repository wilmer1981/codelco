...
<form name="frmPrincipal" action="" method="post">
  <table width="523" border="1" cellpadding="3" cellspacing="0" class="TablaInterior">
    <tr align="center">
      <td height="30" colspan="10"><strong>TIPO DEMOVIMIENTO EXISTENCIA FINAL</strong></td>
    </tr>
    <tr> 
...
?>
	...
	$Consulta.= " SELECT t1.cod_producto, t1.cod_subproducto, t2.cod_bulto, t2.num_bulto, year(t2.fecha_creacion_lote) as ano_creacion, sum(t1.peso_paquetes) as peso ";
	...
	$Consulta.= " where t1.cod_producto = '18' and t1.cod_subproducto in(42,43,44) ";
	...
	$Consulta = " SELECT t1.cod_producto, t1.cod_subproducto, sum(t1.peso_paquetes) as peso,t2.cod_bulto,t2.num_bulto ";
