	  ...
	  <table width="650" border="1" cellpadding="3" cellspacing="0" class="TablaDetalle">
		  ...
		  <?php
			...
			else
			{
				...
				echo "<td width='50' align='center'>N&deg; Lote</td>";
		...
		<?php			
			...
			while ($Fila=mysqli_fetch_array($Respuesta))
			{
				if (($TipoIE=='Normal')||($TipoIE=='Completas')||($TipoIE=='Ventanas')||($TipoIE=='NormalVentanas'))
				{
					...
					echo "<td align='right'>".($cantidad_programada*1000)."</td>";
					echo "<td align='right'>".$peso_preparado."&nbsp;</td>";
					echo "<td align='right'>".abs((int)$cantidad_programada*1000-(int)$peso_preparado)."&nbsp;</td>";
					if ($cod_bulto!="")
					{
				...
				else
				{
						...
						echo "<td>".$subproducto."&nbsp;</td>";
						echo "<td align='center'>".substr($Fila["fecha_disponible"],8,2)."/".substr($Fila["fecha_disponible"],5,2)."/".substr($Fila["fecha_disponible"],0,4)."</td>";
						echo "<td align='right'>".$cantidad_programada."</td>";
						echo "<td align='right'>".$peso_preparado."&nbsp;</td>";
						echo "<td align='right'>".abs($cantidad_programada-$peso_preparado)."&nbsp;</td>";
						if ($cod_bulto!="")
						{
							echo "<td align='right'>\n";
							echo $Fila2["cod_bulto"]."-".$Fila2["num_bulto"]."</a></td>\n";
