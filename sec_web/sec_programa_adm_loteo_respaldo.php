...
function Traspasar()
{
	...
	if (Valores!="")
	{
		if (confirm('�Esta Seguro de Traspasar loa Datos a PMN?'))
		{
...
function Traspasar_r()
{
	...
	if (Valores!="")
	{
		if (confirm('�Esta Seguro de Traspasar loa Datos a Raf?'))
		{
...
function Traspasar_v()
{
	...
	if (Valores!="")
	{
		if (confirm('�Esta Seguro de Despachar el Lote?'))
		{
		...
		<?php
			...
			while ($Fila=mysqli_fetch_array($Respuesta))
			{
				...
				else
				{
						...
						if ($Fila2["cod_bulto"]!="")
						{
							echo "<td width='70' align='right'><a href=\"JavaScript:MostrarPaquetes('".$Fila2["cod_bulto"]."','".$Fila2["num_bulto"]."','".$Fila["corr_ie"]."')\">\n";
							echo $Fila2["cod_bulto"]."-".$Fila2["num_bulto"]."</a></td>\n";
						}
						else
						{
			  ...
			  <?php
			  	 switch ($TipoIE)
				 {
				 	case "Normal":
						...
						echo "<input type='button' name='BtnFinalizar' value='Finalizar' style='width:90' onClick='Finalizar();'>";
						break;
					case "Virtual":
						echo "<input type='button' name='BtnDistribuir' value='Distribuir' style='width:90' onClick='Distribuir();'>&nbsp;";
//                        echo"<option value=>SELECCIONAR</option> ";
//                           $Consulta="select * from proyecto_modernizacion.sub_clase ";
//	/			           $Consulta.=" where cod_clase='3012' and cod_subclase between 1 and 12   ";
//                           $Respuesta=mysqli_query($link, $Consulta);
//				              while($Fila=mysqli_fetch_array($Respuesta))
//				                {
...
//                          echo" </select></td>";
						...
						echo "<input type='button' name='BtnTraspaso' value='Despachos Varios' style='width:110' onClick='Traspasar_v();'>";
						break;
				 	case "NormalVentanas":
						echo "<input type='button' name='BtnAsignar' value='Asignar' style='width:90' onClick='Asignar();'>&nbsp;";
