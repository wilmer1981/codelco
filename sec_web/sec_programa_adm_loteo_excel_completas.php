...
<html>
<head>
<title>Cumplimiento Programa de Loteo</title>
...
<form name="FrmProgLoteo" method="post" action="">
  	<table width="770" height="350" border="0" left="5" cellpadding="5" cellspacing="0">
		...
		<?php
			echo "<table width='730' border='1' cellpadding='1' cellspacing='0'>";
			switch ($TipoIE)
			{
				case "Completas":
			...
			while ($Fila=mysqli_fetch_array($Respuesta))
			{
				if ($TipoIE=='Completas')
				{
					...
					echo "<td width='40' align='center'>".$corr_ie."</td>";
