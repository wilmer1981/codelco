...
<?php
	...
	$LargoTabla = 550 + (count($ArrLeyes) * 25);
?>
  <table width="<?php echo $LargoTabla; ?>" border="1" cellpadding="3" cellspacing="0" class="TablaDetalle">
    <tr align="center" class="ColorTabla01"> 
      <td width="100" rowspan="2">LOTE</td>
      <td width="150" rowspan="2">SUBPRODUCTO</td>
      <td width="30" rowspan="2">N.ENVIO</td>
      <td width="30" rowspan="2">#O.E.</td>
      <td width="1510" rowspan="2">ASIGNACION</td>
      <td width="20" rowspan="2">N.CERT</td>
