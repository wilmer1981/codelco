...
<?php	
	...
	$Consulta = "SELECT distinct t1.flujo, t2.descripcion, t1.peso, t1.fino_cu, t1.fino_ag, t1.fino_au  ";
	$Consulta.= " FROM sec_web.flujos_mes t1 LEFT join proyecto_modernizacion.flujos t2 ";
	$Consulta.= " on t1.flujo = t2.cod_flujo and t2.sistema = 'SEC'";
...
<?php	
	...
	$Consulta = "SELECT distinct t1.nodo, t2.descripcion, t1.peso, t1.fino_cu, t1.fino_ag, t1.fino_au ";
	$Consulta.= " FROM sec_web.existencia_nodo t1 LEFT join proyecto_modernizacion.nodos t2 ";
	$Consulta.= " on t1.nodo = t2.cod_nodo and t2.sistema = 'SEC'";
	$Consulta.= " WHERE t1.ano = ".$Ano." AND t1.mes = ".$Mes;
