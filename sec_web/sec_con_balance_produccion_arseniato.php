			...
			echo'<tr>';
			  ...
			  {  	
				...
				/*   desde aqui */
				  ...
				  $ConsultaN.= " ORDER BY t1.nro_solicitud";	
				...
				/* hasta aca				*/
					$Consulta = "SELECT t1.nro_solicitud, t2.cod_leyes, t2.valor ";
				  	...
				  	$Consulta.= "  ORDER BY t1.nro_solicitud, t2.cod_leyes";	
				  	//echo $Consulta;
				  ...
				  //Acumuladores
				  	...
				  	echo'<td align="center"><a href=\'JavaScript:Historial('.$Fil["nro_solicitud"].')\'>'.$Fil["nro_solicitud"].'</a></td>';
				  	if ($AcumHumedad <> 0)
				  	{
				  	...
				  	{
				  		echo'<td align="center">'.number_format($AcumHumedad,0,",",".").'</td>';				  	
				  	}
