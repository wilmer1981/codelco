...
function Recarga()
{
	...
	Frm.action="sec_conf_inicial_lotes.php?CodMesI="+Frm.CmbCodPaqueteI.value + "&Cargar=S";
	Frm.submit();
}
function Recarga2()
{
	var Frm=document.FrmProceso;
	Frm.action="sec_conf_inicial_lotes.php?NumBulto="+Frm.NumBulto.value+"&Mes1="+Frm.CmbCodPaqueteI.value+"&Mes="+Frm.CmbCodBulto.value+"&Mes2="+Frm.CmbCodPaqueteF.value+"&Mostrar=S";
	Frm.submit();
}
...
{
	var Frm=document.FrmProceso;
	Frm.action="sec_conf_inicial_lotes_proceso01.php?Proceso=C";
	Frm.submit();
}
function MarcaCatodos()
{
	...
	//Frm.action="sec_asignar_marca.php";
	//Frm.submit();
...
<input name="FechaO" type="hidden" value="<?php echo $Fecha; ?>">
  ...
  <table width="770" height="157" border="0" cellpadding="5" cellspacing="0" class="TablaPrincipal" left="5">
    <tr>
    <td width="758"><table width="754" border="0" class="TablaInterior">
          <tr> 
            <td width="37"><font size="2">&nbsp; </font><font size="1"><font size="2"><font size="1"><font size="2"><font size="2"> 
		...
		{	
          ...
          <tr> 
            ...
            <td colspan="6"> <SELECT name="CmbCodBulto">
              ...
              - 
              <input name="NumBulto" type="text" id="NumBulto"  value="<?php echo $NumBulto; ?>" onBlur="Recarga2();"> 
            </td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
            <td colspan="2">N&deg; Serie Inicial Sub -Lote</td>
            <td colspan="6"> <SELECT name="CmbCodPaqueteI" onChange="Recarga2();">
                <?php
				if ($Mostrar!="S")
				{
					$Mes1=date("n");
          ...
          <tr> 
            ...
            <td colspan="6"><SELECT name="CmbCodPaqueteF">
				...
				else
				{
					...
					//echo "<option value=''>$Consulta</option>";	
					//echo $Consulta."<br>";
					$Respuesta=mysqli_query($link, $Consulta);
          ...
          <tr> 
            ...
            <td colspan="6"><input name="ENM" type="text" id="ENM"   value="<?php  echo $ENM;     ?>"></td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
