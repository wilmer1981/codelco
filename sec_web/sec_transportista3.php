...
function Proceso(TxtIE,CmbContrato,CmbDestino,TxtPeso)
{
	var Frm = document.FrmTransportista;
	var Checkeo=false;
	var Valores2="";
	...
	if(Checkeo==true)
	{
		...
		Frm.action="sec_ingreso_ie_ventanas01.php?Proceso=G&Confeccion=G&TxtIE="+TxtIE+"&CmbContrato="+CmbContrato+"&CmbDestino="+CmbDestino+"&TxtPeso="+TxtPeso+"&Valores2="+Valores2;
		/*alert(TxtIE);
		alert(CmbContrato);
		alert(CmbDestino);
		alert(TxtPeso);*/
...
<table width="650" border="0" cellpadding="3" cellspacing="1" class="TablaInterior">
  <tr> 
      ...
      <td width="343"><div align="center">&nbsp; 
          <input name="btnAceptar" type="button" id="btnAceptar" style="width:70px" onClick="Proceso('<?php echo $TxtIE?>','<?php echo $CmbContrato;?>','<?php echo $CmbDestino;?>','<?php echo $TxtPeso;?>');" value="Aceptar">
