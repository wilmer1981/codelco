...
else
{
	...
	{
		echo "<script languaje='JavaScript'>";
		echo " window.opener.document.FrmProceso.action='sec_ingreso_contrato_proceso.php?ValorCheck=".$ValCheck."&Productos=".$Productos."&SubProducto=".$SubProducto."&Modificar=".$Modificando."';";
	...
	{*/
		...
		if($Proceso == 1)
		{
			$Valores = "&ValorCheck=".$ValoresLeyes."&radio=".$radio."&radio1=".$radio1."&radio2=".$radio2."&Transporte=".$Transporte;
			echo "<script languaje='JavaScript'>";
			echo " window.opener.document.FrmProceso.action='sec_ingreso_contrato_proceso.php?Proceso=1".$Valores."';";
			echo " window.opener.document.FrmProceso.submit();";
			echo "window.close();</script>";
		}
		elseif($Proceso == 2)
		{
			$Valores = "&ValorCheck2=".$ValoresImpurezas."&radio=".$radio."&radio1=".$radio1."&radio2=".$radio2."&Transporte=".$Transporte;
			echo "<script languaje='JavaScript'>";
			echo " window.opener.document.FrmProceso.action='sec_ingreso_contrato_proceso.php?Proceso=2".$Valores."';";
			echo " window.opener.document.FrmProceso.submit();";
			echo "window.close();</script>";
		}
	//}		
