...
<form name="FrmStockSec" method="post" action="">
  <table width="622" border="1" cellspacing="0" cellpadding="2">
    ...
    <tr> 
      ...
      <td width="363">SALES</td>
    </tr>
    <tr> 
      <td><strong>SUBPRODUCTO</strong></td>
      <td>SULFATO DE COBRE PTE Y PLAMEN</td>
    </tr>
    <tr> 
    ...
    <tr align="center"> 
      <td height="52" colspan="2"><input type="button" name="BtnImprimir" value="Imprimir" style="width:90" onClick="Imprimir();"> 
				...
				if (($i=='7')||($i=='14')||($i=='21')||($i=='31'))
				{
					...
					while($Fila4=mysqli_fetch_array($Respuesta4))
					{
						...
						if ($Entro==true)
						{
							...
							echo "<td align='center'><a href=\"JavaScript:Historial(".$Fila4["nro_solicitud"].")\">".$Fila4["nro_solicitud"]."</a></td>\n";					
							$Entro=false;
						}
						if ($FinoLeyes=='L')
						{
