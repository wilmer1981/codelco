...
<form action="" method="post" name="frmPrincipal">
  <table width="622" border="1" cellspacing="0" cellpadding="2">
    <tr>
      <td height="30" colspan="10" align="center"><strong>TIPO DE MOVIMIENTO EMBARQUE </strong></td>
    </tr>
    <tr> 
      <td width="129" colspan="3"><strong>PRODUCTO</strong></td>
      <td width="479" colspan="7">DESPUNTE Y LAMINAS</td>
    </tr>
    <tr> 
