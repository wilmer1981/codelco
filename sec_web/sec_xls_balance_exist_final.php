...
<form name="frmPrincipal" action="" method="post">
  <table width="523" border="1" cellpadding="3" cellspacing="0" class="TablaInterior">
    <tr> 
      <td colspan="2"><strong>EXISTENCIA FINAL</strong></td>
    </tr>
    <tr> 
      <td colspan="2">&nbsp;</td>
    </tr>
  ...
  <?php  
	...
	while ($Fila = mysqli_fetch_array($Respuesta))
	{
		...
		if ($Encontro == false)
		{
			...
			{//LOTE EXTERNO
				$Consulta = "select distinct t1.lote_origen as cod_grupo, sum(t1.peso_paquete) as peso_paquetes, t1.fecha_creacion_paquete";
