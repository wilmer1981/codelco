...
<?php
	...
	$Consulta = "SELECT STRAIGHT_JOIN distinct t1.cod_leyes, t2.abreviatura, t2.cod_unidad, t3.abreviatura as unidad ";
	...
	$Largo = 500 + (count($ArrLeyes)*40);
	$ColSpan = count($ArrLeyes) + 4;
?>  
...
<?php
	...
	{		
		...
		{  	
			...
			echo'<td colspan="2">Total Semana</td>';
			...
			while ($Fila2 = mysqli_fetch_array($Resp2))
			{
				...
				if ($Fila2["cod_leyes"]=="04" || $Fila2["cod_leyes"]=="05")
				{
					//ACUMULA LAS LEYES SEMANALES PARA EL PONDERADO FINAL
...
//TOTALES MENSUALES	
	echo'<tr class="detalle01">';
	echo'<td colspan="2">Total Mes</td>';
