<?php
	//PAQUETE.
	$basculas = array(1=>"Bascula 5",2=>"Bascula 6");
	if ($opcion == "M")
	{
		$ano = $ano2;
		$mes = $mes2;
...
<table width="600" border="0" cellspacing="0" cellpadding="3" class="TablaInterior">
  <tr> 
    ...
    <td width="70"> <input name="checkpeso" type="checkbox" id="checkpeso" value="checkbox" <?php echo $peso_auto ?>> </td>
    <td width="80">Bascula</td> 
		<td width="70">
			<select name="cmbbascula" id="cmbbascula" onChange="ValBascula()">
		<?php
			if ($cmbbascula == "-1")
				echo '<option value="-1" selected>Bascula</option>';
			else 
				echo '<option value="-1">Bascula</option>';
		  	if ($cmbbascula == "5")
		  		echo '<option value="5" selected>Bascula 5</option>';
			else 
				echo '<option value="5">Bascula 5</option>';
			if ($cmbbascula == "6")
				echo '<option value="6" selected>Bascula 6</option>';
			else 
				echo '<option value="6">Bascula 6</option>';
		?>
          </select></td>


        <td width="75">Peso Inicial</td>
    	<td width="30"> <input name="checkpeso1" type="checkbox" id="checkpeso1" value="checkbox" <?php echo $pcontrol1; ?> onClick="VeControl1"> </td>
        <td width="75"> Peso Control</td>
    	<td width="30"> <input name="checkpeso2" type="checkbox" id="checkpeso2" value="checkbox" <?php echo $pcontrol2; ?> onClick="VeControl2"> </td>			
