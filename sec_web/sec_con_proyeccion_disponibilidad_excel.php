...
<html>
<head>
<title>CONSULTA PROYECCION DISPONIBILIDAD CATODOS GRADO A EXCEL</title>
...
<table border="1" align="center" cellpadding="2" cellspacing="0" >
  <tr class="ColorTabla02">
	...
	<td colspan="6" align="center">REQUERIMIENTOS</td>
    </tr>
  <tr class="ColorTabla02">
	...
	<td rowspan="2" align="center">DIF<br>DIA</td>
	<td rowspan="2" align="center">DIF<BR>ACUM</td>
...
if($Buscar=='S')
{
	...
	$UltDiasMes=date("Y-m-d", mktime(0,0,0,intval($mes)+1,1-1,$ano));
	...
	for($i=1;$i<=$Dias;$i++)
	{
		...
		$ProgValidado=$ProgPesaje-($ProgPesaje*$PorcRechazoProg);
		echo "<td align='center'>".number_format($ProgValidado,3,',','.')."</td>";
	...
	echo "<td align='center'>".number_format($TotProgValidado,0,',','.')."</td>";
	echo "<td align='center'>&nbsp;</td>";
...
function ObtienePesajeReal($FechaIni,$FechaFin,$LetraMes,$Peso,$link)
{
	...
	$Consulta.="where t2.cod_paquete='".$LetraMes."' and ((t2.fecha_creacion_paquete = '".$FechaIni."' and t2.hora>='08:00:00') or (t2.fecha_creacion_paquete = '".$FechaFin."' and t2.hora<='07:59:59')) and t1.fecha_creacion_paquete = t2.fecha_creacion_paquete and t2.cod_producto='18' and t2.cod_subproducto='40' group by t1.corr_enm";
	//echo $Consulta."<br>";
	$Respuesta=mysqli_query($link, $Consulta);
	...
	$Consulta.="where t2.cod_paquete='".$LetraMes."' and ((t2.fecha_creacion_paquete = '".$FechaIni."' and t2.hora>='08:00:00') or (t2.fecha_creacion_paquete = '".$FechaFin."' and t2.hora<='07:59:59')) and t1.fecha_creacion_paquete = t2.fecha_creacion_paquete and t2.cod_producto='18' and t2.cod_subproducto='40' group by t1.corr_enm,t1.cod_paquete";
