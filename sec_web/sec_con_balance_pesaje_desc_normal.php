...
?>
	...
	$Color = "";
	$TotalPeso = 0;	
	$Consulta = "SELECT STRAIGHT_JOIN t1.cod_producto, t1.cod_subproducto, ifnull(t2.cod_bulto,'') as cod_bulto, ifnull(t2.num_bulto,'0') as num_bulto, sum(t1.peso_paquetes) as peso";
	...
	while ($Fila = mysqli_fetch_array($Respuesta))
	{
		...
		if ($Encontro == false)
		{
			...
			/*echo $Fila["cod_bulto"]."<br>";
			echo $Fila["num_bulto"]."<br>";*/
