...
header("Location:sec_ing_produccion_popup2_2.php?cod_grupo=".$grupo."&cmbproducto=".$cmbproducto."&lado=".$lado."&cmbsubproducto=".$cmbsubproducto."&fecha=".$fecha."&Fecha2=".$fecha2);		
	break;
...
function EnvioCorreo($CodPaquete,$Lote,$Instruccion,$Peso,$Paquete,$Producto,$SubProducto)
{
	...
	if($Fila=mysqli_fetch_array($Resul))
	{
		...
		$cuerpoMsj.="(*) Este Correo ha sido Generado en forma automtica, por favor no responda este mensaje. Gracias.";
		$cuerpoMsj.= "<br>";
		...
		$mail->SMTPAuth=true;
		//$mail->From = "teasdet@codelco.cl";
		//$mail->Username = "teasdet";
		//$mail->Password = "asdet2011";
