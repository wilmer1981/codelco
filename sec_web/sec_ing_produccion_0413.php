...
function Recarga1()
{
	...
	if (f.cmbmovimiento.value == -1)
		f.action = "sec_ing_produccion_0413.php";
	else 
		f.action = "sec_ing_produccion_0413.php?recargapag1=S";
...
function Recarga2()
{
	...
	document.location = "sec_ing_produccion_0413.php?" + linea;
...
function AjustarPeso()
{
	...
	{	
		...
		f.action = "sec_ing_produccion01_0413.php?proceso=B12";
		f.submit();
	}
}
/****************/
...
*/	
	...
	f.action = "sec_ing_produccion01_0413.php?proceso=B8" + linea;
	f.submit();
}
/***************/
function CreaVirtual()
{
	...
	f.action = "sec_ing_produccion01_0413.php?proceso=V" + linea;
	f.submit();	
}
function AgregaPeso()
{
	...
	f.action = "sec_ing_produccion01_0413.php?proceso=AP" + linea;
	f.submit();	
}
/***************/
...
function Grabar()
{
	...
	if (ValidaCampos())
	{
		...
		if ((f.cmbmovimiento.value == 3) && (f.cmbproducto.value == 57) && (f.cmbsubproducto.value == 12))
			f.action = "sec_ing_produccion01_0413.php?proceso=GL" + linea;
		else 
		//alert (linea);
			f.action = "sec_ing_produccion01_0413.php?proceso=G" + linea;
		f.submit();
	}	
}     
...
function Modificar()
{
	...
	if ((f.cmbmovimiento.value == 3) && (f.cmbproducto.value == 57))
		f.action = "sec_ing_produccion01_0413.php?proceso=ML" + linea;
	else
		f.action = "sec_ing_produccion01_0413.php?proceso=M" + linea;
	f.submit();
...
function Eliminar()
{
	...
	//alert(linea);
		f.action = "sec_ing_produccion01_0413.php?proceso=E" + linea;
		f.submit();					
...
function Buscar()
{
	...
	f.action = "sec_ing_produccion01_0413.php?proceso=B" + linea;
	f.submit();
}
/***************/
function BuscarIE()
{	
	...
	document.location = "sec_ing_produccion01_0413.php?proceso=B7" + linea;
}
/***************/
function BuscarIE_Lodo() //Solo para los Lodos.
{
	...
	document.location = "sec_ing_produccion01_0413.php?proceso=B9" + linea;
}
/***************/
function BusarSerieLodo()
{
	...
	f.action = "sec_ing_produccion01_0413.php?proceso=B11" + linea;
	f.submit();
}
/***************/
function VerDatos()
{	
	...
	switch (f.cmbmovimiento.value)
	{
		...
		case '2' :  window.open("sec_ing_produccion_popup2.php?"+linea,"","top=195,left=180,width=540,height=350,scrollbars=no,resizable=no");
					break;
		case '3' :	window.open("sec_ing_produccion_popup3.php?"+linea,"","top=195,left=180,width=540,height=360,scrollbars=no,resizable=no");
					break;
	}
}
/***************/
...
function Limpiar()
{
	document.location = "sec_ing_produccion_0413.php";	
}
/***************/
function Salir()
{		
...
function RecargaGrupo()
{
	...
	f.action = "sec_ing_produccion_0413.php?" + linea;
	f.submit();
}
/************/
  ...
  <tr></tr>
    <td> Version 3 </td>
		...
		?>
             ...
             <?php //echo "Con".$consulta; ?> </SELECT></td>
          </tr>
        </table><br>
<?php
...
//echo "VV".$var1;
	if ($recargapag3 == "S") {	
		switch ($cmbmovimiento) {
			case 1:
				include("sec_ing_produccion_1_0413.php");
				break;
			case 2:
				include("sec_ing_produccion_2_0413.php");
				break;
			case 3:
				if ($cmbproducto == '57') //Lodos
					//include("sec_ing_produccion_4.php");	
					include("sec_ing_produccion_5_0413.php");	
				else
					include("sec_ing_produccion_3_0413.php");	
				break;
		}	 
	}
?>  
