<?php
	...
	//STOCK PAQUETES
	$Consulta = "SELECT cod_producto,cod_subproducto,sum(peso_paquetes) as peso_paquetes  ";
	$Consulta.= " from sec_web.paquete_catodo where cod_producto = '18' and";
	$Consulta.= "  (cod_subproducto = '40' or cod_subproducto = '46'or cod_subproducto = '2' or cod_subproducto ='18')";
	...
	//DIARIO DESC. NORMAL
		//$Consulta = "SELECT sum(peso_produccion) as peso from sec_web.produccion_catodo";
		//$Consulta.= " where CONCAT(fecha_produccion,' ',hora) BETWEEN '".$FechaInf." 08:00:00' AND '".$Fecha2." 07:59:59'";
		//$Consulta.= " and cod_producto = '18'";
		//$Consulta.= " and cod_subproducto = '3'";
		//$Respuesta = mysqli_query($link, $Consulta);
		//if ($Fila = mysqli_fetch_array($Respuesta))
		//{
			//$DescNormalDiario = $Fila["peso"];
		//}
	//ACUMULADO DESC. NORMAL
		//$Consulta = "SELECT sum(peso_produccion) as peso from sec_web.produccion_catodo";
		//$Consulta.= " where CONCAT(fecha_produccion,' ',hora) BETWEEN '".$Fecha1." 08:00:00' AND '".$Fecha2." 07:59:59'";
		//$Consulta.= " and cod_producto = '18'";
		//$Consulta.= " and cod_subproducto = '3'";
	...
	//ACUMULADO DESC. PARCIAL
		...
		//}
	//DIARIO DESP. LAM.
	$DespLamAcumulado=0;$DespLamDiario=0;
	...
	$FaenasAcumulado=0;$FaenasDiario=0;
	...
	//ACUMULADO FAENAS EXTERNAS
		...
		//$Consulta.= " where CONCAT(fecha_creacion_paquete,' ',hora) BETWEEN '".$Fecha1." 08:00:00' AND '".$Fecha2." 07:59:59'";
		//$Consulta.= " and cod_producto = '18'";
		//$Consulta.= " and (cod_subproducto in(6,8,9,10,12))";
		//$Respuesta = mysqli_query($link, $Consulta);
		//if ($Fila = mysqli_fetch_array($Respuesta))
		//{
...
<?php	
	...
	if ($ConsultaGeneral=="S")			
		echo "f.action = 'sec_informe_diario_general1.php';";
	else
...
<table width="650" border="1" cellspacing="0" cellpadding="2">
  ...
  <tr>
    <td class="ColorTabla01">Standard (%) </td>
