...
function Consultar()
{
	...
	Frm.action="sec_consulta_envios_ventanas.php?Orden="+Orden+"&Mostrar=S";
	Frm.submit();
}
function Excel()
{
	var Frm=document.FrmProceso;
	Frm.action="sec_xls_consulta_envios_ventanas.php?CmbMes="+Frm.CmbMes.value+"&CmbAno="+Frm.CmbAno.value;
	Frm.submit();
}
			...
			if ($Mostrar=='S')
			{
				...
				while ($Fila=mysqli_fetch_array($Respuesta))
				{
					...
					if($Fila7=mysqli_fetch_array($Respuesta7))
					{
						...
						echo "<td width='41' align='center'>VTAS</td>";				
					}
					else
					{
