...
if ($Opc=='M')
{
	...
	if($Fila=mysql_fetch_array($Resp))
	{
		...
		$TxtDescripcion=$Fila["descrip_turno"];
...
<?
	if ($Opc=='N')
		echo "<title>Nuevo Turno</title>";
		else	
			echo "<title>Modifica Turno</title>";
?>
...
function Proceso(Opcion)
{
	...
	switch(Opcion)
	{
		case "N":
			...
			if (Veri==true)
			{
				f.action = "sget_mantenedor_turnos01.php?Opcion="+ Opcion+"&Codigo="+f.TxtCodigo.value+"&Descri="+f.TxtDescripcion.value;
				f.submit();
			}
		break;
		case "M":
...
<input type="hidden" name="TxtCodigo" value="<? echo $TxtCodigo;?>">
  ...
  <tr>
   ...
   <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
     <tr>
       <td width="74%" align="left"><?	if($Opc=='N'){?><img src="archivos/sub_tit_turno_n.png"><? }else{?><img src="archivos/sub_tit_turno_m.png"><?	}?></td>
