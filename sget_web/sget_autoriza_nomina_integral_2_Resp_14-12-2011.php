	...
	{	
		...
		while ($FilaHD=mysql_fetch_array($RespHD))
		{
			...
			{	
				...
				$Consulta2.=" where num_hoja_ruta ='".$NumHoja."' and cod_hito='".$FilaHD[cod_hito]."'  and  (t2.fecha_das is null or t2.fecha_das='0000-00-00' or t2.fecha_vigencia_exa_preo is null or t2.fecha_vigencia_exa_preo='0000-00-00')";								
				//echo $Consulta2."<br>";
				$RespDet3=mysql_query($Consulta2);
				if($FilaDet3=mysql_fetch_array($RespDet3))
				{
