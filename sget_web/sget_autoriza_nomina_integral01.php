...
switch($Proceso)
{
	case "G"://Autoriza
		...
		if($NomPag!='sget_autorizacion_gestion_terceros.php')
		{
			$ConsultaFalta="SELECT t1.fecha_das,t1.fecha_vigencia_exa_preo from sget_personal t1 inner join sget_hoja_ruta_nomina_hitos_personas t2 on t1.rut=t2.rut_personal where t2.num_hoja_ruta='".$NumHoja."'";
