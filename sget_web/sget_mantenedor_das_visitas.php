    ...
    <tr>
      ...
      <td><table width="940" border="1" align="center" cellpadding="2" cellspacing="0">
            <tr>
              ...
              <td colspan="2" align="left" class="FilaAbeja2"><input name="TxtFechaD" type="text" id="TxtFechaD"   size="10" readonly="readonly" /> <img src="archivos/calendario.gif" alt="Pulse Aqui ParaSeleccionar Fecha" width="22" height="18" border="0" align="absmiddle" onClick="popFrame.fPopCalendar(TxtFechaD,TxtFechaD,popCal);return false" />&nbsp;&nbsp;
			  <a href="JavaScript:Proceso('M')"><img src="archivos/btn_guardar.png" border="0" alt="Modificar Fecha DAS" align="absmiddle"></a></td>
			  <td colspan="4" align="left" class="FilaAbeja2">- En verde visitas con proceso terminado (Entrada y Salida). </td>
			  </tr>
            <tr>
              ...
              <td width="8%" align="center" class="TituloTablaVerde">Ult Fecha&nbsp;Ingr.</td>
              <td width="8%" align="center" class="TituloTablaVerde">Rut</td>
			  <td width="16%" align="center" class="TituloTablaVerde">Nombre</td>
              <td width="22%" align="center" class="TituloTablaVerde">Empresa o Instituci&oacute;n </td>
			  <td width="15%" align="center" class="TituloTablaVerde">Contrato/OC</td>
              <td width="14%" align="center" class="TituloTablaVerde">Fecha&nbsp;DAS. (Inicio)</td>
              <td width="14%" align="center" class="TituloTablaVerde">Fecha&nbsp;DAS. (Venc.)</td>
              </tr>
            <?
			if($Cons=='S')
			{
				...
				$Consulta.=" group by rut order by apellido_paterno,apellido_materno,nombres,fecha_ingreso desc,empresa";	
				...
				?>				
						<tr>
						  <td width="3%" align="center" <? echo $ColorEstado;?>><? echo "<input name='CheckVisita' class='SinBorde' type='checkbox'  value='".$Fila["corr_visita"]."~".trim($Fila["rut"])."'>" ?></td>
						  <td width="8%"  <? echo $ColorEstado;?>align="center"><? echo $Fila["fecha_ingreso"];?></td>
						  <td width="8%"  <? echo $ColorEstado;?>align="left"><? echo $Fila["rut"];?></td>
						  <td width="16%"  <? echo $ColorEstado;?>align="left"><? echo ucwords(strtolower($Fila["apellido_paterno"]." ".$Fila["apellido_materno"]." ".$Fila["nombres"]));?>&nbsp;</td>
						  <td width="22%"  <? echo $ColorEstado;?>align="left"><? echo ucwords(strtolower($Fila["empresa"]));?>&nbsp;</td>
						  <td width="15%"  <? echo $ColorEstado;?>align="left"><? echo $Fila["contrato_orden"];?>&nbsp;</td>
						  <td width="14%" <? echo $ColorEstado;?> align="center"><? echo $FechaDAS;?>&nbsp;</td>
						  <td width="14%" <? echo $ColorEstado;?> align="center"><? echo $FechaTerminoDAS;?>&nbsp;</td>
					    </tr>
					<?		$Cont++;
				}
