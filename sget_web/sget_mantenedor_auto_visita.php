...
function ValidaUltIngreso($CorrV,$Rut,$FechaVisita)
{
	...
	$UltimoIngreso='';$Dia=0;
	$Consulta="SELECT fecha_ingreso from sget_visitas where rut='".$Rut."' and corr_visita <> '".$CorrV."' and estado='V' and hora_entrada!='0:00:00' and hora_salida!='0:00:00' order by fecha_ingreso desc";	
	$Resp=mysql_query($Consulta);
