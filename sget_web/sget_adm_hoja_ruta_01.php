...
switch($Proceso)
{
	case "A"://Autoriza
		...
		//ENVIO DE CORREO
			...
			$cuerpo.= "Estimado en Sistema Gesti�n de Terceros esta para su aprobaci�n la siguiente Hoja de Ruta";

			$cuerpo.= "\n";

			$cuerpo.= "N� Hoja Ruta             : " .$Correlativo1. "\n"; 
			...
			//$TxtDe=str_replace(";",",","lfara@codelco.cl");
