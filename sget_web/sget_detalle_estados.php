  ...
  <tr>
   ...
   <td>
	 ...
	 echo $Contrato;?></td>
	   ...
	   ?></td>
             <td class="formulariosimple" ><span class="formulario">motivo anulaci&oacute;n</span></td>
             <td class="formulariosimple" ><textarea name="obs" readonly="readonly" cols="70"><? echo $Obs;?></textarea>&nbsp;</td>
           </tr>
           <tr>
 ...
 -->
           <tr>
             <td colspan="6" ><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
                 <tr>
                   <td width="7%" rowspan="2" align="center" class="TituloCabecera">Rut</td>
                   <td width="22%" rowspan="2" align="center" class="TituloCabecera">Nombre Completo </td>
                   <td width="19%" rowspan="2" align="center" class="TituloCabecera">Cargo</td>
			...
			?>                   </td>
                   <td width="9%" rowspan="2" align="center" class="TituloCabecera">Fecha Das</td>
				   <td width="10%" rowspan="2" align="center" class="TituloCabecera">Vig.Exa.Preoc.</td>
		  ...
		  while($FilaDet=mysql_fetch_array($RespDet))
		  {
			?>
                 <tr>
                   <td><? echo $FilaDet["rut"]; ?></td>
                   <td><? echo $FilaDet["nombres"]." ".$FilaDet[ape_paterno]." ".$FilaDet[ape_materno]; ?></td>
                   <td><? echo $FilaDet[descrip_cargo]; ?>&nbsp;</td>
                   <td align="center">
				   <?
				   ...
				   <?
						...
						?>
                     &nbsp; </td>
				   <td align="center"><? echo $FilaDet[fecha_vigencia_exa_preo]; ?></td>
