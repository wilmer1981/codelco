<? 
	...
	if($Fila=mysql_fetch_array($Resp))
	{
		...
		$FReunionArranque=$Fila[fecha_venc_bol_garantia];
		$DetCtto='';
	...
	if ($CmbTipoCtto=='N')
	 $Consulta.= "where cod_clase='30004'  and cod_subclase='".$TipoCT."'";	
		...
		$Consulto="SELECT reunion_arranque from sget_sub_contratistas where cod_contrato='".$TxtCtto."' and rut_empresa='".$TxtRutPrv."-".$TxtDv."'";
		$Resp=mysql_query($Consulto);$FArranqueSUBCTTA='';
		if($Fila=mysql_fetch_assoc($Resp))
		{
			$FArranqueSUBCTTA=$Fila[reunion_arranque];
		}
	}	
?>
<html>
  ...
  <tr>
    ...
    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" >
          ...
          <tr>
            ...
            <td width="361" class="formulariosimple" ><?
				echo $TxtGerencia;
			 
			 ?>		&nbsp;</td>
            <td width="240" class="formulario2">Area</td>
            <td width="216" class="formulariosimple" ><?
				echo $TxtArea;
          ...
          <tr> 
            <td width="287" class="formulario2">Raz&oacute;n Social  </td>
            <td class="formulariosimple" ><? echo FormatearNombre($TxtRazonSocial); ?></td>
            <td class="formulario2" >Fecha Reunion Arranque SubCtta </td>
            <td class="formulariosimple" ><? echo $FArranqueSUBCTTA;?>&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <td class="formulario2" >Fecha Reunion Arranque Ctto </td>
            <td class="formulariosimple" ><? echo $FReunionArranque;?>&nbsp;</td>
          </tr>
        </table>	
