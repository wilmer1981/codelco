...
<html>
<head>
<title>Documentaci�n Contrato</title>
...
function Proceso(Opcion)
{
	...
	switch(Opcion)
	{
		case "G":
			...
			f.action='sget_doc_contrato01.php?Opt='+Opcion;
			f.submit();
			break;
		case "S":
...
function DelFile(arch)
{
	...
	if (msg==true)
	{
		f.action="sget_doc_contrato.php?Elim=S&ArchivoElim="+arch;
		f.submit();
	}
	else
	{
...
{
	var f=document.FrmPopupProceso;
	f.action="sget_doc_contrato.php?BuscarCtto=S";
	f.submit();
...
<table width="100%" align="center"  border="0" cellpadding="0"  cellspacing="0" class="TablaPricipalColor">
   <tr>
    ...
    <tr>
      ...
      <td><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
        ...
        <tr>
          <td align="right" class="formulario2">Contrato</td>
          ...
          <td colspan="3" class="formulario2">Buscar Por N&ordm;
            <input name="TxtContrato" type="text" id="TxtContrato" value="<? echo $TxtContrato; ?>" size="17">
		  <input name="BtnBuscar" type="button" value="Ok" onClick="BuscarCtto()">
          <SELECT name="CmbContrato" style="width:400" onChange="Recarga();">
  ...
  <table width="100%" align="center"  border="0" cellpadding="0"  cellspacing="0" class="TablaPricipalColor">
    <tr>
	  ...
	  <td width="1195" background="archivos/images/interior/form_arriba.gif"><img src="archivos/images/interior/transparent.gif" width="4" /></td>
