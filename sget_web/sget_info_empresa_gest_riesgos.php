  ...
  <tr>
   ...
   <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
       ...
       <tr>
         ...
         <td align="center"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" >
           ...
           <tr>
             ...
             <td width="148" class="formulariosimple" ><? echo $TxtCorreo ; ?></td>
             <td width="138" class="formulario2" >Telefono</td>
             <td width="291" class="formulariosimple" ><? echo $TxtFono ; ?></td>
           </tr>
           <tr>
       ...
       <tr>
         <td height="2" colspan="3"align="center" class="TituloTablaVerde"></td>
       </tr>
     </table>
     <br></td>
