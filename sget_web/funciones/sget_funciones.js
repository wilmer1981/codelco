...
{ 
   extensiones_Nopermitidas = new Array(".exe"); 
   mierror = ""; 
...
function Recuperar5(f)
{
	var LargoForm = eval("document."+f+".elements.length");
	var Valores="";
	for (i=0;i < LargoForm;i++)
	{ 
		if ((eval("document."+f+".elements["+i+"].name") == "TxtNumTarjeta"))
		{
			if ((eval("document."+f+".elements["+(i)+"].value") != "" ))
			{
				Valores = Valores +eval("document."+f+".elements["+(i)+"].value")+"~"+eval("document."+f+".elements["+(i+1)+"].value")+"//";
...
function Recuperar6(f)
{
	var LargoForm = eval("document."+f+".elements.length");
	var Valores2="";
	for (i=0;i < LargoForm;i++)
	{ 
		if ((eval("document."+f+".elements["+i+"].name") == "ChkDatos"))
		{
			Valores2 = Valores2 +eval("document."+f+".elements["+(i)+"].value")+"~"+eval("document."+f+".elements["+(i+1)+"].value")+"//";
		}
	}
	return(Valores2);
}
function Recuperar7(f)
{
	var LargoForm = eval("document."+f+".elements.length");
	var Valores2="";
	for (i=0;i < LargoForm;i++)
	{ 
		if ((eval("document."+f+".elements["+i+"].name") == "ChkDatos"))
		{
			Valores2 = Valores2 +eval("document."+f+".elements["+(i)+"].value")+"~"+eval("document."+f+".elements["+(i+1)+"].value")+"~"+eval("document."+f+".elements["+(i+2)+"].value")+"~"+eval("document."+f+".elements["+(i+3)+"].value")+"//";
		}
	}
	return(Valores2);
}
...
{	
	...
	if(tiene==false)
	{
		alert("Debe ingresar '-' antes del Dijito Verificador")		
		foco;
		return false;
