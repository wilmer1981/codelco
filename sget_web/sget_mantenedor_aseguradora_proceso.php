...
if ($Opc=='M')
{
	$Consulta="SELECT * from sget_aseguradoras t1 ";
	$Consulta.=" where t1.cod_aseguradora='".$Valores."' ";
	
	$Resp=mysqli_query($link, $Consulta);
	if($Fila=mysql_fetch_array($Resp))
	{
		$TxtCodigo=$Fila["cod_aseguradora"];
		$TxtDescripcion=$Fila["descripcion_aseguradora"];
		$CmbEstado=$Fila["estado"];
	}
}
else
{
	$Consulta="SELECT max(cod_aseguradora+1) as maximo from sget_aseguradoras ";
	$Resp=mysqli_query($link, $Consulta);
	if($Fila=mysql_fetch_array($Resp))
	{
...
<?
	if ($Opc=='N')
		echo "<title>Nuevo Aseguradora</title>";
		else	
			echo "<title>Modifica Aseguradora</title>";
?>
...
function Proceso(Opcion)
{
	...
	switch(Opcion)
	{
		case "N":
			...
			if (Veri==true)
			{
				f.action = "sget_mantenedor_aseguradora01.php?Opcion="+ Opcion+"&Codigo="+f.TxtCodigo.value+"&Descri="+f.TxtDescripcion.value;
				f.submit();
			}
		break;
		case "M":
...
<input type="hidden" name="Form" value="<? echo $Form;?>">
  ...
  <tr>
	...
	<td width="1065" height="15"background="archivos/images/interior/form_arriba.gif"><img src="archivos/images/interior/transparent.gif" width="4" height="15"></td>
  ...
  <tr>
   ...
   <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
     <tr>
       <td width="74%" align="left"><?	if($Opc=='N'){?><img src="archivos/sub_tit_aseguradora_n.png"><? }else{?><img src="archivos/sub_tit_aseguradora_m.png"><?	}?></td>
   ...
   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
     ...
     <tr>
       ...
       <td align="center"><table width="100%" border="0" cellpadding="3" cellspacing="0" >
         <tr>
           <td width="111" colspan="2" class="formulario2">&nbsp;</td>
         </tr>
         <tr>
