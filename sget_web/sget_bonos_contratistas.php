...
<html>
<head>
<title>Bonos Contratistas</title>
...
function Procesos(TipoProceso,Valor)
{
	...
	{
		case 'N'://GRABAR
			var URL = "../sget_web/sget_bonos_contratistas_proceso.php?Opcion=N";
		...
		case "M":
			...
			if(SoloUnElemento(f.name,'CheckCtto','M'))
			{
				...
				{
					URL="../sget_web/sget_bonos_contratistas_proceso.php?Opcion=M&CmbContrato="+Valores;
					window.open(URL,"","top=30,left=30,width=750,height=550,status=yes,menubar=no,resizable=yes,scrollbars=yes");
				}
			}	
		break;
		case "C":
			f.action = "sget_bonos_contratistas.php?Buscar=S";
			f.submit();
		break;
		...
		case "E"://ELIMINAR
			...
			{
				f.action = "sget_bonos_contratistas01.php?Opcion=E&Valores="+Valor;
				f.submit();
			}
			break;
		case "I"://IMPRIMIR
			...
			break;			
		case "S":
			window.location="../principal/sistemas_usuario.php?CodSistema=30&Nivel=1&CodPantalla=31";
		break;
	
	}
	
}
function Modificar(Ctto,Ano)
{
	URL="../sget_web/sget_bonos_contratistas_proceso.php?Opcion=M&CmbContrato="+Ctto+"&CmbAno="+Ano;
	window.open(URL,"","top=30,left=30,width=750,height=550,status=yes,menubar=no,resizable=yes,scrollbars=yes");
}
</script>
...
<?
 $IP_SERV = $HTTP_HOST;
 EncabezadoPagina($IP_SERV,'rpt_bonos.png')
 ?>
...
<table width="100%" align="center" cellpadding="2" cellspacing="0" class="ColorTabla02">
  <tr>
    <td width="16%" height="17" class='formulario2'>Contrato</td>
    <td width="84%" class='formulario2'><input name="TxtContrato" type="text" id="TxtContrato" value="<? echo $TxtContrato; ?>" size="25">  </tr>
  <tr>
...
<!--  <tr>
 ...
 <table width="950" align="center"  border="0" cellpadding="0"  cellspacing="0" class="TablaPricipalColor">
  <tr>
	  ...
	  <td width="1171" background="archivos/images/interior/form_arriba.gif"><img src="archivos/images/interior/transparent.gif" width="4" /></td>
...
<tr>
<td width="1%" class="TituloTablaVerde" align="center" rowspan="2">Mod</td>
<td width="1%" class="TituloTablaVerde" align="center" rowspan="2">A�o</td>
<td width="15%"class="TituloTablaVerde" align="center"  rowspan="2">Contrato</td>
<td width="20%" class="TituloTablaVerde" align="center" rowspan="2">Descripci&oacute;n</td>
<?
...
{
	echo "<td class='TituloTablaVerde' width='15%' colspan='2' align='center'>".$FilaBonos[nom_eva]."&nbsp;</td>";
}
?>
</tr>
<tr>
...
while($FilaBonos=mysql_fetch_array($RespBonos))
{
	echo "<td class='TituloCabecera' width='9%' align='center'>N� Beneficiarios</td>";
	echo "<td class='TituloCabecera' width='6%' align='center'>Monto($)</td>";	
}
?>
</tr>	

<?
	$Consulta="SELECT t1.cod_contrato,t1.ano,t2.descripcion ";
	...
	while($FilaCtto=mysql_fetch_array($RespCtto))
	{
	    ...
	    ?>
		<tr>
		<td><a href="JavaScript:Modificar('<? echo $FilaCtto["cod_contrato"];?>','<? echo $FilaCtto["ano"];?>')"><img src="archivos/btn_modificar.png"  alt="Modificar " align="absmiddle" border="0"></a></td>
		<td align="center"><? echo $A�o;?></td>
		<td><a href="sget_info_ctto.php?Ctto=<? echo $FilaCtto["cod_contrato"];?>" target="_blank"><img src="archivos/info2.png"  alt="Informaci�n Contrato" border="0" width='23' height='23' align="absmiddle" /></a>&nbsp;<?  echo $FilaCtto["cod_contrato"]; ?>&nbsp;</td>
  ...
  <tr>
      ...
      <td width="16"><img src="archivos/images/interior/esq4em.gif" width="15" height="15" /></td>
    </tr>
  </table>
<? 
}
