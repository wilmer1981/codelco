...
function Proceso(Opcion)
{
	...
	switch(Opcion)
	{
		...
		case "E":
			URL='sget_info_ctto_ac_gest_riesgo_excel.php?Ctto=<? echo $Ctto;?>';
...
<table width="63%" align="center"  border="0" cellpadding="0"  cellspacing="0" class="TablaPricipalColor">
  <tr>
	<td height="15"><img src="archivos/images/interior/esq1.gif" width="15" height="15"></td>
	<td width="746" height="15"background="archivos/images/interior/form_arriba.gif"><img src="archivos/images/interior/transparent.gif" width="4" height="15"></td>
