...
function enviar(f)
{
  ...
  f.action = 'result_pa.php?'+ parametros;
  f.submit();
}
...
<body bgcolor="#ffffff" text="#000000" link="#336699" vlink="#336699" alink="#336699" leftmargin="10" topmargin="5" onLoad="carga()">
...
<?    
  echo "<td>";
  echo "<table width=200 ID=campo3>";
  echo "<tr><td><input type=checkbox name=ck0 onClick='JavaScript:chequear(this.form)'>Todo</td></tr>";
  echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck1 >Turno</td></tr>";
  echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck2 >Caudal</td></tr>";
  echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck3 >Horas Op.</td></tr>";
  echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck4 >Azufre</td></tr>";
  echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck5 >Produccion</td></tr>"; 
  echo "</table>";  
  echo "</td>";
?>
</tr>
