...
function enviar(f)
{
  ...
  f.action = 'result_cps.php?'+ parametros;
  f.submit();
}
...
<?
  echo "<table border=0>";
  echo "<tr><td></td><td height=30 ID=campo1>Selecione los Sgts. Datos:</td></tr>";
  ...
  echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck1 onClick='JavaScript:verificar(this.form)'>Nº de Carga</td></tr>";
  echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck3 >Cantidad de Movimiento</td></tr>";
  echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck4 >Peso Movimiento</td></tr>";
  echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck2 >Cod. Unidad</td></tr>";  
