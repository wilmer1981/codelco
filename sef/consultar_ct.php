...
function enviar(f)
{
  ...
  f.action = 'result_ct.php?'+ parametros;
  f.submit();
}
...
function validar(f)
{
  ...
  if ((document.forms[0].ley.value == 1) || (document.forms[0].ley.value == 2))
  {
    if (f.ck7.checked)
      f.ck7.value = 1;
    else f.ck7.value = 0;
  ...
  if (document.forms[0].ley.value == 2)
  {
    if (f.ck8.checked)
      f.ck8.value = 1;
    else f.ck8.value = 0;
...
function chequear1(f)
{
  ...
  if ((valor == false) && (document.forms[0].opc.value == 1))
  {
    f.ck5.disabled = true;
    f.ck6.disabled = true;
  }
...
{
  if ((!f.ck1.checked) && (document.forms[0].opc.value == 1))
  {
    f.ck5.checked = false;
    f.ck6.checked = false;
    f.ck5.disabled = true;
  ...
  if ((!f.ck1.checked) && (document.forms[0].opc.value == 2))
  {
    f.ck2.checked = false;
    f.ck2.disabled = true;
    return;
...
function desabilita()
{  
  if ((!document.forms[0].ck1.checked) && (document.forms[0].opc.value == 1))
  {
    document.forms[0].ck5.disabled = true;
    document.forms[0].ck6.disabled = true;
  }  
  if ((!document.forms[0].ck1.checked) && (document.forms[0].opc.value == 2))
  {
    document.forms[0].ck2.disabled = true;
  }  
...
function limpiar(f)
{
  ...
  f.ck3.disabled = false;
  f.ck4.disabled = false;
  if (document.forms[0].opc.value == 1)
  {
    f.ck5.disabled = true;
    f.ck6.disabled = true;
  }
...
<?
  if ($opc == 1)
  {
    ...
    echo "<tr><td><input type=checkbox name=ck0 onClick='JavaScript:chequear1(this.form)'>Todo</td></tr>";
    ...
    echo "</td><td>";    
    echo "<table width=180 ID=campo3>";
    if (($ley == 1) or ($ley == 2))
    {
    ...
    if ($ley == 2)
    {
      echo "<tr><td>&nbsp;&nbsp;<input type=checkbox name=ck8 >Leyes Silice</td></tr>"; 
      echo "<tr><td>&nbsp;&nbsp;<input type=checkbox name=ck9 >Leyes Magnetita</td></tr>"; 
    }
    if ($ley == 1)
    {
      echo "<tr><td>&nbsp;</td></tr>"; 
  ...
  if ($opc == 2)
  {
    echo "<td>";
    echo "<table width= 280 ID=campo3>";
    echo "<tr><td><input type=checkbox name=ck0 onClick='JavaScript:chequear2(this.form)'>Todo</td></tr>";
    echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck1 onClick='JavaScript:verificar(this.form)'>Turno</td></tr>";
    echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck2 >Tobera</td></tr>";
    echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck3 >Aire Soplado</td></tr>";
    echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck4 >Oxigeno</td></tr>";
    echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck5 >Temperatura</td></tr>";
    echo "<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox name=ck6 >Gas</td></tr>";
    echo "</table>";  
    echo "</td>";
  }
?>
