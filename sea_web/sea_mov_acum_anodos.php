...
//echo $Consulta;
			...
			while($Fila = mysqli_fetch_array($resp))
			{
				echo'<tr>';
				 ...
				 // echo'<td align="right">'.number_format($Fil2["peso"]/1000,0,"",".").'</td>';
				  ...
				  echo'<td align="right">'.number_format($entero/1000,0,"",".").'</td>';
    ...
    <tr class="Detalle02">
      <td>RESTOS</td>
		...
		//echo "--".$AcumIni5." + ".$AcumProd5." - ".$AcumNave5." - ".$AcumRaf5." - ".$AcumEmb;
    ...
    <tr class="Detalle02">
	 <td>Restos</td> 	
		...
		//embarque
			...
			$entero3=0;
			$entero = number_format($peso_fisico/1000,0,"","");
			$entero1= number_format($peso_quimico/1000,0,"","");
			$entero2= number_format($peso_calafateo/1000,0,"","");
			$entero3= number_format($peso_analisis/1000,0,"","");
			$AprobRestos = $ExFinal5 - $entero - $entero1 - $entero2 - $entero3;
			$peso_total = $entero + $entero1 + $entero2 + $entero3;
			$AcumEmb11 = 0;
			...
			echo'<td align="right">'.number_format($AcumEmb11/1000,0,"",".").'</td>'; 
