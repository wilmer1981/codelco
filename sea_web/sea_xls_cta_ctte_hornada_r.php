...
<form name="frmPrincipal" action="" method="post">
  ...
  <table width="900" border="1" align="center" cellpadding="3" cellspacing="0" class="TablaDetalle">
	...
	if ((isset($Hornada)) && ($Hornada != ""))
	{
		...
		$Consulta.= " order by t1.cod_producto, t1.cod_subproducto, t1.hornada_ventana";
		...
		while ($Row = mysqli_fetch_array($Respuesta))
		{
			...
			echo "<td align='right'>";
			$SaldoUnidades = StockActual($Row[hornada_ventana],$Row["cod_producto"],$Row["cod_subproducto"]);
			echo $SaldoUnidades;
			echo "</td>\n";
			$SaldoPesos = StockPesoActual($Row[hornada_ventana],$Row["cod_producto"],$Row["cod_subproducto"]);
