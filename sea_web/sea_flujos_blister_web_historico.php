...
<table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr class="ColorTabla01">
    <td align="center">BLISTER a RAF</td>
  </tr>
 ...
 set_time_limit(300);
  ...
  //  nueva forma de c�lculo LFF 05-10-2016 por flujo en forma diaria
   ...
   // borrar en tabla los datos del mes a insertar del blister
	...
	$borrar.=  " AND   cod_flujo in (74,81,130,169,200,290) ";
  ...
  // $ConsultaFlujo.= " ORDER BY  flujo ";
     $ConsultaFlujo = " SELECT distinct cod_flujo FROM  proyecto_modernizacion.flujos " ;
	 $ConsultaFlujo.=  " where cod_flujo in (74,81,130,169,200,290) order by cod_flujo " ;
	//echo $ConsultaFlujo."<br>"; 
   ...
   {	
     ...
     {
      $cod_flujo = $Fila_flujo["cod_flujo"];
      $PesoFlujo = 0;
      $peso_ton = 0;
      $ley_as = 0;
      $ley_s = 0;
	// echo "flujo 1: ".$cod_flujo." ";
     ...
     // busca las hornadas para el flujo
      ...
      $Consulta.= " WHERE t1.flujo = '".$Fila_flujo["cod_flujo"]."'";
    ...
    //	echo $Consulta."<br>";
      ...
      while ($Fila_horna = mysqli_fetch_array($Resp7))		//recorre las hornadas
      {
       ...
       // $peso_ton = number_format($PesoFlujo /1000,0,'','');
		$peso_ton =  $PesoFlujo;
        ...
        if ($PesoFlujo = 0  )
		 { 
           ...
           $Consulta.= " WHERE flujo = '".$Fila_flujo["cod_flujo"]."'";
           $Consulta.= " AND tipo_movimiento = 4 AND cod_producto = 16 " ;
           // $Consulta.= " AND fecha_movimiento BETWEEN '".$fecha_aux."' AND '".$FechaFinAux."'";
           $Consulta.= " and hora between '".$fecha_aux." 08:00:00' and '".$FechaFinAux." 07:59:59'";
          ...
          // $peso_total =  $Fila_tot["peso"]/1000;
		  // $peso_ton = number_format($Fila_tot["peso"]/1000,0,'',''); 
		  }  
