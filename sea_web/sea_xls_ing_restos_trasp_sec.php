        ...
        <table width="400" border="0" cellspacing="0" cellpadding="3" class="TablaInterior">
          ...
          <tr>
			...
			if($cmbproducto!='0-0')
			{
				...
				$Consulta.=" left join sea_web.traspasos_sec t3 on t1.cod_bulto=t3.cod_bulto and t1.num_bulto=t3.num_bulto and year(t3.fecha)= year(t1.fecha_creacion_lote) and t3.cod_producto='19' and t3.cod_subproducto='".$SubProd."' ";				
			...
			if($recargapag=='S')
			{
				...
				while ($row = mysqli_fetch_array($rs))
				{
					...
					{				
						...
						echo '<td align="center">'.substr($hornadas,6,6).'</td>';
