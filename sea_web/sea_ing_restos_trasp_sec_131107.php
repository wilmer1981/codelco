...
function Recarga2(f)
{
	vector = f.cmbproducto.value.split("-");
	chequeado = "S";
	f.action = "sea_ing_restos_trasp_sec.php?cmbproducto=" + f.cmbproducto.value + "&activar=" + chequeado;		
	f.submit();	
}
function VerDatos()
{
...
function Traspaso()
{
	...
	if (Valores!='')
	{
		...
		{
			f.action="sea_ing_restos_trasp_sec01.php?Proceso=G&Valores="+Valores;
			f.submit();	
		}	
	}
	else
