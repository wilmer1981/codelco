...
if($Proceso == "G")
{
	...
	if ($tipo=='B')
	{
		...
		$Consulta.=" cod_subproducto = '4' and hornada = '".$Fila[hornada_ventana]."' and fecha_movimiento = '".$fecha."'";
		...
		if ($Row2=mysqli_fetch_array($RspH))
		{
			...
			$actualiza.=" where tipo_movimiento = '1' and cod_producto = '16' and  cod_subproducto = '4' and hornada = '".$Fila[hornada_ventana]."'";
		...
		else
		{
			...
			$Inserta.="campo1,campo2,unidades,flujo,peso,estado,lote_ventana,hora) values ('1','16','4','".$Fila[hornada_ventana]."',0,'".$fecha."',";
			$Inserta.=" '".$guia."', '".$patente."','".$unidad_recepcion."','000','".$peso_recepcion."','0','".$LoteVentana."','".$fechaHora."')";
			//echo "tres".$Inserta;
			mysqli_query($link, $Inserta);
		}
		$ConsultaH="SELECT * from sea_web.hornadas where cod_producto = '16' and cod_subproducto ='4' and hornada_ventana = '".$Fila[hornada_ventana]."'";
		...
		if ($FilaH=mysqli_fetch_array($resph))
		{
			...
			$ActualizaH.=" where cod_producto = '16' and cod_subproducto ='4' and hornada_ventana = '".$Fila[hornada_ventana]."'";
		...
		else
		{
			...
			$InsertaH.=" values('16','4','".$Fila[hornada_ventana]."','".$unidad_recepcion."','".$peso_recepcion."','N','1')";
			//echo "cinco".$InsertaH;
