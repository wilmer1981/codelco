...
<form name="formulario" method="post" action="">
  ...
  <table width="88%" class="TablaInterior" cellpadding="3" cellspacing="0">
    ...
    if($listados == 'S')       	
   {
		...
		{	
			if($cmblistados == 4)
			echo '<option value="4" SELECTed>Producci�n Acumulada por Grupos de Restos</option>';
			else
			echo '<option value="4">Producci�n Acumulada por Grupos de Restos</option>';

			if($cmblistados == 5)
			echo '<option value="5" SELECTed>Producci�n Acumulada de Restos</option>';
			else
			echo '<option value="5">Producci�n Acumulada de Restos</option>';

			if($cmblistados == 6)
			echo '<option value="6" SELECTed>Producci�n Diaria Acumulada de Restos</option>';
			else
			echo '<option value="6">Producci�n Diaria Acumulada de Restos</option>';
...
/***********  restos anodos ********/
		 ...
		 {
			echo '<td width="105">Restos de �nodos</td>';
