...
?>
<?php
function ActualizaPeso($Fecha, $Prod, $SubProd, $Hornada, $PesoSea, $PesoSipa, $PesoZuncho, $Unidades, $Guia, $Patente)
{
...
<?php include("../principal/encabezado.php"); ?>
  <table width="770" height="330" border="0" class="TablaPrincipal">
    <tr>
	  ...
	  ?>
        ...
        <table width="750" border="1" align="center" cellpadding="0" cellspacing="0" class="TablaDetalle">
          ...
          <?php
	 drop table tmp_yo;
	$Consulta = " create table tmp_yo as select t1.fecha_movimiento, t1.tipo_movimiento,  t3.descripcion as nom_producto, ";
	...
	$Consulta.= " on t1.cod_producto = t2.cod_producto and t1.cod_subproducto in ('2','3','6','7','9','10') and t1.cod_subproducto = t2.cod_subproducto ";
...
//	$Consulta.= " order by t1.fecha_movimiento, t1.cod_producto, t1.cod_subproducto, t1.hornada ";
	...
	$Inserta = " insert into table tmp_yo...............aqui voy
	$TotalPeso = 0;
	$TotalPesoOrigen = 0;
	$TotalZuncho = 0;
	$TotalDiferencia = 0;	
	while ($Fila = mysqli_fetch_array($Respuesta))
	{
		...
		if ($Dif <> 0) 
		{
			...
			if ($Act == "S")
				ActualizaPeso($Fila["fecha_movimiento"], $Fila["cod_producto"], $Fila["cod_subproducto"], $Fila["hornada"], $Fila["peso"], $PesoSipa, $PesoZuncho, $Fila["unidades"], $Fila["campo1"], $Fila["campo2"]);
		}
		else
		{
