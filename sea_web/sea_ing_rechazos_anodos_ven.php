...
<table width="750" border="0" cellspacing="0" cellpadding="3" class="TablaInterior">
		...
		?>
          ...
          <tr> 
            ...
            <td colspan="4"><SELECT name="cmbhornada" onChange="JavaScript:BuscarRechazo(this.form)">
                <option value="-1">SELECCIONAR</option>
                <?php
					if ($buscar == "S")
					{
						include("../principal/conectar_sea_web.php");
						$consulta = "SELECT DISTINCT hornada_ventana FROM hornadas WHERE cod_producto = 17 AND cod_subproducto in (4,8,11)";
//						if ($mostrar == "S")
