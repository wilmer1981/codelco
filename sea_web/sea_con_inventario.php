  ...
  <table width="770" height="330" border="0" cellpadding="5" cellspacing="0" class="TablaPrincipal">
	...
	<?php        	
		if ($mostrar == "S")
		{
			...
			//echo "PASO 1: ".date('Y-m-d G:i:s')."<br>";
			...
			//echo "PASO 2: ".date('Y-m-d G:i:s')."<br>";
			...
			while ($row = mysqli_fetch_array($rs))
			{
				...
				//$consulta = $consulta."WHERE tipo_movimiento = 2 AND campo2 = '3'";
...
//echo "<br>aca1<br>";
	...
	//$fecha_ter =date("Y-m-d", mktime(0,0,0,$mes_t,($dia_t +1),$ano_t));	
			...
			//echo "PASO 3: ".date('Y-m-d G:i:s')."<br>";
			reset($grupos1);
			//while (list($c,$v) = each($grupos1))
			foreach($grupos1 as $c=>$v)
			{		
				
				//echo "PASO 3.1: GRUPO:".$c." - ".date('Y-m-d G:i:s')."<br>";
				//Limpio el arreglo.
				reset($total_leyes);
				...
				$fecha_aux = $v[0];
				//echo "PASO 3.2: GRUPO:".$c." - ".date('Y-m-d G:i:s')."<br>";
				...
				//echo "PASO 3.3: GRUPO:".$c." - ".date('Y-m-d G:i:s')."<br>";			
				...
				{					
					...
					//echo "PASO 3.4: GRUPO:".$c." - ".date('Y-m-d G:i:s')."<br>";
					//echo $consulta."<br><br>";
					...
					//echo "PASO 3.5: GRUPO:".$c." - ".date('Y-m-d G:i:s')."<br>";										
				}
				//echo "PASO 3.6: GRUPO:".$c." - ".date('Y-m-d G:i:s')."<br>";
				...
				//echo "PASO 3.7: GRUPO:".$c." - ".date('Y-m-d G:i:s')."<br>";
				//echo "PESO:".$consulta."<br><br>";
			...
			echo '</table>';
			//echo "PASO 4: ".date('Y-m-d G:i:s')."<br>";
			...
			{		
				...
				$consulta = $consulta." and (hora between '".$fecha_ini." ".$Hora1."' and '".$fecha_ter." ".$Hora2."'";
				//$consulta = $consulta." or hora between '".$fecha_ter." ".$Hora1."' and '".$fecha_ter." ".$Hora2."')";
				$consulta = $consulta." or hora between '".$fecha_ter." ".$Hora1."' and '".$fecha_ter." 23:59:59')";	
				//$consulta = $consulta." and (hora between '".$fecha_ini." 08:00:00' and '".$fecha_ter." 07:59:59'";	
				//$consulta = $consulta." or hora between '".$fecha_ter." 08:00:00' and '".$fecha_ter." 23:59:59')";	
				//echo $consulta."<br>";
				$rs3 = mysqli_query($link, $consulta);
			...
			echo '</table>';
			//echo "PASO 5: ".date('Y-m-d G:i:s')."<br>";
			...
			echo '</table>';
//echo "PASO 6: ".date('Y-m-d G:i:s')."<br>";
		}
	?>
