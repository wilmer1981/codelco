...
set_time_limit(900);
	...
	$fechasubprod  =date("Y-m-d", mktime(1,0,0,($Mes+8),$Dia,$Ano));
...
<form name="FrmPrincipal" method="post" action="">
  <table width="530" border="1" cellspacing="0" cellpadding="0" align="center">
    <tr> 
      <td width="334"><strong>INFORME OPERATIVO DE PRODUCTOS INTERMEDIOS&nbsp;&nbsp;(V-2)</strong></td>
      <td width="98" class="ColorTabla02"><strong>FECHA EMISION:</strong></td>
      <td width="90" class="ColorTabla02">&nbsp;<?php echo $dia.'-'.$mes.'-'.$ano;?></td>
    </tr>
  </table>
  <br>
  <?php
  ...
  <table width="561" border="1" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="350"><strong>MOVIMIENTOS ACUMULADOS DE ANODOS</strong></td>
	  <td width="60" align="right"><strong>PERIODO:</strong>&nbsp;</td>
      <td width="264"><?php echo '01-'.$Mes.'-'.$Ano?>  AL <?php echo $Dia.'-'.$Mes.'-'.$Ano?></td>
    </tr>
  </table>
			...
			while($Fila = mysqli_fetch_array($resp))
			{
				echo'<tr>';
                 ...
                 //STOCK INICIAL				 
				  ...
				  if (isset($Fil2["peso"])) {
					$entero=number_format($Fil2["peso"]/1000,0,"",".");
			      }else{
					$entero=0;
				  }
				   //$entero=0;
				  ...
				  echo'<td align="right">'.$entero.'</td>';
				  $AcumIni = $AcumIni + $entero;
				  $AcumIni2 = $AcumIni2 + $entero;
				  //Recep 	
				  ...
				  {
				  	$Consulta.=" AND cod_subproducto = '".$Fila["cod_subproducto"]."' AND tipo_movimiento IN (1,44) ";	
				  }
				  else
				  {
				  	$Consulta.=" AND cod_subproducto = '".$Fila["cod_subproducto"]."' AND tipo_movimiento = 1 ";	
				  }
				  ...
				  $entero=0;
				  $entero=number_format($Fil3["peso"]/1000,0,"","");
				  echo'<td align="right">'.number_format($Fil3["peso"]/1000,0,"",".").'</td>';
				  $AcumRecep = $AcumRecep + $entero;
				  $AcumRecep2 = $AcumRecep2 + $entero;
                  ...
                  $entero=0;$entero1=0;
				  $entero=number_format($peso/1000,0,"","");
				  $entero1=number_format($Fil3["peso"]/1000,0,"","");
				  $Falta=0;
				  if($entero>0)
				  	$Falta=$entero - $entero1;
                  if ($Fila["cod_subproducto"]==13)
                  {
                      $Falta = 0;
                  }
				  $AcumProy = $AcumProy + $entero;	
				  $AcumFalta = $AcumFalta + $Falta;	
				  echo'<td align="right">'.number_format($Falta,0,"",".").'</td>';

				  //Nave	
				  $Consulta = "SELECT SUM(peso) as peso FROM sea_web.movimientos WHERE cod_producto = 17 ";
				  $Consulta.=" AND cod_subproducto = '".$Fila["cod_subproducto"]."' AND tipo_movimiento = 2";	
				  $Consulta.=" AND fecha_movimiento BETWEEN '".$Fecha_Ini."' AND '".$Fecha_Ter."' and hora between '".$FechaInicio."' and '".$FechaTermino."'";
			      $rs4 = mysqli_query($link, $Consulta);
				  $Fil4 = mysqli_fetch_array($rs4);						
				  $entero=0;
				  $entero=number_format($Fil4["peso"]/1000,0,"","");
				  echo'<td align="right">'.number_format($Fil4["peso"]/1000,0,"",".").'</td>';
				  $AcumNave = $AcumNave + $entero;
				  $AcumNave2 = $AcumNave2 + $entero;
				...
				$consulta1.=" left join sea_web.leyes_por_hornada as t2 on t1.hornada = t2.hornada and ";
				$consulta1.=" t1.cod_producto = t2.cod_producto and t1.cod_subproducto = t2.cod_subproducto ";
				$consulta1.=" and t2.cod_leyes = '09' where t1.cod_producto = 17";
				$consulta1.=" and t1.cod_subproducto = '".$Fila["cod_subproducto"]."' and t1.tipo_movimiento = 4";
				$consulta1.=" and t1.fecha_movimiento between '".$Fecha_Ini."' and '".$Fecha_Ter."' and hora between '".$FechaInicio."' and '".$FechaTermino."'";
				$ps = mysqli_query($link, $consulta1);
				while($fila_p = mysqli_fetch_array($ps))
				{
					...
					$pasraf=0;$quimraf=0;$fisraf=0;$pasraf2=0;
					$pasraf=$peso_fisico + $peso_quimico;
					$quimraf=number_format($peso_quimico/1000,0,"","");
					$pasraf2=number_format($pasraf/1000,0,"","");
					$fisraf=$pasraf2 - $quimraf;
					echo '<td align="right">'.number_format($fisraf,0,"",".").'</td>';
					echo '<td align="right">'.number_format($quimraf,0,"",".").'</td>';
                    $AcumRaf = $AcumRaf + $fisraf;
					$AcumRaf1 = $AcumRaf1 + $quimraf;
					$dospesos = $AcumRaf + $AcumRaf1;
					$AcumRaf2 = $AcumRaf2 + $dospesos ;	

				  //Otros Destinos
				  $Consulta = "SELECT SUM(peso) as peso FROM sea_web.movimientos WHERE cod_producto = 17";
				  $Consulta.=" AND cod_subproducto = '".$Fila["cod_subproducto"]."' AND (tipo_movimiento = 5 or tipo_movimiento = 9)";
				  $Consulta.=" AND fecha_movimiento BETWEEN '".$Fecha_Ini."' AND '".$Fecha_Ter."' and hora between '".$FechaInicio."' and '".$FechaTermino."'";
			      $rs6 = mysqli_query($link, $Consulta);
				  $Fil6 = mysqli_fetch_array($rs6);	
				  echo'<td align="right">'.number_format($AcumEmbResto,0,"",".").'</td>';
				  echo'<td align="right">'.number_format($Fil6["peso"]/1000,0,"",".").'</td>';
				  $entero = number_format($Fil6["peso"]/1000,0,"","");
				  $AcumDest = $AcumDest + $entero;
				  $AcumDest2 = $AcumDest2 + $entero;
				  $entero=0;$entero1=0;$entero2=0;
				  $entero=number_format($peso_quimico/1000,0,"","");
				  $entero1=number_format($peso_fisico/1000,0,"","");
				  $ExFinal = $AcumIni2 + $AcumRecep2 - $AcumNave2 - $fisraf - $quimraf - $AcumDest2;
				  $AcumFinal = $AcumFinal + $ExFinal;
				  echo'<td align="right">'.number_format($ExFinal,0,"",".").'</td>';				  
			    echo'</tr>';
			}				
	  ?>
    <tr class="Detalle01">
      <td>TOTAL TONS.</td>
      <td align="right"><?php echo number_format($AcumIni,0,"","."); ?></td>
      <td align="right"><?php echo number_format($AcumRecep,0,"","."); ?></td>
      <td align="right"><?php echo number_format($AcumProy,0,"","."); ?></td>
      <td align="right"><?php echo number_format($AcumFalta,0,"","."); ?></td>
      <td align="right"><?php echo number_format($AcumNave,0,"","."); ?></td>
	  <td align="right"><?php echo number_format($AcumRaf,0,"","."); ?></td>
	  <td align="right"><?php echo number_format($AcumRaf1,0,"","."); ?></td>
	  <td align="right"><?php echo number_format($AcumDest,0,"","."); ?></td>
	   <td align="right"><?php echo number_format($AcumEmbResto,0,"",".");?></td>
	 
	  <td align="right"><?php echo number_format($AcumFinal,0,"","."); ?></td>
    </tr>
    <tr class="Detalle02">
      <td>RESTOS</td>
   	  <?php 
		...
		while($Fil2 = mysqli_fetch_array($rs2))						
 	    {
			$pesores=$pesores + $Fil2["peso"];
		}
		$AcumIni5 = number_format($pesores/1000,0,"","");
		echo'<td align="right">'.number_format($AcumIni5,0,"",".").'</td>';
		//Prod.	
		...
		$entero = 0;
		$entero=number_format($Fil5["peso"]/1000,0,"","");						
 	    $AcumRaf5 = $AcumRaf5 + $entero;
		...
		$entero=0;
		$entero= number_format($Filresto["peso"]/1000,0,"","");						
 	    $AcumEmb = $AcumEmb + $entero;
  ...
  |<br>
    ...
    <tr class="Detalle01">
	 ...
	 <td width="81" rowspan="2" align="center">Total Obj.</td>	
	...
	<?php 
		...
		$Consulta = "SELECT MAX(fecha) as fecha FROM sea_web.inf_rechazos WHERE fecha between '".$Fecha_Ini."' and ";
		$Consulta.=" '".$Fecha_Ter."' and hora between '".$FechaInicio."' and '".$FechaTermino."'";
		$res = mysqli_query($link, $Consulta);
		...
		if($row = mysqli_fetch_array($rs))
		{
			...
			{	
				 ...
				 //STOCK INICIAL
				  ...
				  $entero=0;
				  $entero=number_format($Fil4["peso"]/1000,0,"","");						
				  $AcumNave3 = $AcumNave3 + $entero;
	
				  //Trasp Raf
				  $Consulta = "SELECT SUM(peso) as peso FROM sea_web.movimientos WHERE cod_producto = 17";
				  $Consulta.=" AND cod_subproducto = '".$Fila["cod_subproducto"]."' AND tipo_movimiento = 4";	
				  $Consulta.=" AND fecha_movimiento BETWEEN '".$Fecha_Ini."' AND '".$Fecha_Ter."' and hora between '".$FechaInicio."' and '".$FechaTermino."'";
				  $rs5 = mysqli_query($link, $Consulta);
				  $Fil5 = mysqli_fetch_array($rs5);
				  $entero=0;
				  $entero=number_format($Fil5["peso"]/1000,0,"","");						
				  $AcumRaf3 = $AcumRaf3 + $entero;

				  //Otros Destinos
				  $Consulta = "SELECT SUM(peso) as peso FROM sea_web.movimientos WHERE cod_producto = 17";
				  $Consulta.=" AND cod_subproducto = '".$Fila["cod_subproducto"]."' AND tipo_movimiento IN (5,9)";	
				  $Consulta.= " AND fecha_movimiento BETWEEN '".$Fecha_Ini."' AND '".$Fecha_Ter."' and hora between '".$FechaInicio."' and '".$FechaTermino."'";
			      $rs6 = mysqli_query($link, $Consulta);
				  $Fil6 = mysqli_fetch_array($rs6);
				  $entero=0;
				  $entero=number_format($Fil6["peso"]/1000,0,"","");						
				  $AcumDest3 = $AcumDest3 + $entero;
		...
		else
		{
			...
			while($Fila = mysqli_fetch_array($resp))
			{
				 ...
				 //STOCK INICIAL
				  ...
				  $entero=0;
				  $entero=number_format($peso_calaf/1000,0,"","");
				  $AcumCalaf = $AcumCalaf + $entero;
				  ...
				  $entero=0;
				  $entero=number_format($peso_fisico/1000,0,"","");
				  $AcumFisi = $AcumFisi + $entero;
				  ...
				  $entero=0;
				  $entero=number_format($peso_quimico/1000,0,"",".");
				  $AcumQuim = $AcumQuim + $entero;
													  
				  $ExFinal3 = $AcumIni3 + $AcumRecep3 - $AcumNave3 - $AcumRaf3 - $AcumDest3;
				  $AcumFinal3 = $AcumFinal3 + $ExFinal3;  
				  $entero=0;$entero1=0;$entero2=0;
				  $entero=number_format($peso_fisico/1000,0,"","");
				  $entero1=number_format($peso_calaf/1000,0,"","");
				  $entero2=number_format($peso_quimico/1000,0,"","");            
				  $Aprobados = $ExFinal3 - $entero - $entero1;
				  $AcumAprob = $AcumAprob + $Aprobados;
				  
				  $total = $entero + $entero1 + $entero2;
				  $AcumTotal = $AcumTotal + $total;
				  echo'<td align="right">'.number_format($Aprobados,0,"",".").'</td>';				  
				  echo'<td></td>';
    ...
    <tr class="Detalle01">
	 <td>Total Tons.</td> 	
	 <td align="right"><?php echo number_format($AcumAprob,0,"","."); ?></td>	
	 <td align="right"><?php echo number_format($AcumAna,0,"","."); ?></td>	
	 <td align="right"><?php echo number_format($AcumCalaf,0,"","."); ?></td>	
	 <td align="right"><?php echo number_format($AcumFisi,0,"","."); ?></td>	
	 <td align="right"><?php echo number_format($AcumQuim,0,"","."); ?></td>	
	 <td align="right"><?php echo number_format($AcumTotal,0,"","."); ?></td>	
	  <td align="right"><?php echo number_format($AcumEmbResto,0,"","."); ?></td>
	 <td align="right"><?php echo number_format($AcumFinal3,0,"","."); ?></td>	
    </tr>	
    <tr class="Detalle02">
	 <td>Restos</td> 	
       <?php 
		...
		if($row = mysqli_fetch_array($rs))
		{
			...
			while($Fil2 = mysqli_fetch_array($rs2))						
			{
				$PesoPas = $PesoPas + $Fil2["peso"];
			}
			$AcumIni5 = number_format($PesoPas/1000,0,"","");
			//Prod.	
			$Consulta = "SELECT SUM(peso) as peso FROM sea_web.movimientos WHERE cod_producto = 19";
			$Consulta.=" AND tipo_movimiento = 3";	
			$Consulta.=" AND fecha_movimiento BETWEEN '".$Fecha_Ini."' AND '".$Fecha_Ter."' and hora between '".$FechaInicio."' and '".$FechaTermino."'";
			$rs3 = mysqli_query($link, $Consulta);
			$Fil3 = mysqli_fetch_array($rs3);						
			$AcumProd5 = $AcumProd5 + number_format($Fil3["peso"]/1000,0,"","");
			...
			$rs4 = mysqli_query($link, $Consulta);
			$Fil4 = mysqli_fetch_array($rs4);						
			$AcumNave5 = $AcumNave5 + number_format($Fil4["peso"]/1000,0,"","");
			...
			$rs5 = mysqli_query($link, $Consulta);
			$Fil5 = mysqli_fetch_array($rs5);						
			$AcumRaf5 = $AcumRaf5 + number_format($Fil5["peso"]/1000,0,"","");
		...
		//embarque
			...
			$rsresto = mysqli_query($link, $Consulta);
			$Filresto = mysqli_fetch_array($rsresto);						
			$AcumEmb1 = $AcumEmb1 + number_format($Filresto["peso"]/1000,0,"","");
			$entero=0;$entero1=0;$entero2=0;$entero3=0;$entero4=0;
			$entero1=number_format($peso_fisico/1000,0,"","");
			$entero2=number_format($peso_quimico/1000,0,"","");
			$entero3=number_format($peso_calafateo/1000,0,"","");
			$entero4=number_format($peso_analisis/1000,0,"","");
			$ExFinal5 = $AcumIni5 + $AcumProd5 - $AcumNave5 - $AcumRaf5;
			$AprobRestos = $ExFinal5 - $entero1 - $entero2 - $entero3 - $entero4;
			$peso_total = $entero1 + $entero2 + $entero3 + $entero4;
			$AcumEmb11=0;
			echo'<td align="right">'.number_format(($AprobRestos - $AcumEmb1),0,"",".").'</td>';				  
			echo'<td align="right">'.number_format($peso_analisis/1000,0,"",".").'</td>';				  
			echo'<td align="right">'.number_format($peso_calafateo/1000,0,"",".").'</td>';				  
			echo'<td align="right">'.number_format($peso_fisico/1000,0,"",".").'</td>';				  
			echo'<td align="right">'.number_format($peso_quimico/1000,0,"",".").'</td>';				  
			echo'<td align="right">'.number_format($peso_total,0,"",".").'</td>';	
			echo'<td align="right">'.number_format($AcumEmb11,0,"",".").'</td>'; 
			echo'<td align="right">'.number_format(($ExFinal5 - $AcumEmb1),0,"",".").'</td>';				  
		}
		else
		{
			...
			$ExFinal5 = $AcumIni5 + $AcumProd5 - $AcumNave5 - $AcumRaf5;
			$AprobRestos = $ExFinal5 - number_format($peso_restos/1000,0,"","");
  ...
  <table width="600" border="1" cellspacing="0" cellpadding="0" class="TablaDetalle">
    <tr class="ColorTabla01">
	 <td width="71">&nbsp;</td>
	 <td colspan="3" align="center">Turno A</td>
	 <td colspan="3" align="center">Turno B</td>
	</tr>	
    <tr>
	 <td>Grupos</td>
	 <?php
		...
		else
		{
			...
			$Consulta.=" INNER JOIN sea_web.movimientos as t2"; 
			$Consulta.=" ON (t2.campo2 * 1) = (t1.cod_grupo * 1)"; 
			$Consulta.=" WHERE t1.cod_concepto = 'A' and t1.dia_renovacion = '".$Dia_R."'";
			$Consulta.=" and t1.fecha_renovacion = '".$Fecha_In."' and t2.fecha_movimiento = '".$FechaTer2."'";
			$Consulta.=" and t2.tipo_movimiento = 2 and t2.cod_subproducto != 8 group by t1.cod_grupo";		
			$rs = mysqli_query($link, $Consulta);
			...
			$Consulta.=" INNER JOIN sea_web.movimientos as t2"; 
			$Consulta.=" ON (t2.campo2 * 1) = (t1.cod_grupo * 1)"; 
			$Consulta.=" WHERE t1.cod_concepto = 'B' and t1.dia_renovacion = '".$Dia_R."'";
			$Consulta.=" and t1.fecha_renovacion = '".$Fecha_In."' and t2.fecha_movimiento = '".$FechaTer2."'";
			$Consulta.=" and t2.tipo_movimiento = 2 and t2.cod_subproducto != 8 group by t1.cod_grupo";		
			$rs = mysqli_query($link, $Consulta);
			while($Fila = mysqli_fetch_array($rs))
  ...
  <table width="814" border="1" cellspacing="0" cellpadding="0" class="TablaDetalle">
    ...
    <tr>
	 ...
	 <td width????????y???="49" align="center" class="Detalle01">Hornada</td>
	 <td width="55" align="center" class="Detalle01">TM/PROY</td>
	 ...
	 <?php
		...
		if (isset($row4["observacion"])) {
			$observac = $row4["observacion"];
		}else{
			$observac = "";
		}
	 ?>	 
	 <td rowspan="4">&nbsp;<?php echo nl2br($observac);?></td>
	</tr>	
    <tr>
	  <td>Reverb 1</td>
	  <?php
		...
		if (isset($row1["hornada1"])) {
			$hornada11 = $row1["hornada1"];
		}else{
			$hornada11 = 0;
		}	
		if (isset($row1["hornada2"])) {
			$hornada12 = $row1["hornada2"];
		}else{
			$hornada12 = 0;
		}
		if (isset($row1["hornada3"])) {
			$hornada13 = $row1["hornada3"];
		}else{
			$hornada13 = 0;
		}
		if (isset($row1["ton_proy1"])) {
			$ton_proy11 = $row1["ton_proy1"];
		}else{
			$ton_proy11 = 0;
		}	
		if (isset($row1["ton_proy2"])) {
			$ton_proy12 = $row1["ton_proy2"];
		}else{
			$ton_proy12 = 0;
		}
		if (isset($row1["ton_proy3"])) {
			$ton_proy13 = $row1["ton_proy3"];
		}else{
			$ton_proy13 = 0;
		}	
		...
		if (isset($row2["hornada1"])) {
			$hornada21 = $row2["hornada1"];
		}else{
			$hornada21 = 0;
		}	
		if (isset($row2["hornada2"])) {
			$hornada22 = $row2["hornada2"];
		}else{
			$hornada22 = 0;
		}
		if (isset($row2["hornada3"])) {
			$hornada23 = $row2["hornada3"];
		}else{
			$hornada23 = 0;
		}
		if (isset($row2["ton_proy1"])) {
			$ton_proy21 = $row2["ton_proy1"];
		}else{
			$ton_proy21 = 0;
		}	
		if (isset($row2["ton_proy2"])) {
			$ton_proy22 = $row2["ton_proy2"];
		}else{
			$ton_proy22 = 0;
		}
		if (isset($row2["ton_proy3"])) {
			$ton_proy23 = $row2["ton_proy3"];
		}else{
			$ton_proy23 = 0;
		}			
		...
		if (isset($row3["hornada1"])) {
			$hornada31 = $row3["hornada1"];
		}else{
			$hornada31 = 0;
		}	
		if (isset($row3["hornada2"])) {
			$hornada32 = $row3["hornada2"];
		}else{
			$hornada32 = 0;
		}
		if (isset($row3["hornada3"])) {
			$hornada33 = $row3["hornada3"];
		}else{
			$hornada33 = 0;
		}	
		if (isset($row3["ton_proy1"])) {
			$ton_proy31 = $row3["ton_proy1"];
		}else{
			$ton_proy31 = 0;
		}	
		if (isset($row3["ton_proy2"])) {
			$ton_proy32 = $row3["ton_proy2"];
		}else{
			$ton_proy32 = 0;
		}
		if (isset($row3["ton_proy3"])) {
			$ton_proy33 = $row3["ton_proy3"];
		}else{
			$ton_proy33 = 0;
		}
		...
		$Fecha_Ter = date("Y-m-d", mktime(1,0,0,$Mes,($Dia +1),$Ano));	  		
	  ?> 	
	 <td align="center"><?php echo $hornada11; ?></td>
	 <td align="center"><?php echo $ton_proy11; ?></td>
	 <td align="center"><?php echo $hornada21; ?></td>
	 <td align="center"><?php echo $ton_proy21; ?></td>
	 <td align="center"><?php echo $hornada31; ?></td>
	 <td align="center"><?php echo $ton_proy31; ?></td>
	</tr>	
    <tr>
	 <td>Reverb 2</td>
	 <td align="center"><?php echo $hornada12; ?></td>
	 <td align="center"><?php echo $ton_proy12; ?></td>
	 <td align="center"><?php echo $hornada22; ?></td>
	 <td align="center"><?php echo $ton_proy22; ?></td>
	 <td align="center"><?php echo $hornada32; ?></td>
	 <td align="center"><?php echo $ton_proy32; ?></td>
	</tr>	
    <tr>
	 <td>Bascul.</td>
	 <td align="center"><?php echo $hornada13; ?></td>
	 <td align="center"><?php echo $ton_proy13; ?></td>
	 <td align="center"><?php echo $hornada23; ?></td>
	 <td align="center"><?php echo $ton_proy23; ?></td>
	 <td align="center"><?php echo $hornada33; ?></td>
	 <td align="center"><?php echo $ton_proy33; ?></td>
	</tr>	
  </table> 
  <br>
  <table width="400" border="1" cellspacing="0" cellpadding="0">
	  ...
	  //RECEPCION ANODOS EXTERNOS
		...
		{	
			...
			echo'<tr>';
			  ...
			  $Consulta.=" AND RUT_PRV = '1100-2' AND COD_SUBPRODUCTO = '17'";
			  $rs = mysqli_query($link, $Consulta);
			  $Fil = mysqli_fetch_array($rs);			  
			  ...
			  //TTE
			  $Consulta = "SELECT count(*) as cont FROM SIPA_WEB.recepciones WHERE FECHA = '".$Fila["FECHA_A"]."'";
			  $Consulta.=" AND RUT_PRV = '61704005-0' AND COD_PRODUCTO='1' AND COD_SUBPRODUCTO = '17'";
			  $rs2 = mysqli_query($link, $Consulta);
			  $Fil2 = mysqli_fetch_array($rs2);			  
			  ...
			  $Consulta.=" AND tipo_movimiento = 1";
			  $Consulta.=" AND cod_producto = 17 AND cod_subproducto = 2";
			  $rs2 = mysqli_query($link, $Consulta);
			  $Fil2 = mysqli_fetch_array($rs2);			  
			  echo'<td align="right">'.number_format($Fil2["peso"]/1000,0,"","").'&nbsp;</td>'; 
			  ...
			  $Consulta.=" AND RUT_PRV = '90132000-4' AND COD_PRODUCTO='1' AND COD_SUBPRODUCTO = '17'";
			  $rs3 = mysqli_query($link, $Consulta);
			  $Fil3 = mysqli_fetch_array($rs3);			  
			  ...
			  $Consulta.=" AND '".$FechaTerm2."' and hora between '".$FechaHoraIni."' and '".$FechaHoraFin."'";
			  $Consulta.=" AND tipo_movimiento = 1";
			  $Consulta.=" AND cod_producto = 17 AND cod_subproducto = 3";
			  $rs3 = mysqli_query($link, $Consulta);
			  $Fil3 = mysqli_fetch_array($rs3);			  
			  echo'<td align="right">'.number_format($Fil3["peso"]/1000,0,"","").'&nbsp;</td>'; 
  ...
  <table width="550" border="1" cellspacing="0" cellpadding="0" class="TablaDetalle">
	...
	<?php
	  //RECEPCION BLISTER EXTERNOS 
		...
		$Consulta.=" AND FECHA BETWEEN '".$FechaIni."' AND '".$Fecha_Ter."'";
		$Consulta.=" AND RUT_PRV IN('61704000-K','61704005-0') ORDER BY FECHA";
		$resp = mysqli_query($link, $Consulta);
		while($Fila = mysqli_fetch_array($resp))
		{	
			echo'<tr>';
			  ...
			  $Consulta.=" AND RUT_PRV = '61704000-K' AND COD_PRODUCTO='1' AND COD_SUBPRODUCTO = '16'";
			  $rs = mysqli_query($link, $Consulta);
			  $Fil = mysqli_fetch_array($rs);			  
			  echo'<td align="center">'.$Fil["cont"].'</td>';
			  echo'<td align="right">'.number_format($Fil["peso"]/1000,0,"","").'</td>'; 
			  ...
			  //CODEL.TTE
			  $Consulta = "SELECT count(*) as cont, sum(PESO_NETO) as peso FROM SIPA_WEB.recepciones WHERE FECHA = '".$Fila["FECHA_A"]."'";
			  $Consulta.=" AND RUT_PRV = '61704005-0' AND COD_PRODUCTO='1' AND COD_SUBPRODUCTO = '16'";
			  $rs2 = mysqli_query($link, $Consulta);
			  $Fil2 = mysqli_fetch_array($rs2);
			  echo'<td align="center">'.$Fil2["cont"].'</td>';
			  echo'<td align="right">'.number_format($Fil2["peso"]/1000,0,"","").'</td>'; 
  ...
  <table width="550" border="1" cellspacing="0" cellpadding="0" class="TablaDetalle">
	...
	<tr class="Detalle01">
	   <td>Total Exist.</td>  
       <td align="right"><?php echo number_format($AcumIni/1000,0,"","."); ?></td>
       <td align="right"><?php echo number_format($AcumRecep/1000,0,"","."); ?></td>
       <td align="right"><?php echo number_format($AcumRaf/1000,0,"","."); ?></td>
	   <td></td>  
       <td align="right"><?php echo number_format($AcumFinal2/1000,0,"","."); ?></td>
	</tr>  
  </table>
  <br>
    <?php 	
    ...
    <tr class="ColorTabla01">
	  ...
	  <td width="69">Exist. Actual</td>
   	...
   	<?php  
		...
		$Consulta.=" AND fecha_movimiento BETWEEN '".$FechaIni."' AND '".$Fecha_Ter."'";
		$resp = mysqli_query($link, $Consulta);
		while($Fila = mysqli_fetch_array($resp))
		{
			echo'<tr>';
			  ...
			  $Consulta.=" AND cod_subproducto = '".$Fila["cod_subproducto"]."' AND tipo_movimiento = 1";	
			  $Consulta.=" AND fecha_movimiento BETWEEN '".$Fecha_Ini."' AND '".$Fecha_Ter."' and hora between '".$FechaHi."' and '".$FechaHf."'";
			  $rs3 = mysqli_query($link, $Consulta);
			  $Fil3 = mysqli_fetch_array($rs3);
			  if($Fil3["peso"]>1000)						
				  echo'<td align="right">'.number_format($Fil3["peso"]/1000,0,"",".").'&nbsp;</td>';
