...
//mostrar=S&ano=2024&mes=12&dia=13&proveedor=A-77762940-9
...
$peso_recepcion  = isset($_REQUEST["peso_recepcion"])?$_REQUEST["peso_recepcion"]:"";
$hornada  = isset($_REQUEST["hornada"])?$_REQUEST["hornada"]:"";
$hornada_aux = isset($_REQUEST["hornada_aux"])?$_REQUEST["hornada_aux"]:"";
$peso_origen  = isset($_REQUEST["peso_origen"])?$_REQUEST["peso_origen"]:"";
$unidades  = isset($_REQUEST["unidades"])?$_REQUEST["unidades"]:"";

$Fecha_Mov = isset($_REQUEST["Fecha_Mov"])?$_REQUEST["Fecha_Mov"]:"";
