...
<html>
<head>
<title>Sistema Carga Historica Blister</title>
...
function Proceso(opt)
{
	...
	switch (opt)
	{
		case "C":
			...
			f.action = "sea_flujos_blister_web_historico.php";				
			f.submit();		
			break;	
...
{
	var f = document.frmPrincipal;
	f.action = "sea_flujos_blister_historico.php";
	f.submit();
}
</script>
</head>
...
<?php include("../principal/encabezado.php"); ?>
  <table width="770" height="315" border="0" cellpadding="3" cellspacing="3" class="TablaPrincipal">
      ...
      <tr> 
        <td width="27%">Periodo a cargar de los Flujos Blister a RAF:</td>
	  </tr>  
		<br> 
		<br> 
    <tr>
