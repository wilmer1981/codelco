...
<body>
		 ...
		 <table width="405" border="1" cellpadding="2" cellspacing="0" class="TablaDetalle" align="center">
                <tr align="center" class="ColorTabla01">
                  ...
                  <td colspan="2">STOCK</td>
                  <td width="75" rowspan="2">Acum.Dif.</td>
                </tr>
                <tr align="center" class="ColorTabla01">
                  <td width="72">Programado </td>
                  <td width="56">Real</td>
                  <td width="90">Acum.Prog.</td>
                  <td width="75">Acum.Real</td>
                </tr>
                <?php	
...
?>
                <tr bgcolor="#FFFFFF" >
                  ...
                  <td align="center"><span class="Estilo2"><?php echo number_format($TotalProgramado,0,",","."); ?></span></td>
                  <td align="center"><span class="Estilo2"><?php echo number_format($TotalReal,0,",","."); ?></span></td>
                  <td align="center"><span class="Estilo2"><?php echo number_format($TotalDiferencia,0,",","."); ?></span></td>
                  <td align="center"><span class="Estilo2"><?php echo number_format($TotalProgramado,0,",","."); ?></span></td>
                  <td align="center"><span class="Estilo2"><?php echo number_format($TotalReal,0,",","."); ?></span></td>
                  <td align="center"><span class="Estilo2"><?php echo number_format($TotalDiferencia,0,",","."); ?></span></td>
                </tr>
