...
<form name="FrmPrincipal" method="post" action="">
  <table width="530" border="1" cellspacing="0" cellpadding="0" align="center">
    <tr> 
      <td width="334"><strong>INFORME OPERATIVO DE PRODUCTOS INTERMEDIOS</strong></td>
  ...
  <table width="561" border="1" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="264"><strong>PERIODO:</strong>&nbsp;&nbsp;<?php echo '01-'.$Mes.'-'.$Ano?> AL <?php echo $Dia.'-'.$Mes.'-'.$Ano?></td>
    </tr>
  </table>
...
*/
    ...
    <tr class="Detalle01">
      ...
      <td align="right"><?php echo number_format($AcumProy/1000,0,"","."); ?></td>
      <td align="right"><?php echo number_format($AcumFalta/1000,0,"","."); ?></td>
      <td align="right"><?php echo number_format($AcumNave/1000,0,"","."); ?></td>
	  <td align="right"><?php echo number_format($AcumRaf/1000,0,"","."); ?></td>
	  <td align="right"><?php echo number_format($AcumRaf1/1000,0,"","."); ?></td>
	  <td align="right"><?php echo number_format($AcumDest/1000,0,"","."); ?></td>
	   <td align="right"><?php echo number_format($AcumEmbResto/1000,0,"",".");?></td>
	 
	  <td align="right"><?php echo number_format($AcumFinal/1000,0,"","."); ?></td>
    </tr>
    <tr class="Detalle02">
      <td>RESTOS</td>
   	  <?php 
...
/*		$Consulta = "SELECT * FROM sea_web.inf_rechazos WHERE fecha = '$Fecha_B'"; */
  ...
  <table width="814" border="1" cellspacing="0" cellpadding="0" class="TablaDetalle">
    ...
    <tr>
	 ...
	 ?>	 
	 <td rowspan="4">&nbsp;<?php echo nl2br($row4["observacion"]);?></td>
	</tr>	
    <tr>
	  <td>Reverb 1</td>
	  <?php
		...
		$Fecha_Ter = date("Y-m-d", mktime(1,0,0,$Mes,($Dia +1),$Ano));	  		
	  ?> 	
	 <td align="center"><?php echo $row1[hornada1]; ?></td>
	 <td align="center"><?php echo $row1[ton_proy1]; ?></td>
	 <td align="center"><?php echo $row2[hornada1]; ?></td>
	 <td align="center"><?php echo $row2[ton_proy1]; ?></td>
	 <td align="center"><?php echo $row3[hornada1]; ?></td>
	 <td align="center"><?php echo $row3[ton_proy1]; ?></td>
	</tr>	
    <tr>
	 <td>Reverb 2</td>
	 <td align="center"><?php echo $row1[hornada2]; ?></td>
	 <td align="center"><?php echo $row1[ton_proy2]; ?></td>
	 <td align="center"><?php echo $row2[hornada2]; ?></td>
	 <td align="center"><?php echo $row2[ton_proy2]; ?></td>
	 <td align="center"><?php echo $row3[hornada2]; ?></td>
	 <td align="center"><?php echo $row3[ton_proy2]; ?></td>
	</tr>	
    <tr>
	 <td>Bascul.</td>
	 <td align="center"><?php echo $row1[hornada3]; ?></td>
	 <td align="center"><?php echo $row1[ton_proy3]; ?></td>
	 <td align="center"><?php echo $row2[hornada3]; ?></td>
	 <td align="center"><?php echo $row2[ton_proy3]; ?></td>
	 <td align="center"><?php echo $row3[hornada3]; ?></td>
	 <td align="center"><?php echo $row3[ton_proy3]; ?></td>
	</tr>	
  </table> 
  <br>
  <table width="400" border="1" cellspacing="0" cellpadding="0">
	...
	<?php  //RECEPCION ANODOS EXTERNOS
		...
		{	
			...
			echo'<tr>';
			  ...
			  $Consulta = $Consulta." AND RUT_PRV = '90132000-4' AND COD_PRODUCTO='1' AND COD_SUBPRODUCTO = '17'";
			  //echo "seis".$Consulta;
			  $rs3 = mysqli_query($link, $Consulta);
			  $Fil3 = mysqli_fetch_array($rs3);			  
  ...
  <table width="550" border="1" cellspacing="0" cellpadding="0" class="TablaDetalle">
	...
	<?php  //RECEPCION BLISTER EXTERNOS 
