...
<html>
<head>
<title>SIM-WEB, Codelco División Ventanas</title>
<!-- FUNCIONES -->
<Script>
function Volver()
{
...
function Valida()
{
  	...
  	var archi = "indicadores_"+largo+"_"+Ano+".xls";
    //f.action="http://10.56.11.4/archivos/Mantencion/disponibilidad/"+archi;
    f.action="../archivos/Mantencion/disponibilidad/"+archi;
    f.submit();
}
</Script>
</head>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center" height="80">
        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="2">
          <tr>
			...
			&nbsp;&nbsp;Consulta Indicadores</font><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000000"></font></b><br>
              <br>
			  <br>
<?
