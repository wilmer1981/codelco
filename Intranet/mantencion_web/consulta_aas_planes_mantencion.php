...
function Consulta()
{
	...
	//f.action="http://10.56.11.4/archivos/Mantencion/planillas_aas/rev_aas_"+f.Ano.value+".xls";
	f.action="../archivos/Mantencion/planillas_aas/rev_aas_"+f.Ano.value+".xls";
	f.submit();
}
function Volver()
{
		...
		<tr><td>&nbsp;</td></tr>
          <tr>
            <td valign="top"> <b><font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="#336699">
              ...
              AAS Planes Mantencion SIM</font></b><br>
              <br>
