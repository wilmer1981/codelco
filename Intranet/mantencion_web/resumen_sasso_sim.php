...
function Consulta()
{
    ...
    var resumen = "resumen_siper_sim_"+f.Ano.value+".xls";
	//f.action="http://10.56.11.4/archivos/Mantencion/resumen_siper/"+resumen;
	f.action="../archivos/Mantencion/resumen_siper/"+resumen;
	f.submit();
}
function Volver()
{
		...
		<tr><td>&nbsp;</td></tr>
          <tr>
            <td valign="top"> <b><font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="#336699">
              &nbsp;&nbsp;</font><font size="3" face="Verdana, Arial, Helvetica, sans-serif">Resumen  
              SASSO SIM</font></b><br>
              <br>
              <br>
              <br>
...
?>
    ...
    <br>
	    <input type=button value="Ver Resumen" onClick="Consulta()" >
	<br><br>
