...
function Consulta()
{
    ...
    var planilla = "plan_iso_"+f.Ano.value+".xls";
	//f.action="http://10.56.11.4/archivos/Mantencion/plan_anual_iso/"+planilla;
	f.action="../archivos/Mantencion/plan_anual_iso/"+planilla;
	f.submit();
}
function Volver()
{
	var f= document.frm_principal; 
	f.action='http://10.18.18.220/proyecto/intranet/index.php?Pagina=menu_dinamico2.php?CodMenu=124';
...
<form name="frm_principal" action=""  method="get">
  ...
  <table border="2" cellpadding="0" cellspacing="0" width="700" height="300">
  <tr>
  <td>
...
?>
    ...
    <br>
	    <input type=button value="Ver Consulta" onClick="Consulta()" >
	<br><br>
