...
function Consulta()
{
	...
	var planilla = "prog_func_eqs_"+f.Ano.value+".xls";
	//f.action="http://10.56.11.4/archivos/Mantencion/equipos_rot/"+planilla;
	f.action="../archivos/Mantencion/equipos_rot/"+planilla;
	f.submit();
}
function Volver()
{
		...
		<tr><td>&nbsp;</td></tr>
          <tr>
            <td valign="top"> <b><font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="#336699">
              &nbsp;&nbsp;</font><font size="3" face="Verdana, Arial, Helvetica, sans-serif">Programa Funcionamiento
              Equipos Rotativos</font></b><br>
              <br>
              <br>
              <br>
...
?>
    ...
    <br>
	    <input type=button value="Ver Programa" onClick="Consulta()" >
	<br><br>
