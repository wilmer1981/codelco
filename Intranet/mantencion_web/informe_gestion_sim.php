...
function Valida()
{
  ...
  var informe = "inf_gestion_sim_"+largo+"_"+Ano+".ppt";
  //f.action="http://10.56.11.4/archivos/Mantencion/gestion_informes/"+informe;
  f.action="../archivos/Mantencion/gestion_informes/"+informe;
  f.submit();
}
</Script>
</head>
<body bgcolor="#CCCCCC" text="#336699" link="#336699" vlink="#336699" alink="#336699" leftmargin="10" topmargin="5" Onload="JavaScript:document.frm_principal.cmb_mes_i.focus()">
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center" height="80">
        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="2">
          <tr>
			...
			&nbsp;&nbsp;Informe Gestion Mensual</font><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#000000"></font></b><br>
              <br>
			  <br>
			  <br>
<?
...
?>
   <br>
	<input type=button value="Ver Informe" onClick="Valida()" >
	<br><br>
