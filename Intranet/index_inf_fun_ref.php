...
<body  background="imagenes/fondo.gif">
  <table width="223" border="0" cellpadding="2" cellspacing="1" class="TablaPrincipal">
      ...
      <tr>
        ...
        <td align="left" class="BordeInf"><input name="Ayer_Web" type="button" id="Ayer_Web2" value="Ayer" onClick="List_Inf_Dia('A_W','<? echo $DiaAnt; ?>','<? echo $MesAnt; ?>','<? echo $AnoAnt; ?>')">
        <input type="button" name="Listar_Web" value="Consulta" onClick="List_Inf_Dia('W','','','')"> </td>
      </tr>
      <tr>
        <td class="BordeInf">Excel:</td>
        <td align="left"  class="BordeInf"><span class="main-menu"><font class="main-menu">
          <input name="Ayer_Excel" type="button" value="Ayer" onClick="List_Inf_Dia('A_E','<? echo $DiaAnt; ?>','<? echo $MesAnt; ?>','<? echo $AnoAnt; ?>')">
          <input type="button" name="Listar_Excel" value="Consulta" onClick="List_Inf_Dia('E','','','')">
        </font></a></span></td>
      </tr>
