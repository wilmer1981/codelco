...
*/
    ...
    echo "<td width='200%'><font size=1 color='blue' face='verdana'>";
    echo "&nbsp";
	echo $Observacion;
    echo "</font></td>";
...
function DibujaCabecera()
{
    ...
    echo "<td width='50%'><FONT color=WHITE><b>Título del Plano</b></FONT></td>";
	echo "<td width='100%'><FONT color=WHITE><b>Nº Enami</b></FONT></td>";
    echo "<td width='25%'><FONT color=WHITE><b>Nº Proyecto</b></FONT></td>";
	echo "<td width='25%'><FONT color=WHITE><b>Gaveta</b></FONT></td>";
/*
    echo "<td><FONT color=WHITE><b>Suministro</b></td>";
*/
	echo "<td width='25%'><FONT color=WHITE><b>Cad</b></FONT></td>";
    echo "<td width='25%'><FONT color=WHITE><b>Rev</b></FONT></td>";
    echo "<td width='200%'><FONT color=WHITE><b>Obs</b></FONT></td>";
   	echo "</tr>";
}
?>
...
/*INICIO DE LA CONSULTA*/
      	...
      	if($cmb_sec != '-1' || $cmb_ar != '-1' /*|| $cmb_sumi != '-1'*/ || $txt_titulo != '' || $txt_n_enm != ''  || $txt_n_proy != '' || $cad != '2')
        {
          ...
          ECHO $Consulta;
       	...
       	//echo "<BR>$Consulta";
/*FIN DE LA CONSULTA*/
        echo "<font size='2'><B><I><BR>El resultado según los criterios de busqueda </font>";
