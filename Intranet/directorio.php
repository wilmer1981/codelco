<html>
<head>
<title>Intranet CODELCO, Ventanas</title>
<link href="js/style.css" rel="stylesheet" type="text/css">
</head>

<body>
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="TablaPrincipal">
  <tr align="center">
    <td colspan="4" valign="top" nowrap class="Detalle03"><strong><? echo $Titulo; ?> 
</strong></td>
  </tr>
...
if (count($ArrArchivo)>0)
{
	...
	while (list($k,$v)=each($ArrArchivo))
	{
		...
		else
		{
			if(is_dir($Dir."/".$v[0]))
			{
				echo "<td><img src=\"images/ico_carpeta.gif\" border='0' align='absmiddle'>&nbsp;";
			...
			{
				echo "<td><img src=\"images/img_listado.gif\" border='0' align='absmiddle'>&nbsp;";
...
?>
  <tr align="center" class="ColorTabla01">
    <td colspan="2" valign="top"><input name="BtnCerrar" type="button" id="BtnCerrar" value="Cerrar Ventana" onClick="window.close()"></td>
  </tr>
</table>
<br>
</body>
