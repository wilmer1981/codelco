...
<html>
<head>
<title>Reporte Informe Suministro Excel</title>
...
<body>
  <form name="frmPrincipal" action="" method="post">
    <table width="974" height="330" border="0" align="center" cellpadding="0" cellspacing="0" left="5"  >
      <tr> 
        <td width="972" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="0">
          <tr>
            <td width="20%">&nbsp;</td>
