               ...
               <select name="CmbLey">
                 ...
                 <?
					...
					?>
                          ...
                          &nbsp;</span><a href="JavaScript:ProcesoVenta('NVER')"><img src="archivos/btn_agregar2.png" alt="Agregar" width="25" height="25"  border="0" align="absmiddle" /></a> <a href="JavaScript:ProcesoNuevo('NREC','VE','MostrarRec')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a></td>
           </tr>
         <tr>
	     ...
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>Cargos
	           ...
	           &nbsp;</span><a href="JavaScript:ProcesoVenta('NVECCA')"><img src="archivos/btn_agregar2.png" alt="Agregar" width="25" height="25"  border="0" align="absmiddle" /></a> <a href="JavaScript:ProcesoNuevo('NCAR','VE','MostrarCosto')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo " align="absmiddle" border="0" /></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	       ...
	       <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	         ...
	         <tr>
	           <td class='formulario2'>&nbsp;Contables
	             ...
	             &nbsp;</span><a href="JavaScript:ProcesoVenta('NVECC0')"><img src="archivos/btn_agregar2.png" alt="Agregar" width="25" height="25"  border="0" align="absmiddle" /></a> <a href="JavaScript:ProcesoNuevo('NLEY','VE','MostrarCosto')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a></td>
             </tr>
	         <tr>
	           <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	             <tr>
	     ...
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>Castigos
	           ...
	           &nbsp;</span><a href="JavaScript:ProcesoVenta('NVECAS')"><img src="archivos/btn_agregar2.png" alt="Agregar" width="25" height="25"  border="0" align="absmiddle" /></a> <a href="JavaScript:ProcesoNuevo('NCAS','VE','MostrarCast')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	         ...
	         <td class='formulario2'>&nbsp;Origen - Destino
               <select name="CmbOrigenTrans">
                 ...
                 <?
					...
					while ($Fila=mysql_fetch_array($Resp))
					{
						if ($CmbOrigenTrans==$Fila["cod_subclase"])
							echo "<option selected value='".$Fila["cod_subclase"]."'>".ucfirst(strtolower($Fila["nombre_subclase"]))."</option>\n";
						else
							echo "<option value='".$Fila["cod_subclase"]."'>".ucfirst(strtolower($Fila["nombre_subclase"]))."</option>\n";
					}
...
Valor
	           ...
	           &nbsp;</span><a href="JavaScript:ProcesoVenta('NVETRANS')"><img src="archivos/btn_agregar2.png" alt="Agregar" width="25" height="25"  border="0" align="absmiddle" /></a> <a href="JavaScript:ProcesoNuevo('NDES','VE','MostrarTras')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	     ...
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>Leyes
	           ...
	           &nbsp;</span><a href="JavaScript:ProcesoVenta('NVEPRE')"><img src="archivos/btn_agregar2.png" alt="Agregar" width="25" height="25"  border="0" align="absmiddle" /></a> <a href="JavaScript:ProcesoNuevo('NLEY','VE','MostrarPre')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
