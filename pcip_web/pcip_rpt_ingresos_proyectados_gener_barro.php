...
function Proceso(TipoProceso)
{
	...
	{
		case "C":
			f.action = "pcip_rpt_ingresos_proyectados_gener_barro.php?Buscar=S";
			f.submit();
		break;
		case "E"://GENERA EXCEL
			URL='pcip_rpt_ingresos_proyectados_gener_barro_excel.php?&Ano='+f.Ano.value+'&Mes='+f.Mes.value+'&MesFin='+f.MesFin.value;
			window.open(URL,"","top=30,left=30,width=1000,height=550,status=yes,menubar=yes,resizable=yes,scrollbars=yes");
		break;				
		case "R":
			f.action = "pcip_rpt_ingresos_proyectados_gener_barro.php";
			f.submit();
			break;	
		case "I"://IMPRIMIR
			window.print();
...
<?
 $IP_SERV = $HTTP_HOST;
 EncabezadoPagina($IP_SERV,'reporte_gener_barro.png')
?>
...
<table width="100%" align="center" cellpadding="2" cellspacing="0" class="ColorTabla02">
   <tr>
    <td width="77" height="25" class='formulario2'>Periodo</td>
      ...
      <tr>
        ...
        <td background="archivos/images/interior/form_izq.gif">&nbsp;</td>
         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
          <tr>
            <td class="TituloTablaVerde" align="center" rowspan="2" colspan="2">Programa  Divisi&oacute;n Ventanas</td>	
			<?
			for($i=$Mes;$i<=$MesFin;$i++)
			{
			?>
            <td class="TituloTablaVerde"align="center" colspan="2"><? echo $Meses[$i-1]?></td>
            <?	
			}
			?>            
          </tr>
          <tr>
			...
			$ArrTotalPpto2[$i][0]=0;
			?>
            <td  class="TituloTablaVerde" align="center" >Real</td>
            <td class="TituloTablaVerde" align="center">Proyectado</td>
            <?	
			}
			?>
          </tr>
			<?			
			 ...
			 ?>
			    <tr class="texto_bold">
				<td class="texto_bold" align="center" colspan="2">Plata [kUS$]</td>
				<?
			    ...
			    <tr class="texto_bold">
				<td class="texto_bold" align="center" colspan="2">Oro [kUS$]</td>
				<?
