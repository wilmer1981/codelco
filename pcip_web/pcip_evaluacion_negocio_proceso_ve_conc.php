  ...
  <tr class='formulario2'>
   ...
   <tr>
	 <td colspan="2" class='formulario2'>Todos
	   ...
	   {
	   ?>
       <a href="JavaScript:ProcesoExpCont('VE','MostrarTodos','N')"><img src="archivos/ico_contra.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
       <?
	   }
	   else
	   {
	   ?>
	   <a href="JavaScript:ProcesoExpCont('VE','MostrarTodos','S')"><img src="archivos/ico_expan.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
	   <? }?>
	 </td>
	 </tr>   
	 <tr align="center">
	 ...
	 <tr align="center">
	   ...
	   {
	   ?>
           <a href="JavaScript:ProcesoExpCont('VE','MostrarRec','N')"><img src="archivos/ico_contra.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>&nbsp;Recuperaci&oacute;n
               <select name="CmbRecup" onchange="JavaScript:Recuperaciones('VE','S')">
               ...
               <a href="JavaScript:ProcesoNuevo('NREC','VE','MostrarRec')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nueva Recuperaci�n" align="absmiddle" border="0" /></a>               </span>
	           Finos
	           <select name="CmbLey" onchange="JavaScript:Recuperaciones('VE','S')">
	           ...
	           <select name="CmbUnidad">
	             <option value="T" class="Selected">Seleccionar</option>
	             <?
					$Consulta = "select cod_subclase,nombre_subclase from proyecto_modernizacion.sub_clase where cod_clase='31051' and cod_subclase in('9','10')  ";			
					$Resp=mysqli_query($link, $Consulta);		
					while ($Fila=mysql_fetch_array($Resp))
					{
			   ...
			   <a href="JavaScript:ProcesoNuevo('NREC','VE')"></a></td>
             </tr>
	       <tr>
	   ...
	   {
	   ?>
         <a href="JavaScript:ProcesoExpCont('VE','MostrarRec','S')"><img src="archivos/ico_expan.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
         <? }?></td>
	 </tr>
	 <tr align="center">
	   ...
	   {
	   ?>
           <a href="JavaScript:ProcesoExpCont('VE','MostrarCosto','N')"><img src="archivos/ico_contra.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       <tr>
	         <td class="TituloTablaVerde" align="center">Ingreso de Parametros </td>
           </tr>
	       <tr>
	         <td class='formulario2'>Cargos
               <select name="CmbCargo" onchange="JavaScript:Aparece2('VE','S')">
                 <option value="-1" selected="selected" class="Selected">Seleccionar</option>
                 <?
               ...
               Unidad
	           <select name="CmbUnidad2" onchange="JavaScript:Aparece('VE','S')">
                 <option value="T" class="Selected">Seleccionar</option>
                 <?
	           ...
	           <a href="JavaScript:ProcesoNuevo('NCAR','VE','MostrarCosto')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo " align="absmiddle" border="0" /></a>         
	       		<a href="JavaScript:ProcesoAsig('NCAR','VE','S')"></a> </td>  
	       </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	   ...
	   {
	   ?>
           <a href="JavaScript:ProcesoExpCont('VE','MostrarCosto','S')"><img src="archivos/ico_expan.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
           <? }?>
           <!--<table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
           <tr>
           ...
           <tr>
             <td class='formulario2'>&nbsp;Valor
               ...
               &nbsp;</span><a href="JavaScript:ProcesoVenta('NVECC0')"><img src="archivos/btn_agregar2.png" alt="Agregar" width="25" height="25"  border="0" align="absmiddle" /></a> <a href="JavaScript:ProcesoNuevo('NLEY','VE')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a></td>
           </tr>
           <tr>
             <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
               <tr>
	   ...
	   {
	   ?>
           <a href="JavaScript:ProcesoExpCont('VE','MostrarCast','N')"><img src="archivos/ico_contra.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       <tr>
	         <td class="TituloTablaVerde" align="center">Ingreso de Parametros </td>
           </tr>
	       <tr>
	         <td class='formulario2'>&nbsp;Castigos
               <select name="CmbCastigo" onchange="JavaScript:Castigos('VE','S')">
                 <option value="-1" selected="selected" class="Selected">Seleccionar</option>
                 <?
				 ...
				 <? //consulto si existe el castigo en la ley arsenico es 4 y antimonio 5 cinc 6
					...
					{	
						...
						if(!$FilaLey=mysql_fetch_array($RespLey))
						{
							...
							Por Cada <input type="text" name="Cada" size="5" maxlength="4" value="0">%&nbsp;&nbsp;
							Sobre <input type="text" name="Sobre" size="5" maxlength="4" value="0">%
							<? 
						}
						else
						{	
	           ...
	           <a href="JavaScript:ProcesoNuevo('NCAS','VE','MostrarCast')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	   ...
	   {
	   ?>
         <a href="JavaScript:ProcesoExpCont('VE','MostrarCast','S')"><img src="archivos/ico_expan.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
         <? }?></td>
        </tr>
	 <tr align="center">
	   ...
	   {
	   ?>
           <a href="JavaScript:ProcesoExpCont('VE','MostrarFact','N')"><img src="archivos/ico_contra.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       <tr>
	         <td class="TituloTablaVerde" align="center">Ingreso de Parametros </td>
           </tr>
	       <tr>
	         <td class='formulario2'>&nbsp;Factores
               ...
               Valor
	           <input type="text" name="TxtValor8" size="10" />
	           Unidad
	           ...
	           <input type="text" name="TxtEuro" style="visibility:hidden" size="5"><input type="text" name="EURO" size="3" style="visibility:hidden" value="EURO" class="SinBorde"><br>
	   ...
	   {
	   ?>
         <a href="JavaScript:ProcesoExpCont('VE','MostrarFact','S')"><img src="archivos/ico_expan.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
         <? }?></td>
	 </tr>
	 <tr align="center">
	   ...
	   {
	   ?>
           <a href="JavaScript:ProcesoExpCont('VE','MostrarTras','N')"><img src="archivos/ico_contra.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       <tr>
	         <td class="TituloTablaVerde" align="center">Ingreso de Parametros  </td>
           </tr>
	       <tr>
	         <td class='formulario2'>&nbsp;
	           Origen - Destino
                 ...
                 <a href="JavaScript:ProcesoNuevo('NDES','VE','MostrarTras')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a>Finos
                 <select name="CmbLey">
                   <option value="T" class="Selected">Seleccionar</option>
                   <?
					$Consulta = "select cod_subclase,nombre_subclase from proyecto_modernizacion.sub_clase where cod_clase='31037' and cod_subclase not in ('0')  order by cod_subclase";			
	           ...
	           &nbsp;</span><a href="JavaScript:ProcesoVenta('NVETRANS')"><img src="archivos/btn_agregar2.png" alt="Agregar" width="25" height="25"  border="0" align="absmiddle" /></a> <a href="JavaScript:ProcesoNuevo('NDES','VE')"></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	   ...
	   {
	   ?>
         <a href="JavaScript:ProcesoExpCont('VE','MostrarTras','S')"><img src="archivos/ico_expan.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
         <? }?></td>
	 </tr>
	 <tr align="center">
	   ...
	   {
	   ?>
           <a href="JavaScript:ProcesoExpCont('VE','MostrarPre','N')"><img src="archivos/ico_contra.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       <tr>
	         <td class="TituloTablaVerde" align="center">Ingreso de Parametros  </td>
           </tr>
	       <tr>
	         <td class='formulario2'>&nbsp;Base o Digitar
               <select name="CmbDatosBuscar" onchange="JavaScript:SeleccionCombo('VE','S')">
                 <?
			   ...
			   <?
				   ...
				   $Consulta.="where t1.corr='".$Cod."' and t1.cod_tipo_analisis='".$CodTipoAnalisis."' and QP<>'0'";
				   //echo $Consulta;
				   $Resp=mysqli_query($link, $Consulta);
			   ...
			   ?>
				...
				<?  if($CmbDatosBuscar==1)
				 ...
				 ?>
					...
					<select name="CmbFino" onchange="JavaScript:SeleccionCombo('VE','S')">
					  <option value="T" class="Selected" >Seleccionar</option>
					  <?
	           ...
	           <a href="JavaScript:ProcesoNuevo('NLEY','VE')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	   ...
	   {
	   ?>
         <a href="JavaScript:ProcesoExpCont('VE','MostrarPre','S')"><img src="archivos/ico_expan.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
         <? }?></td>
	 </tr>
   </table>
   </td>
