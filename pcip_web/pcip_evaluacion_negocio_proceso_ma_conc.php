  ...
  <tr class='formulario2'>
   ...
   <tr>
	 ...
	 <tr align="center">
	     ...
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>&nbsp;Recuperaci&oacute;n
               <select name="CmbRecup" onchange="JavaScript:Recuperaciones('MA','S')">
			   ...
			   </span><a href="JavaScript:ProcesoNuevo('NREC','MA','MostrarRec')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nueva Recuperaci�n" align="absmiddle" border="0" /></a>
	           Finos
	           <select name="CmbLey" onchange="JavaScript:Recuperaciones('MA','S')">
			   ...
			   <a href="JavaScript:ProcesoNuevo('NREC','MA')"></a></td>
             </tr>
	       <tr>
	   ...
	   {
	   ?>
         <a href="JavaScript:ProcesoExpCont('MA','MostrarRec','S')"><img src="archivos/ico_expan.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
         <? }?></td>
	 </tr>
	 <tr align="center">
	     ...
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>Cargos&nbsp;&nbsp;
               <select name="CmbCargo" onchange="JavaScript:Aparece2('<? echo $Ptl;?>','S')">
                 <option value="-1" selected="selected" class="Selected">Seleccionar</option>
                 <?
               ...
               Unidad
	           <select name="CmbUnidad2" onchange="JavaScript:Aparece('<? echo $Ptl;?>','S')">
                 <option value="T" class="Selected">Seleccionar</option>
                 <?
	           ...
	           <a href="JavaScript:ProcesoNuevo('NCAR','<? echo $Ptl;?>','MostrarCosto')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo " align="absmiddle" border="0" /></a>     </td>        </tr>
		   <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	   ...
	   ?>
           ...
           <tr>
             <td class='formulario2'>&nbsp;Valor
               ...
               &nbsp;</span><a href="JavaScript:ProcesoVenta('NVECC0')"><img src="archivos/btn_agregar2.png" alt="Agregar" width="25" height="25"  border="0" align="absmiddle" /></a> <a href="JavaScript:ProcesoNuevo('NLEY','MA')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a></td>
           </tr>
           <tr>
             <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
               <tr>
	     ...
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>Castigos
               <select name="CmbCastigo" onchange="JavaScript:Castigos('<? echo $Ptl;?>','S')">
                 <option value="-1" selected="selected" class="Selected">Seleccionar</option>
                 <?
	           ...
	           <a href="JavaScript:ProcesoNuevo('NCAS','<? echo $Ptl;?>','MostrarCast')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	 ...
	 <tr align="center">
	   ...
	   {
	   ?>
           <a href="JavaScript:ProcesoExpCont('<? echo $Ptl;?>','MostrarFact','N')"><img src="archivos/ico_contra.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       <tr>
	         <td class="TituloTablaVerde" align="center">Ingreso de Parametros  </td>
           </tr>
	   ...
	   {
	   ?>
         <a href="JavaScript:ProcesoExpCont('<? echo $Ptl;?>','MostrarFact','S')"><img src="archivos/ico_expan.gif" alt="Agregar" width="15" height="15"  border="0" align="absmiddle" /></a>
         <? }?></td>
	 </tr>
	 <tr align="center">
	     ...
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>Premios
	           ...
	           <a href="JavaScript:ProcesoNuevo('NPREM','<? echo $Ptl;?>')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	           ...
	           <?
				   ...
				   while($Fila=mysql_fetch_array($Resp))
				   {
						...
						echo "<td align='center' width='1%'><a href=JavaScript:ProcesoVenta('EVEPREM','".$Codigo."')><img src='archivos/elim_hito.png'  alt='Eliminar' align='absmiddle' border='0' width='15' height='15'></a></td>";
						echo "<td width='15%' align='center'>".$Fila[nom_premio]."</td>";
						echo "<td width='15%' align='center'>".$Fila[valor]."</td>";
						echo "<td width='15%' align='center'>".$Fila[nom_unidad]."</td>";
						echo "<td width='15%' align='center'>".number_format($Fila[euro],2,',','.')."&nbsp;</td>";
						echo "<tr>";	
				   }
				 ?>
	           </table></td>
	     ...
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>&nbsp;Origen
	           ...
	           <a href="JavaScript:ProcesoNuevo('NDES','MA','MostrarTras')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a>
				Finos
				<select name="CmbLey">
				  <option value="T" class="Selected">Seleccionar</option>
				  <?
			  ...
			  <a href="JavaScript:ProcesoNuevo('NDES','MA')"></a></td>
              </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	     ...
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>&nbsp;Base o Digitar
               ...
               <?  if($CmbDatosBuscar==1)
				...
				<select name="CmbFino" onchange="JavaScript:SeleccionCombo('CO','S')">
				  ...
				  <?
						...
						<input type="hidden" class="SinBorde" name="CmbUnidad62" size="2" value="<? echo $CodUni;?>"/>
	           ...
	           <a href="JavaScript:ProcesoNuevo('NLEY','<? echo $Ptl;?>')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0" /></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
