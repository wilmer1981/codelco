	     ...
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>&nbsp;
	           ...
	           <a href="JavaScript:ProcesoNuevo('NREC','CO','MostrarRec')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0"></a></td>
             </tr>
	       <tr>
...
Valor
	           ...
	           <a href="JavaScript:ProcesoNuevo('NCAR','CO','MostrarCosto')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo " align="absmiddle" border="0"></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	       ...
	       <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	         ...
	         <tr>
	           <td class='formulario2'>&nbsp;Contables
	             ...
	             <a href="JavaScript:ProcesoNuevo('NLEY','CO','MostrarCosto')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0"></a></td>
             </tr>
	         <tr>
	           <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	             <tr>
	     ...
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>&nbsp;Castigos
	           ...
	           <a href="JavaScript:ProcesoNuevo('NCAS','CO','MostrarCast')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0"></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
	     ...
	     <table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
	       ...
	       <tr>
	         <td class='formulario2'>&nbsp;Origen - Destino
	           ...
	           <a href="JavaScript:ProcesoNuevo('NDES','CO','MostrarTras')"><img src="archivos/btn_ingreso_obs2.png"  alt="Ingresar Nuevo" align="absmiddle" border="0"></a></td>
           </tr>
	       <tr>
	         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
	           <tr>
