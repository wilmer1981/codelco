...
{
	var f= document.FrmPopupProceso;
	if(confirm('Esta Seguro de Duplicar esta Versi�n'))
	{
   ...
   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
     ...
     <tr>
	   ...
	   <table width="100%" border="0" cellpadding="3" cellspacing="0" >
		 ...
		 <tr>
           <td width="14%" class="formulario2" align="justify">Descripci�n</td>
          ...
          <tr>
           <td colspan="2" class="formulario2"><table width="100%" border="1" cellpadding="4" cellspacing="0" >
             <tr align="center">
               ...
               <td width="12%" class="TituloTablaVerde">N&ordm; Versi�n </td>
               <td width="10%" class="TituloTablaVerde">A�o</td>
			   <td width="10%" class="TituloTablaVerde">Mes</td>
			   <td width="15%" class="TituloTablaVerde">Fecha Creaci�n</td>
			   <td width="35%" class="TituloTablaVerde">Descripci�n</td>
			   <td width="15%" class="TituloTablaVerde">Ult.Versi�n</td>
             </tr>
             <?
             ...
             <tr class="FilaAbeja">
               ...
               <td align="center"><a href="JavaScript:Duplicar('<? echo $Cod;?>','<? echo $Ano;?>','<? echo $Mes;?>')"><img src="../pcip_web/archivos/duplicar2.png"  border="0"  alt=" Duplicar Versi�n " align="absmiddle"></a></td>
