...
function Guardar()
{
	var f= document.FrmPopupProceso;
		f.action = "pcip_mantenedor_asigna_productos_por_grupo_proceso01.php?Opc=G&Producto="+f.CmbProducto.value+"&Grupo="+f.CmbGrupo.value;
		f.submit();
...
{
	var f= document.FrmPopupProceso;
		f.action = "pcip_mantenedor_asigna_productos_por_grupo_proceso01.php?Opc=E&Cod="+Cod;
		f.submit();
...
function Recarga()
{
	...
	f.action = "pcip_mantenedor_asigna_productos_por_grupo.php";
	f.submit();
}
function Salir()
{
          ...
          <tr>
           <td colspan="2" class="formulario2"><table width="100%" border="1" cellpadding="4" cellspacing="0" >
             ...
             <?
				...
				$Consulta = "select t1.nom_producto,t1.cod_producto,t3.nombre_subclase,t1.vigente"; 
