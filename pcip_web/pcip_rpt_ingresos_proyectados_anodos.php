					   ...
					   //PROVEEDORES EN DURO
						...
						$ArrTotal2[$i][0]=0;
						  ...
						  {			
							  ?>						  				  
							<tr class="Formulario2">
							<td rowspan="1" colspan="25" align="left">Sur Andes, �nodos (c�todos rechazados: l�minas y despuntes)</td>
							</tr>
							  <tr class="FilaAbeja3">
								<td align="left">TMS</td>
								<?
							...
							<tr class="Formulario2">
							<td rowspan="1" colspan="25" align="left">Sur Andes, �nodos (c�todos est�ndar)</td>
							</tr>
							  <tr class="FilaAbeja3">
								<td align="left">TMS</td>
								<?
