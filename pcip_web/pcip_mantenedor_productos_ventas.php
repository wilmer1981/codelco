...
function Proceso(Opc)
{
	...
	{
		case "C":
			f.action="pcip_mantenedor_productos_ventas.php?&Buscar=S";
			f.submit();
		break;
		case "N":
			URL="pcip_mantenedor_productos_ventas_proceso.php?Opc="+Opc;
			opciones='top=30,toolbar=0,resizable=0,menubar=0,status=1,width=750,height=300,scrollbars=1';
		...
		case "M":
			if(SoloUnElemento(f.name,'CheckTipoDoc','M'))
			{
				...
				URL="pcip_mantenedor_productos_ventas_proceso.php?Opc="+Opc+"&Valores="+Datos;
		...
		break;
		case "A":
				URL="pcip_mantenedor_asigna_productos_ventas_por_grupo.php";
		...
		break;					
		case "O":
				URL="pcip_mantenedor_asigna_productos_ventas_por_ordenes.php?";
				opciones='top=30,toolbar=0,resizable=0,menubar=0,status=1,width=660,height=650,scrollbars=1';
				verificar_popup(popup);
				popup=window.open(URL,"",opciones);
				popup.focus();
		...
		case "E":
			if(SoloUnElemento(f.name,'CheckTipoDoc','E'))
			{
				...
				{
					Datos=Recuperar(f.name,'CheckTipoDoc');
					f.action='pcip_mantenedor_productos_ventas_proceso01.php?Opcion=E&Valor='+ Datos; //Datos; //+"&Pagina="+f.Pagina.value;
					f.submit();
				}
			}	
		break;
		case "R":
			f.action = "pcip_mantenedor_productos_ventas.php";
			f.submit();
		break;				
		case "S":
...
<?
 $IP_SERV = $HTTP_HOST;
 EncabezadoPagina($IP_SERV,'mant_productos_ventas.png')
 ?>
   <table width="950" align="center"  border="0" cellpadding="0"  cellspacing="0" class="TablaPricipalColor">
    ...
    <tr>
      ...
      <td>
		<table width="100%" cellpadding="2" cellspacing="0">
		  <tr>
				...
				<a href="JavaScript:Proceso('O')"><img src="../pcip_web/archivos/btn_ingreso_obs2.png"  alt="Asigna Producto a Ordenes" align="absmiddle" border="0"></a>
      ...
      <tr>
    	<td width="168" height="17" class='formulario2'>Producto</td>
      ...
      <tr>
    	<td width="168" height="17" class='formulario2'>Vigente</td>
    	<td class="formulario2" ><select name="CmbVig" onChange="Proceso('R')">
...
<table width="950" align="center"  border="0" cellpadding="0"  cellspacing="0" class="TablaPricipalColor">
  ...
  <td ><img src="../pcip_web/archivos/images/interior/esq2em.gif" width="15" /></td>
	  ...
	  <tr align="center">
          ...
          <td width="12%" class="TituloTablaVerde">Codigo</td>		  
          <td width="43%" class="TituloTablaVerde">Producto</td>
		  <td width="12%" class="TituloTablaVerde">Vigente</td>
	  </tr>
<?
if($Buscar=='S')
{
	$Consulta = "select t1.cod_producto,t1.nom_producto,t2.nombre_subclase as nom_vig";
	$Consulta.= " from pcip_cdv_productos_ventas t1 inner join proyecto_modernizacion.sub_clase t2 on t2.cod_clase='31007' and t2.cod_subclase=t1.vigente";
