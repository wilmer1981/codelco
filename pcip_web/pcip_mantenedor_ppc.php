...
<html>
<head>
<title>Mantenedor Programa Producci�n</title>
<style type="text/css">
<!--
body {
  ...
  <tr>
   ...
   <td>
	...
	<tr>
		...
		<a href="JavaScript:Procesos('NV')"><img src="archivos/btn_ingreso_obs2.png"  border="0"  alt="Nueva Versi�n" align="absmiddle" /></a>&nbsp;
...
?>
      ...
      <tr>
		...
		while ($Fila=mysql_fetch_array($Resp))
		{
          ...
          <input type="text" name="textfield" style='background:"#339900"' size="2">&nbsp;&nbsp;Ultima Versi�n
          <label></label>
        </span></tr>
      <tr>
