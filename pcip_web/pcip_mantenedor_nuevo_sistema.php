		...
		<table width="100%" cellpadding="2" cellspacing="0">
		  <tr>
	         ...
	         <td width="81%" align="right" class='formulario2' >
				...
				<a href="JavaScript:Proceso('I')"><img src="../pcip_web/archivos/btn_ingreso_obs2.png" border="0" alt="Relaci�n Sistema Indicador" align="absmiddle"></a> 				
				<a href="JavaScript:Proceso('O')"><img src="../pcip_web/archivos/btn_ingreso_obs2.png" border="0" alt="Relaci�n Sistema Centro Costo" align="absmiddle"></a> 				
				<!--<a href="JavaScript:Proceso('A')"><img src="../pcip_web/archivos/btn_ingreso_obs2.png" border="0" alt="Relaci�n Sistema Equipo" align="absmiddle"></a> -->				
	...
	<table width="930" border="1" cellpadding="4" cellspacing="0" >
	  ...
	  <tr align="center">
        <td width="3%" class="TituloTablaVerde"><input class='SinBorde' type="checkbox" name="CheckTipoDoc" value="" onClick="CheckearTodo(this.form,'CheckTipoDoc','ChkTodos');"></td>
          ...
          <td width="13%" class="TituloTablaVerde">C�digo</td>
          <td width="25%" class="TituloTablaVerde">Sistema</td>
		  <td width="35%" class="TituloTablaVerde">Descripci�n del Sistema</td>
