...
//	}	
	...
	$Consulta = "select * from ValorizacProduccion where VPa�o=".$Ano." and VPmes=".$Mes;
	//$Consulta = "select * from ValorizacProduccion ";
	//echo $Consulta;
	$Respuesta= odbc_exec($conexion,$Consulta);
	while ($Fila = odbc_fetch_row($Respuesta))
	{  
		$Insertar="INSERT INTO `pcip_svp_valorizacproduccion` (`VPa�o`,`VPmes`,`VPorden`,`VPtm`,`VPsubtm`,`VPordenrel`,`VPmaterial`,`VPtipinv`,`VPtv`,`VPordes`,`VPcantidad`,`VPcostun`,`VPvalor`,`VPdiaref`) VALUES ";
		$Insertar.="('".odbc_result($Respuesta,"VPa�o")."','".odbc_result($Respuesta,"VPmes")."','".odbc_result($Respuesta,"VPorden")."','".odbc_result($Respuesta,"VPtm")."','".odbc_result($Respuesta,"VPsubtm")."','".odbc_result($Respuesta,"VPordenrel")."','".odbc_result($Respuesta,"VPmaterial")."','".odbc_result($Respuesta,"VPtipinv")."',";
...
//	mysql_query($Eliminar);
	...
	$Eliminar='delete from pcip_svp_valorizacproduccion where VPa�o="'.$Ano.'" and VPmes="'.$Mes.'" ';
	mysql_query($Eliminar);
