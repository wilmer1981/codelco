...
function Proceso(TipoProceso)
{
	...
	{
		case "C":
			f.action = "pcip_rpt_ingresos_proyectados_precio_barro.php?Buscar=S";
			f.submit();
		break;
		case "E"://GENERA EXCEL
			URL='pcip_rpt_ingresos_proyectados_precio_barro_excel.php?&Ano='+f.Ano.value+'&Mes='+f.Mes.value+'&MesFin='+f.MesFin.value;
			window.open(URL,"","top=30,left=30,width=1000,height=550,status=yes,menubar=yes,resizable=yes,scrollbars=yes");
		break;				
		case "R":
			f.action = "pcip_rpt_ingresos_proyectados_precio_barro.php";
			f.submit();
			break;	
		case "I"://IMPRIMIR
			window.print();
...
<?
 $IP_SERV = $HTTP_HOST;
 EncabezadoPagina($IP_SERV,'reporte_precio_barro.png')
?>
      ...
      <tr>
        ...
        <td background="archivos/images/interior/form_izq.gif">&nbsp;</td>
         <td><table width="100%" border="1" align="center" cellpadding="2" cellspacing="0" >
          <tr>
            <td class="TituloTablaVerde" align="center" rowspan="2">Precio Barro An�dico Descobrizado</td>	
			<?
