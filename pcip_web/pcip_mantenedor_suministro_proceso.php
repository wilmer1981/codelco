...
<?
	if ($Opcion=='N')
		echo "<title>Nuevo Suministro</title>";
	else	
		echo "<title>Modifica Suministro</title>";
?>
	...
	{	
		case "N":
			...
			if (Veri==true)
			{
				...
				f.action = "pcip_mantenedor_suministro_proceso01.php?Opcion="+Opcion+"&Valores="+Valores;
				f.submit();
			}
		break;
		case "M":
		...
		case "NI":
			f.Opcion.value='N';
			f.action = "pcip_mantenedor_suministro_proceso.php?Opcion=N";
			f.submit();
		break;

		case "R":	
			f.action = "pcip_mantenedor_suministro_proceso.php?Recarga=S";
			f.submit();
		break;
	}
}
...
<input name="Codigos" type="hidden" value="<? echo $Codigos; ?>">
  ...
  <tr>
   ...
   <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
     <tr>
       <td width="74%" align="left"><?	if($Opcion=='N'){?><img src="archivos/sub_tit_suministro_n.png" width="450" height="40"><? }else{?><img src="archivos/sub_tit_suministro_m.png" width="450" height="40"><? }?></td>
       <td align="right">
		...
		while ($FilaTC=mysql_fetch_array($Resp))
		{
         ...
         <tr>
		   ...
		   <?
				...
				echo "<span class='formulario2'>".$CodCC."</span>";	
		   ?>
		   </td>
         </tr>
         <tr>
           <td height="25" class="formulario2">Tipo</td>
           <td colspan="3" class="FilaAbeja2">
		   <?
		   if($Opcion=='N')
		   {
		   ...
		   <?
				...
				echo "<span class='formulario2'>".$Tipo."</span>";	
		   ?>
		   </td>
         </tr>
         ...
         <tr>
           <td colspan="4" class='formulario2'><table width="100%" border="1" cellpadding="4" cellspacing="0" >
             <tr>
               <td colspan="13" align="center" class="TituloTablaNaranja">Valores a Ingresar </td>
             </tr>
             <tr align="center">
             ...
             <?
				if($Opcion=='M')
				{
					 for($i=1;$i<=12;$i++)
					 {
						...
						{
						?>	
						<td align="right"><input type='text' name='TxtValorMes' value='<? echo $FilaMes[valor];?>' size='6' onkeydown='TeclaPulsada(false)' maxlength="7"></td>
						<?
						}else{		
						?>
						<td><input type='text' name='TxtValorMes' value='' size='6' onkeydown='TeclaPulsada(false)' maxlength="7"></td>
						<?
						}	
					 }
			   }
