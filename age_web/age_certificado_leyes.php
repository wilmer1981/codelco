<?php
	...
	foreach($Datos as $c => $v)
	{
		...
		if ($Fila = mysqli_fetch_array($Resp))
		{
			...
			if ($ENM!="S")
			{
				$pdf->addText(345,610,10,"PESO SECO",0,0);
				$pdf->addText(470,610,10,":",0,0);	
				$pdf->addText(475,610,10,number_format($PesoSecoLote,$CantDec,',','.'),0,0);
				$pdf->addText(530,610,10,"Kgrs.",0,0);				
