...
<html>
<head>
<title>AGE-Consulta Leyes Historicas</title>
<link href="../principal/estilos/css_principal.css" rel="stylesheet" type="text/css">
<script language="JavaScript">
function Recarga3()
{
	var Frm = frmPrincipal;
	Frm.action="age_con_leyes_historicas.php?Busq=S";
	Frm.submit();	
}
<!--
function Proceso(opt)
{
	...
	switch (opt)
	{
		...
		case "C":
			...
			{
				alert("El Año de Inicio no puede ser Mayor al Final");
				f.CmbAnoIni.focus();
				return;
			}
			f.action = "age_con_leyes_historicas_mensual.php";
			f.submit();
			break;		
		case "R":
			f.action = "age_con_leyes_historicas.php";
			f.submit();
			break;
	}
}
  ...
  <table width="770" border="0" cellspacing="0" cellpadding="5" class="TablaPrincipal">
    <tr>
      <td height="300" align="center" valign="middle">
          <table width="617" height="169" border="13" cellpadding="3" cellspacing="0" class="TablaInterior">
            ...
            <tr> 
              ...
              <td width="498"><select name="CmbSubProducto" style="width:300" onChange="Proceso('R')">
            ...
            <tr>
              ...
              <input name="BtnVer" type="button" id="BtnVer" value="Ver Limites" style="width:70px " onClick="Proceso('VL')"></td>
            </tr>
            <tr>
              <td height="22" align="right"><img src="../principal/imagenes/left-flecha.gif" width="11" height="11"> </td>
