...
<form name="frmPrincipal" action="" method="post">
  <table width="620" border="0" align="center">
    <tr>
      <td width="294" colspan="5">CODELCO CHILE<br>
        DIVISION VENTANAS <br> </td>
      <td width="296" align="right" colspan="6">FECHA:&nbsp;<?php echo date("d-m-Y")?></td>
    </tr>
    <tr align="center">
      <td height="30" colspan="11"><strong><u>RECEPCION DE CONJUNTOS</u></strong></td>
    </tr>
    <tr align="center">
      <td colspan="11"><?php echo substr($TxtFechaIni,8,2)."-".substr($TxtFechaIni,5,2)."-".substr($TxtFechaIni,0,4)." al ".substr($TxtFechaFin,8,2)."-".substr($TxtFechaFin,5,2)."-".substr($TxtFechaFin,0,4) ?></td>
    </tr>
  </table>
  <br>
  <?php
...
{			
	...
	$Consulta.= " where t1.lote<>'' and t1.num_conjunto<>'' and t1.num_conjunto<>'0' ";
