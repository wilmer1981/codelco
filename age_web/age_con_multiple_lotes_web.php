...
function Proceso(opt)
{
	...
	{		
		case "I":
			...
			break;	
		case "S":
			f.action = "age_con_multiple_lotes.php";
			f.submit();
			break;
	}
}
function DetalleLote(Lote,Recargo)
{
	window.open("../age_web/age_adm_leyes_lote.php?EsPopup=S&TxtLote="+Lote+"&Recargo="+Recargo,"","top=0,left=0,width=1000,height=600,scrollbars=yes,resizable = yes");					
}
</script>
<style type="text/css">
body {
...
<table width="500"  border="1" align="center" cellpadding="2" cellspacing="0" class="TablaInterior">
  <tr align="center" class="ColorTabla02">
    <td colspan="2"><strong>CONSULTA  DE LEYES POR LOTES </strong></td>
  </tr>
<?php
	if ($OpcConsulta=="F")
	{
...
<?php
	if (isset($TxtLeyesMuestra) && $TxtLeyesMuestra!="")
	{
?>  
  <tr>
    <td class="Detalle01">Leyes:</td>
    <td><?php echo $TxtLeyesMuestra; ?></td>
  </tr>
<?php
	}
	if (isset($TxtLimitesMuestra) && $TxtLimitesMuestra!="")
	{
?>  
  <tr>
    <td class="Detalle01">Limites:</td>
    <td><?php echo $TxtLimitesMuestra; ?></td>
  </tr>
<?php
	}
?>  
			...
			if (mysqli_data_seek ($Resp, $i)) 
			{
				...
				{        				
					...
					if ($OpcTR=="R")
					{
						...
						//FARAecho "<td align='center'><a href=".$Lote.">$Lote</a></td>\n";
						echo "<td><a href=\"JavaScript:DetalleLote('".$Lote."','".$Recargo."')\">$Lote</a></td>";
						if ($OpcTR=="R")			
					...
					if ($Totalizar)
					{
						...
						if ($OpcTR=="R")			
						{		
							echo "<td colspan='".$ColSpanSubTotal."' align='left'><a href=JavaScript:DetalleLote('".$Lote."','')>".$Negrita01."Total Lote:&nbsp;".$Lote."".$Negrita02."</a></td>\n";
						}
						else
						{
							$Negrita01 = "";
							...
							if ($OpcConsulta != "C")
								...
								echo "<td align='center'>".$N_Conjto."</td>\n";
							echo "<td colspan='".($ColSpanSubTotal-1)."' align='center'><a href=\"JavaScript:DetalleLote('".$Lote."','')\">".$Negrita01."".$Lote."".$Negrita02."</a></td>\n";
						}
						if ($Humedad==true)
