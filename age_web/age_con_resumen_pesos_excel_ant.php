...
<html>
<head>
<title>Resumen Peso Humedo y Peso Seco</title>
</head>
...
<form name="frmPrincipal" action="" method="post">
  <table width="620" border="0" align="center">
    <tr>
      <td width="294" colspan="3">CODELCO DIVISION VENTANAS </td>
      <td width="296" align="right" colspan="2">FECHA:&nbsp;<?php echo date("d-m-Y")?></td>
    </tr>
    <tr align="center">
      <td height="30" colspan="5"><strong><u>RESUMEN DE PESO HUMEDO Y PESO SECO </u></strong></td>
    </tr>
    <tr align="center">
      <td colspan="5">MES: <?php echo $CmbMes."-".$CmbAno; ?></td>
    </tr>
  </table>
  <br>
  <?php
