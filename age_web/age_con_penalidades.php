...
function CargaParametros(opt)
{
	...
	{
		case "LEY":
			URL="age_seleccion_leyes_penalidades.php?Plantilla="+f.Plantilla.value+"&AnoApl=" +f.CmbAno.value+"&MesApl="+f.CmbMes.value;
			break;
	}	
...
function Recarga3()
{
	...
	Frm.action="age_con_penalidades.php?Busq=S";
	Frm.submit();	
}
function Proceso(opt)
{
	...
	switch (opt)
	{
		...
		case "C2":
			...
			f.action="age_con_penalidades_web2.php";
			f.submit();
			break;
		case "E":
