...
function Proceso(opt)
{
	...
	{
		case "C":
			f.action="age_con_recepciones_productos_web.php";
			f.submit();
			break;
		case "E":
			f.action="age_con_recepciones_productos_excel.php";
			f.submit();
			break;
		case "R":
...
function Recarga3()
{
	...
	Frm.action="age_con_recepciones_productos.php?Busq=S";
	Frm.submit();	
}
</script>
  ...
  <table width="770" height="316" border="0" cellpadding="5" cellspacing="0" class="TablaPrincipal" left="5">
    <tr> 
      ...
      <input name="BtnOkA2" type="button" value="Ok" onClick="Recarga3()"></td>
          ...
          <tr> 
            <td width="110" class="Detalle02">&gt;&gt;Ver:</td>
