...
function Proceso(opt)
{
	...
	{
		case "C":
			f.action="age_con_resumen_compra_vendedor_web_decimales.php";
			f.submit();
			break;
		case "C2":
			f.action="age_con_resumen_compra_vendedor_web_decimales.php";
			...
			break;
		case "E":
			f.action="age_con_resumen_compra_vendedor_excel.php";
			f.submit();
			break;
		case "E2":
			f.action="age_con_resumen_compra_vendedor_excel2.php";
			f.submit();
			break;
		case "R":
			f.action="age_con_resumen_compra_vendedor_decimales.php";
			f.submit();
			break;
		case "S":
...
<title>Agencia Ventanas - Resumen Compra Vendedor</title>
