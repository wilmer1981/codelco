<?php 	
	...
	if ($Recarga=='S')
	{
		...
		$Consulta = "select rut_prv as RUTPRV_A, nombre_prv as NOMPRV_A from sipa_web.proveedores where rut_prv='".$TxtRutPrv."'";
...
function Grabar(Proceso,Valores)
{
	...
	Frm.action="age_proveedores_proceso01.php?Proceso="+Proceso;
	Frm.submit();
}
function Eliminar()
{
