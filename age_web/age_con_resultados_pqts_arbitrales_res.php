	...
	switch (opt)
	{
		case "B"://BUSCAR
			if(f.TxtLoteIni.value=='')
			{
				...
				{
					f.TipoB.value = 'BOE';
					f.action = "age_con_resultados_pqts_arbitrales_res.php?Recarga=S&TipoBusqueda=BOE&Buscar=S";
				}
				else
				{
					f.TipoB.value = 'BM';
					f.action = "age_con_resultados_pqts_arbitrales_res.php?Recarga=S&TipoBusqueda=BM&Buscar=S";
				}
			}
			else
			{
				...
				f.action = "age_con_resultados_pqts_arbitrales_res.php?Recarga=S&TipoBusqueda=BL&Buscar=S";
			}
			f.submit();		
			break;		
		case "I"://IMPRIMIR			
...
function TraeParametros()
{
	...
	var Tipo = f.TipoB.value;
	for (i=0;i<f.Traer.length;i++)
	{
		//alert (F.Traer[i].value);
		if (f.Traer[i].checked==true)
		{
			Valores=Valores + f.Traer[i].value +"//";
		}
	}
	if (Valores!='')
	{
			...
			if (Tipo=='BL')
			{
				Param1 = f.TxtLoteIni.value;
				Param2 = f.TxtLoteFin.value;
				f.action = "age_cambia_param_canje.php?Valores=" + Valores +"&Tipo="+Tipo+"&Param1="+Param1+"&Param2="+Param2;
			}
			if (Tipo=='BOE')
			{
				Param1 = f.TxtOrdenEnsaye.value;
				f.action = "age_cambia_param_canje.php?Valores=" + Valores +"&Tipo="+Tipo+"&Param1="+Param1;		
			}
			if (Tipo=='BM')
			{
				Param1 = f.CmbMes.value;
				Param2 = f.CmbAno.value;
				f.action = "age_cambia_param_canje.php?Valores=" + Valores +"&Tipo="+Tipo+"&Param1="+Param1+"&Param2="+Param2;
			}
			f.submit();	
	}
...
<?php
	echo'<input name="TipoB" type="hidden" value="'.$TipoB.'">';
?>
...
<table width="544"  border="1" align="center" cellpadding="2" cellspacing="0" class="TablaInterior">
  ...
  <tr align="center" class="Colum01">
	  <td height="30" colspan="4" class="Colum01">
		...
		<input name="Btntrae" type="button" value="Param Canje" style="width:80px" onClick="TraeParametros()">
	...
	<br>
	<table width='900'  border='1' align='center' cellpadding='1' cellspacing='0' class='TablaInterior'>
	<tr align="center" class="ColorTabla01">
	<td width="24" rowspan="2">Orden Param</td>
