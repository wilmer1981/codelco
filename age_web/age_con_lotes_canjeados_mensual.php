...
function Proceso(opt,opt2)
{
	...
	switch (opt)
	{
		case "B"://BUSCAR
			...
			{
				//BUSQUEDA POR MES(BM)
				f.action = "age_con_lotes_canjeados_mensual.php?Recarga=S&TipoBusqueda=BM&Buscar=S";
			}
			else
			{
				...
				f.action = "age_con_lotes_canjeados_mensual.php?Recarga=S&TipoBusqueda=BL&Buscar=S";
			}
			f.submit();		
			break;		
		case "I"://IMPRIMIR			
		...
		case "E"://EXCEL	
			if(f.TxtLoteIni.value=='')
			{
				f.action = "age_con_lotes_canjeados_mensual_excel.php?Recarga=S&TipoBusqueda=BM&Buscar=S";			}
			else
			{
				if(f.TxtLoteFin.value=='')
					f.TxtLoteFin.value=f.TxtLoteIni.value;
				f.action = "age_con_lotes_canjeados_mensual_excel.php?Recarga=S&TipoBusqueda=BL&Buscar=S";
			}
			f.submit();	
			break;		
		case "S"://SALIR
...
<table width="544"  border="1" align="center" cellpadding="2" cellspacing="0" class="TablaInterior">
  ...
  <tr align="center" class="Colum01">
	...
	<br>
	<table width='1500'  border='1' align='center' cellpadding='1' cellspacing='0' class='TablaInterior'>
