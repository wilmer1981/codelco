...
<script>
			...
			{
				DDDD="age_directorio_unidad.php?Abre=S&Dir="+directorio+"&file="+file+"&cl=<?php echo $cl;?>";
				//alert(DDDD)
			...
			function Eliminar(directorio,file)
			{
				...
				{
					f=document.Frm;
					window.location="age_directorio_unidad.php?Abre=N&EM=ELI&Directorio="+directorio+"&Dir="+directorio+"&fileD="+file+"&cl=<?php echo $cl;?>";
					//f.submit();
				}
			}
			function busca()
			{ var f=document.Frm;window.location="age_directorio_unidad.php?cl=<?php echo $cl;?>&Directorio="+f.Directorio.value;
			}
			</script>
         			<form name="Frm">
<?php
...
{	
	?>
    <script>function acc(){ var f=document.eee;f.action="age_directorio_unidad.php?cl="+f.cl.value;f.submit();}</script>
    <form name="eee">
    <table>
    <tr>
