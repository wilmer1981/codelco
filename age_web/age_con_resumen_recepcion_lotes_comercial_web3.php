	...
	{			
		...
		{					
			...
			{		
				...
				while($FilaLote=mysqli_fetch_array($RespLote))
				{
					...
					//
						...
						if ($LeyJcf !="")
						{
							$Entro = 1;
							$LeyJcf="(".$LeyJcf.")";
							$Busca = "select STRAIGHT_JOIN  t1.cod_leyes, t1.valor,t1.valor2, t2.cod_unidad, t2.abreviatura as nom_unidad, t2.conversion, t3.abreviatura as nom_ley,t3.nombre_leyes as nombre_ley ";
				...
				$TotalPesoHumPrv=0;$TotalPesoSecPrv=0;$TotalFinoCuPrv=0;$TotalFinoAgPrv=0;$TotalFinoAuPrv=0;$cuento=0;
			}
