...
function Proceso(opt)
{
	...
	switch (opt)
	{
		case "C":
			...
			f.action="age_con_resumen_lotes_rechazos_penalid_web.php";
			f.submit();
			break;
		case "E":
			if(f.TxtLeyesMuestra.value=="")
			...
			f.action="age_con_resumen_lotes_rechazos_penalid_excel.php";
			f.submit();
			break;
		case "R":
			f.action="age_con_resumen_lotes_rechazos_penalid.php";
			f.submit();
			break;
		case "S":
...
<title>Resumen Rechazos y Penalidades Prod. Metalicos</title>
  ...
  <table width="770" height="316" border="0" cellpadding="5" cellspacing="0" class="TablaPrincipal" left="5">
    <tr> 
	  ...
	  <table width="500" border="1" cellspacing="0" cellpadding="3" class="tablainterior">
          <tr align="center">
            <td colspan="2" class="Detalle02">RESUMEN RECHAZOS Y PENALIDADES PROD. METALICOS </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="left"><select name="CmbSubProducto" style="width:300" onKeyDown="TeclaPulsada2('N',false,this.form,'CmbFlujos');" onChange="Proceso('R')">
              ...
              <?php
				...
				$Consulta.= " where cod_producto='1' and cod_subproducto in('17') ";
          ...
          <tr> 
            ...
            <td width="372" align="left"><input name="OptLeyes" type="checkbox" value="S" checked>
              Leyes
