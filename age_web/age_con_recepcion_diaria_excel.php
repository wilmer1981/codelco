...
<body><form name="frmPrincipal" action="" method="post">
...
<br>
		  ...
		  <table width="750"  border="1" cellpadding="2" cellspacing="0" class="TablaDetalle">
            <tr class="ColorTabla01">
              ...
              <td width="6%">Guia</td>
              <td width="11%">Producto</a></td>
              <td width="21%">Proveedor</td>
              <td width="4%">Conj</a></td>
              <td width="3%">Cls</td>
              <td width="4%">Aut</td>
            </tr>
<?php	
...
function EscribeSubTotal($Opt, $NomProd, $NomRut, $PesoBr, $PesoTr, $PesoNt, $Reg)
{	
	switch ($Opt)
	{
		case "P":
