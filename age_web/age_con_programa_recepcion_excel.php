...
<table width="547" border="0" align="center" cellpadding="3" cellspacing="0">
          <tr align="center">
            <td width="1056" height="30" colspan="14"><strong>PROGRAMA DE RECEPCION A&Ntilde;O <?php echo $Ano; ?><br><br>
<?php
	switch ($ChkTipoProg)
	{
		case "00":
		...
		for ($Cont=1;$Cont<=3;$Cont++)
			{
				...
				{
					if ($j==1)
						echo "<tr class=\"Detalle01\" align=\"left\"><td colspan=\"14\">>>>&nbsp;&nbsp;".$Titulo."</td></tr>";
					$j++;				
