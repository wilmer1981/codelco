...
<html>
<head>
<title>AGE-Resumen Recepcion Lotes</title></head>
...
<form name="frmPrincipal" action="" method="post">
  <table width="620" border="0" align="center">
    ...
    <tr align="center">
      <td height="30" colspan="11"><strong><u>INFORME RECEPCION POR LOTES </u></strong></td>
    </tr>
    <tr align="center">
	...
	{			
		...
		{					
			...
			{		
				...
				$CodLoteIni=substr($CmbAno,3,1).str_pad($CmbMes,2,'0',STR_PAD_LEFT)."999";
