...
<html>
<head>
<title>AGE-Balance Operacional</title>
...
function Proceso(Proceso)
{
	...
	{
		case "B"://CONSULTAR
			Frm.action='age_balance_operacional.php?Proceso=B&Mostrar=S';
			Frm.submit();		
			break;
		case "E"://EXCEL
			Frm.action='age_balance_operacional_excel.php?Proceso=B&Mostrar=S';
			Frm.submit();		
			break;
		case "I"://IMPRIMIR			
			window.print();
			break;
		case "R"://RECARGA
			Frm.action='age_balance_operacional.php';
			Frm.submit();		
			break;
		case "S"://SALIR
...
<input type="hidden" name="Valores" value="">
    <table width="1000" border="1" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
      <tr align="center">
        <td height="23" colspan="6" class="Detalle02"><strong>BALANCE OPERACIONAL</strong></td>
      </tr>
      <tr>
