...
<form name="frmPrincipal" action="" method="post">
  <table width="620" border="0" align="center">
    ...
    <tr align="center">
      <td height="30" colspan="2"><strong><u>INFORME RECEPCION POR LOTES COMERCIAL CON FINOS PAGABLES </u></strong></td>
    </tr>
    <tr align="center">
			...
			{		
				...
				while($FilaLote=mysqli_fetch_array($RespLote))
				{
					...
					{   $ArrLeyesAux7 = isset($ArrLeyesAux[$c][7])?$ArrLeyesAux[$c][7]:0;
						...
						if($c!='01'&&$c!='02'&&$c!='04'&&$c!='05')
						{
							echo "<td align='right'>".number_format((float)$ArrLeyesAux[$c][7],$DecFinos,',','.')."</td>";
	...
	if($FilaDeduc=mysqli_fetch_array($RespDeduc))
	{
		...
		switch($FilaDeduc["cant_param"])
		{
			case "1":
				...
				break;
			case "2":
				//echo $ValorLey."--".$Valor1."--".$Valor2."</br>";
				if($ValorLey<=$Valor1)
					$ValorDed=$ValorFino;
				else
