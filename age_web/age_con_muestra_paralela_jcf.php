...
function Proceso(opt)
{
	...
	{		
		...
		case "I":
			...
			break;		
		case "R":
			f.action = "age_con_muestra_paralela_jcf.php?Mostrar=<?php echo $Mostrar; ?>";
			f.submit(); 
			break;
		case "C":
			f.action = "age_con_muestra_paralela_jcf.php?Mostrar=S";
			f.submit(); 
			break;
		case "E":
...
if ($Mostrar=="S")
{
	...
	$Proveedor ="77618440-3";
	$borra_tmp = "delete from age_web.tmp_control";
	...
	$Consulta.= " from age_web.tmp_lotes t1 inner join proyecto_modernizacion.subproducto t2 on t1.cod_producto=t2.cod_producto ";
	...
	while ($Fila = mysqli_fetch_array($Resp))
	{
		...
		while ($Fila2 = mysqli_fetch_array($Resp2))
		{
			...
			{				
				$ConsultaSi="Select * from age_web.tmp_control where lote_t = '".$Lote."'";
				$RespT=mysqli_query($link, $ConsultaSi);
				...
				{
					 $cuenta = 0;
					 $Consulta = "select * from age_web.tmp_lotes where "; /* estado_lote <>'6'and */ 
					 $Consulta.=" num_lote_remuestreo='".$Lote."' order by lote";
			...
			if ($cuenta>0)
			{
				...
				{
					$TxtRemuestreo=$A1[$k];	
					echo "<td><input checked name=\"ChkRemuestreo_".$k."_".$Lote."_".$Fila2["recargo"]."\" type=\"checkbox\" value=\"".$Valores."\" onClick=\"Habilita(this, '".$Lote."', '".$Fila2["recargo"]."')\"></td>\n";					
					echo "<td><input name=\"TxtRemuestreo_".$k."_".$Lote."_".$Fila2["recargo"]."\" type=\"text\" value=\"".$TxtRemuestreo."\" size=\"10\" maxlength=\"8\" class=\"InputCen\" style=\"background=#FFFFFF\"  onKeyDown=\"TeclaPulsada2('S',false,this.form,'')\"></td>\n";
				}
				for($j=$k-1;$j<4;$j++)
				{
					$TxtRemuestreo="";
					$Valores="";
					echo "<td><input checked name=\"ChkRemuestreo_".$j."_".$Lote."_".$Fila2["recargo"]."\" type=\"checkbox\" value=\"".$Valores."\" onClick=\"Habilita(this, '".$Lote."', '".$Fila2["recargo"]."')\"></td>\n";					
					echo "<td><input name=\"TxtRemuestreo_".$j."_".$Lote."_".$Fila2["recargo"]."\" type=\"text\" value=\"".$TxtRemuestreo."\" size=\"10\" maxlength=\"8\" class=\"InputCen\" style=\"background=#FFFFFF\"  onKeyDown=\"TeclaPulsada2('S',false,this.form,'')\"></td>\n";
			...
			else
			{
				for($l=1;$l<5;$l++)
				{
					$TxtRemuestreo="";
					$Valores ="";
					echo "<td><input name=\"ChkRemuestreo_".$l."_".$Lote."_".$Fila2["recargo"]."\" type=\"checkbox\" value=\"".$Valores."\" onClick=\"Habilita(this, '".$Lote."', '".$Fila2["recargo"]."')\"></td>\n";
					echo "<td><input disabled name=\"TxtRemuestreo_".$l."_".$Lote."_".$Fila2["recargo"]."\" type=\"text\" value=\"".$TxtRemuestreo."\" size=\"10\" maxlength=\"8\" class=\"InputCen\" style=\"background=#CCCCCC\"  onKeyDown=\"TeclaPulsada2('S',false,this.form,'')\"></td>\n";
				}
			}
			echo "</tr>\n";
		}
...
function Titulo($Prod, $NomProd, $Proved, $NomProved)
{
	...
	echo "<td colspan=\"10\">Proveedor:&nbsp;".str_pad($Proved,10,'0',STR_PAD_LEFT)."-".strtoupper($NomProved)."</td>\n";
	echo "</tr>\n";
	...
	echo "<td colspan=\"8\">Remuestreo</td>\n";
	echo "</tr>\n";
	...
	echo "<td width=\"57\">Num. 1</td>\n";
	echo "<td width=\"57\">S/N</td>\n";
	echo "<td width=\"57\">Num. 2</td>\n";
	echo "<td width=\"57\">S/N</td>\n";
	echo "<td width=\"57\">Num. 3</td>\n";
	echo "<td width=\"57\">S/N</td>\n";
	echo "<td width=\"57\">Num. 4</td>\n";
	echo "</tr>\n";
}//FIN FUNCION TITULO
