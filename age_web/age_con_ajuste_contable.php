			...
			while ($FilaProd = mysqli_fetch_array($RespProd))
			{
				...
				while ($FilaProv = mysqli_fetch_array($RespProv))
				{
					...
					while ($FilaLote = mysqli_fetch_array($RespLote))
					{
						...
						echo "<td>".number_format((float)$ArrLeyes022,2,',','')."</td>\n";
						echo "<td>".number_format((float)$ArrLeyes042,2,',','')."</td>\n";
						echo "<td>".number_format((float)$ArrLeyes052,2,',','')."</td>\n";
						echo "<td>".number_format((float)$ArrLeyes028,2,',','')."</td>\n";
						echo "<td>".number_format((float)$ArrLeyes048,2,',','')."</td>\n";
						echo "<td>".number_format((float)$ArrLeyes058,2,',','')."</td>\n";
