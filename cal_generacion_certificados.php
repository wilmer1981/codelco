...
<form  method="post" name="FrmGeneracion" action="" >
 <? include("../principal/encabezado.php")?>
  <table width="770" border="0" cellpadding="5" cellspacing="0"  left="5" class="TablaPrincipal">
   <input name="SA01" type="hidden" value="<? echo $SA  ?>">
    <tr> 
      <td width="456" valign="top"> 
          ...
          <table width="170" border="1"  class="ColorTabla01" cellpadding="3" cellspacing="0" >
            <?
					...
					if (($Mostrar == 'S' ) && ($CmbProductos == 1)) 
					{
						...
						$Consulta ="select distinct t3.nro_solicitud,t3.nro_sa_lims,nombre_subclase  from imp_web.proveedores t1 ";
						$Consulta = $Consulta.$Estado ; 
						...
						while ($Fila=mysql_fetch_array($Respuesta))
						{
							...
							echo "<td width='20'><input type='checkbox' name ='checkSA' value=''></td>"; 
                 					$VarSA=$Fila["nro_solicitud"];
 		              				echo "<td width='100'><input name='TxtSA' type='hidden' readonly style='width:100' maxlength='100' value =".$TxtSA = $Fila["nro_solicitud"]."><input name = 'TxtRecargo' type = 'hidden' value ='N'><input name='TxtEstadoO' type = 'hidden' value =".$TxtEstadoO = $Fila["nombre_subclase"]."><input name='TxtVarSA' type='text' readonly style='width:100' maxlength='100' value =".$VarSA."></td>";
          						echo "</tr>";		
						}
					}
					...
					if (($Mostrar =='S') && ($CmbProductos != 1))
					{
						$Consulta = " select  distinct t1.nro_solicitud,t1.nro_sa_lims,t1.tipo_solicitud ";
						...
						while ($Fila=mysql_fetch_array($Respuesta))
						{
							...
							echo "<td width='2'><input type='checkbox' name ='checkSA' value=''></td>"; 
              					        $VarSA=$Fila["nro_solicitud"];
							echo "<td width='100'><input name='TxtSA' type='hidden' readonly style='width:80' maxlength='80' value =".$TxtSA = $Fila["nro_solicitud"]."><input name = 'TxtRecargo' type = 'hidden' value ='N'><input name = 'TxtEstadoO' type = 'hidden' value =".$TxtEstadoO = $Fila["nombre_subclase"]."><input name='TxtVarSA' type='text' readonly style='width:80' maxlength='80' value =".$VarSA."></td>";
							echo "</tr>";		
						}
					}				
							...
							if ($Fila["tipo_solicitud"]=='A')
							{
								...
								if ($Fila2["NroSol"] == $Fila3["NroSolF"])
								 {							
									...
									echo "<td width='2'><input type='checkbox' name ='checkSA' value=''></td>"; 
		              					        $VarSA=$Fila["nro_solicitud"];
		              				                echo "<td width='100'><input name='TxtVarSA' type='text' readonly style='width:80' maxlength='80' value =".$VarSA."><input name='TxtSA' type='hidden' readonly style='width:80' maxlength='80' value =".$TxtSA = $Fila["nro_solicitud"]."><input name = 'TxtRecargo' type = 'hidden' value ='N'><input name = 'TxtEstadoO' type = 'hidden' value =".$TxtEstadoO = $Fila["nombre_subclase"]."></td>";
									echo "</tr>";		
								}
							}	
		...
		?>
              ...
              <input name="NumIni" type="text" id="NumIni2" value="<? echo $NumIni; ?>" size="10" maxlength="15">
              </font></font></font> 
		...
		?>
              </select> <input name="NumFin" type="text" id="NumFin2" value="<? echo $NumFin; ?>" size="10" maxlength="15"></td>
        ...
        <br> <table width="762" border="0" cellpadding="0" class="TablaInterior" bordercolor="#b26c4a">
          <tr class="ColorTabla01"> 
		   ...
		   if ($Mostrar =='O')
		   {
		  		...
		  		//echo  "<td width='100'><div align='center'>#SA LIMS</div></td>";
		   ...
		   {		
			...
			if ($Mostrar == 'I' )
			{
				for ($j = 0;$j <= strlen($SA); $j++)
				{
					...
					{	
						...
						$Consulta ="select   distinct t1.nro_solicitud,t1.nro_sa_lims,t3.nombre_subclase,t4.descripcion as DesProducto,t2.descripcion as DesSubProducto   from cal_web.solicitud_analisis t1";	
						$Consulta = $Consulta."	inner join proyecto_modernizacion.subproducto t2 ";
						$Consulta = $Consulta."	on t1.cod_producto = t2.cod_producto and t1.cod_subproducto = t2.cod_subproducto ";
						$Consulta = $Consulta. " inner join proyecto_modernizacion.sub_clase t3 on t3.cod_subclase = t1.estado_actual and t3.cod_clase = '1002'"; 
						$Consulta = $Consulta. " inner join proyecto_modernizacion.productos t4 on t4.cod_producto = t1.cod_producto "; 
			...
			if ($Mostrar == 'O')
			{
			 	$Consulta ="select   distinct t1.nro_solicitud,t1.nro_sa_lims,t1.estado_actual,t1.tipo_solicitud,t3.nombre_subclase,t4.descripcion as DesProducto,t2.descripcion as DesSubProducto   from cal_web.solicitud_analisis t1";	
				$Consulta = $Consulta."	inner join proyecto_modernizacion.subproducto t2 ";
			 	$Consulta = $Consulta."	on t1.cod_producto = t2.cod_producto and t1.cod_subproducto = t2.cod_subproducto ";
				$Consulta = $Consulta. " inner join proyecto_modernizacion.sub_clase t3 on t3.cod_subclase = t1.estado_actual and t3.cod_clase = '1002'"; 
				$Consulta = $Consulta. " inner join proyecto_modernizacion.productos t4 on t4.cod_producto = t1.cod_producto "; 
			 	...
			 	while ($Fila = mysql_fetch_array($Respuesta))
				{
					...
					{		
						...
						echo "<td width='5' align='rigth'><input type='checkbox' name ='checkAtender' value=''></td>"; 
        					echo "<td width='110'><div align='rigth'><input name='TxtSA' type='text' readonly style='width:100' maxlength='100' value =".$TxtSA = $Fila["nro_solicitud"]."><input name = 'TxtRecargo' type = 'hidden' value ='N'></div></td>";
						//echo "<td width='110'><div align='rigth'><input name='TxtSA' type='text' readonly style='width:100' maxlength='100' value =".$TxtSA = $Fila["nro_solicitud"]."><input name = 'TxtRecargo' type = 'hidden' value ='N'></div></td>";
						//echo "<td width='110'><div align='rigth'><input name='TxtSALIMS' type='text' readonly style='width:100' maxlength='100' value =".$TxtSALIMS = $Fila["nro_sa_lims"]."></div></td>";
						echo "<td width='100'><div align='rigth'><input name='TxtEstado' type='text' readonly style='width:100' maxlength='10' value =".$TxtEstado = $Fila["nombre_subclase"]."></div></td>";
						echo "<td width='250'><div align='rigth'><input name='TxtProducto' type='text' readonly style='width:250' maxlength='10' value ='".$TxtProducto = $Fila["DesProducto"]."'></div></td>";				
						echo "<td width='250'><div align='rigth'><input name='TxtProducto' type='text' readonly style='width:250' maxlength='10' value ='".$TxtProducto = $Fila["DesSubProducto"]."'></div></td>";				
						echo "</tr>";
