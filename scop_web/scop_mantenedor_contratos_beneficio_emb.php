...
function RecargaBEN(Opc,check)
{
	var f= document.FrmPopupProceso;
	var R='';
	f.action = "scop_mantenedor_contratos_proceso.php?Opc="+Opc+"&TabBen=true&CheckBEN="+check+"&R=S";
	f.submit();
}
</script>
<table width="100%"  border="0" align="center" cellpadding="0"  cellspacing="0">	
  <tr class="formulario2">
	 <td width="70%">
	   Tipo de Flujos
	     <input name="radiobeneficio" id="cbbCustomer" onclick="RecargaBEN('<? echo $Opc;?>','1')" type="radio" class="SinBorde" value="1" <? if($CheckBEN=='1') echo " checked ";?>>
		Enabal
		<input name="radiobeneficio" id="cbbCustomer" onclick="RecargaBEN('<? echo $Opc;?>','2')" type="radio" class="SinBorde" value="2" <? if($CheckBEN=='2') echo " checked ";?>>
		Pmn
		<input name="radiobeneficio" id="cbbCustomer" onclick="RecargaBEN('<? echo $Opc;?>','3')" type="radio" class="SinBorde" value="3" <? if($CheckBEN=='3') echo " checked ";?>>
	   Otros<br>	   
	   <?
		  if($CheckBEN=='1')
		  	$TipoFlujo='ENA';
		 ...
		 {
			?>
			 <select name="CmbFlujoBene" style="width:300">
		 ...
		 {
			 echo "<select name='CmbFlujoBene' style='width:300'>";
			   echo "<option value='T' class='Selected'>Seleccionar</option>";
		 	echo "</select>";
		 }		
		?>	
		 &nbsp;&nbsp;&nbsp;
		 <select name="CmbSignoBene" style="width:60">
		...
		&nbsp;<a href="JavaScript:ProcesoNuevo('NBENE','<? echo $CheckBEN;?>','<? echo $R;?>')"><img src="archivos/agregar.png" alt="Agregar" width="25" height="25"  border="0" align="absmiddle" /></a>
    </td>
				...
				<?
				  ...
				  while ($Fila=mysql_fetch_array($Resp))
				  {
						...
						if($Fila["signo"]=='1')
							...
							$Signo='-';	
						?><tr>
							<td align='center' width='1%'><a href="JavaScript:ProcesoEliminar('EBENE','<? echo $Cod;?>')"><img src='archivos/eliminar2.png'  alt='Eliminar' align='absmiddle' border='0' width='15' height='15'></a></td>
