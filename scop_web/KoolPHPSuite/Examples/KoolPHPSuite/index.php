...
<head>
	...
	<title>KoolPHPSuite - Excellent PHP UI Controls For Web 2.0 Application: PHP Ajax Framework, PHP TreeView, PHP Slide Menu, PHP Tab Menu, PHP Ajax File Upload, PHP Ajax AutoComplete, PHP ComboBox, PHP ImageView</title>
</head>
<body>
<!-- Wrap all -->
    	...
    	<div class="ie6hack">
		    <table class="hack-ie">
		    	<tr valign="top">
		            ...
		            <td class="content-R">
						<div id="main-content">
		             		<table><tr><td class="tl"><img src="<?php echo $imgURL?>/none.gif" alt="" /></td><td class="tc"><div>&nbsp;</div></td><td class="tr"><img src="<?php echo $imgURL?>/none.gif" alt="" /></td></tr></table>
		                	<div id="middle">
		                		<div id="main">
		                    		<div class="component-title fix-float">
		                    			<h1>
		                    				<span class="left">
		                    					<img src="./Images/icon.png" class="absbottom" alt="<?php echo $control['name'];?>" />
												<?php echo $control["name"];?>
											</span>
											<span class="version right">
												<?php echo $control["version_type"]." ".$control["version"]." released on ".$control["releasedate"];?>
											</span>
										</h1>
									</div>
		                        	<div class="example">
		                        		<div class="show-control-example"><?php echo $control["description"];?></div>
		                        		<div class="title"><h4>Suite contains:</h4></div>
		                	...
		                	<table><tr><td class="bl"><img src="<?php echo $imgURL?>/none.gif" alt="" /></td><td class="tc"><div>&nbsp;</div></td><td class="br"><img src="<?php echo $imgURL?>/none.gif" alt="" /></td></tr></table>
		             	</div>
