                            ...
                            <div class="show-it">
                                <div class="TabView" id="TabView">
                                    ...
                                    <div class="Tabs" style="width: 600px;">
                                        <a <?=($id == 0) ? 'class="Current"' : 'href="?id=0"';?>>Description</a>
                                        <?php for($i=1; $i <= $example["samplecodes"]["total"]; $i++){
                                            if(!empty($example["samplecodes"]["code"][$i-1])){
                                        ?>
                                                <a <?=($id == $i) ? 'class="Current"' : 'href="?id=$i"';?>>
                                                <?php echo $example["samplecodes"]["header"][$i-1]?>
                                                </a>
                                        <?php }}?>
                                      <a <?=($id == 100) ? 'class="Current"' : 'href="?id=4"';?>>Documentation</a>
                                    </div>
                                    <!-- ***** Pages *********************************************************** -->
                                    <div class="Pages" style="width: 650px; height: 300px;">
	                                    <div class="Page" style="width: 650px;height: 300px;display: <?=($id == 0) ? 'block' : 'none';?>">
	                                        <div class="Pad"><?php echo $example["description"]?></div>
	                                    </div>
	                                    <?php for($i=1; $i <= $example["samplecodes"]["total"]; $i++){
	                                    	if(!empty($example["samplecodes"]["code"][$i-1])){
										?>
	                                    <div class="Page" style="width: 650px;height: 300px;display: <?=($id == 2) ? 'block' : 'none';?>">
	                                        <div class="Pad">
	                                        <?php 
	                                    ...
	                                    <?php }}?>
	                                    <div class="Page" style="width: 650px;height: 300px;display: <?=($id == 4) ? 'block' : 'none';?>">
