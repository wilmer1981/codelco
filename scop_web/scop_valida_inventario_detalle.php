...
<html>
<head>
<title>Valida Inventario Detalle</title>
...
function Excel(Opc,TipoEst)
{
	...
	URL='scop_valida_inventario_detalle_excel.php?Valores='+f.Valores.value;
...
<table width="85%" align="center"  border="0" cellpadding="0"  cellspacing="0" class="TablaPricipalColor">
  ...
  <tr>
   ...
   <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
     <tr>
       <td width="74%" align="left"><?	if($Opc=='N'){?><img src="../scop_web/archivos/subtitulos/sub_tit_contratos_n.png"><? }else{?><img src="../scop_web/archivos/subtitulos/sub_tit_detalle.png"><?	}?></td>
       <td align="right">
	   <a href="JavaScript:Excel('')"><img src="../scop_web/archivos/excel.png"  alt="Generar Excel " align="absmiddle" border="0"></a>
	   <a href="JavaScript:Proceso('<? echo $Opc;?>')"></a>
