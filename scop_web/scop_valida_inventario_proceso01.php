<?  
	...
	switch($Opcion)
	{
		case "G":	
			...
			if($CorrCheck!='')
			{
				$CorrCheck1=explode("~",$CorrCheck);
				while(list($c,$v)=each($CorrCheck1))
				{
			...
			EnvioCorreo($PARA,'3',$TipEst,$Ano,$CmbMes,$Meses,'PV',$TipoContrato,'',$TextObs,'','','','');//PV PROCESO VALIDADO PARA ANO Y MES				
			$Mensaje='1';
