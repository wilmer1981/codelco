<?php 
    ...
    //include("calidad_leyes_antiguas.php");
	...
	$Seleccion2= "select distinct t1.nro_solicitud,t1.recargo,t1.nro_sa_lims ";
					...
					while ($Fila=mysqli_fetch_array($Respuesta2))
					{
						...
						if ((is_null($Fila["recargo"])) || ($Fila["recargo"]==""))
						{
							...
							if ($Fila["nro_sa_lims"]=='') {
              					...
              					<a href=\"javascript:Historial(".$Fila["nro_solicitud"].",'".$Recargo."')\">".intval($Fila["nro_sa_lims"])."</a>
              					</td>";
              				}
							...
							$Consulta ="select t1.cod_producto,t1.cod_subproducto,t4.nombre_subclase,t1.fecha_hora,t1.id_muestra,t2.abreviatura as producto,t3.abreviatura as subproducto,t1.fecha_muestra,t1.observacion ";
							if($CmbAno<2008 && $CmbAno>0)
						...
						else
						{
							...
							if ($Fila["nro_sa_lims"]=='') {
              					...
              					echo "<td align=\"center\"><a href=\"javascript:Historial(".$Fila["nro_solicitud"].",'".$Fila["recargo"]."')\">".intval($Fila["nro_sa_lims"])."-".$Fila["recargo"]."</a></td>";
              				}
							...
							$Consulta ="select t1.cod_producto,t1.cod_subproducto,t4.nombre_subclase,t1.fecha_hora,t1.id_muestra,t2.abreviatura as producto,t3.abreviatura as subproducto,t1.fecha_muestra,t1.observacion ";
							if($CmbAno<2008 && $CmbAno>0)
								$Consulta.=" from cal_web.solicitud_analisis_a_".$CmbAno." t1 ";
								else
								$Consulta.=" from cal_web.solicitud_analisis t1 ";
							$Consulta=$Consulta." inner join proyecto_modernizacion.productos t2 on t1.cod_producto=t2.cod_producto";
							$Consulta=$Consulta." inner join proyecto_modernizacion.subproducto t3 on t1.cod_producto=t3.cod_producto and t1.cod_subproducto = t3.cod_subproducto ";
						...
						$Consulta ="select t1.cod_leyes,t1.valor,t1.signo,t2.abreviatura ";
						if($CmbAno<2008 && $CmbAno>0)
						...
						foreach($Arreglo as $Clave=>$Valor)
						{
							...
							echo "<td align=\"center\" bgcolor=\"#efefef\" ><span style=\"font-size:9px \">".$Val02."</span></td>";
						}
						if ($ChkAgrupacion=="S")
