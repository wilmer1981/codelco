...
function Checkeo(CB)
{
	...
	{
		alert("ale");
		f.sel.value=parseInt(f.sel.value)+1;
	}
	else
	{
		f.sel.value=f.sel.value-1;	
	}
...
<?php 
	...
	{
		echo '<tr>';
		echo '<td width="50"><input type="checkbox" name="a['.$i.']" onClick =Checkeo(this)></td>'; 
/*		echo '<td width="50"><input type="text" size="10" name="text" value="'.$i.'"></td>';
