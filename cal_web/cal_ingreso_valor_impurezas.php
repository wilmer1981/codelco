...
{
	var Frm=document.FrmIngresoValorImpureza;
	var ValoresSA="";
	var Valores="";
	var Valor="";
	...
	Frm.action="cal_ingreso_valor_leyes01.php?ValoresSA="+ValoresSA+"&Valores="+Valores+"&Tipo=I&Opcion=G";
	Frm.submit();
}

function Seguridad(CB,ValoresSA)
{
	var Frm=document.FrmIngresoValorImpureza;
	var Valores = "";
	var ValoresAux="";
	...
	{
		window.open("cal_desbloquear_leyes.php?ValoresSA="+ValoresSA+"&Valores="+ValoresAux+"&Tipo=I","","top=200,left=175,width=409,height=210,scrollbars=no,resizable = no");	
	}
	else
	{
		...
		Frm.action="cal_ingreso_valor_leyes01.php?ValoresSA="+ValoresSA+"&Valores="+Valores+"&Tipo=I&Opcion=G&PonerCandado=S";
		Frm.submit();
	}
}
...
<form name="FrmIngresoValorImpureza" method="post" action="">
    ...
    <tr>
      <td><div align="center"></div>
        <table width="490" border="0" cellpadding="5" class="ColorTabla01">
          <tr>
            <td><div align="center">Ingreso Valores Impurezas</div></td>
          </tr>
        </table>
		<br>
        <table width="490" border="0" cellpadding="5" class="TablaInterior">
          <tr> 
            <td width="329">Quimico: 
              <?php  
            ...
            <td width="132"><input name="BtnGrabar2" type="button" id="BtnGrabar22" value="Grabar" style="width:60" onClick="Grabar('<?php echo $Solicitudes;?>');"> 
              <input name="BtnSalir2" type="button" id="BtnSalir22" value="Salir" style="width:60" onClick="JavaScript:window.close();"></td>
          </tr>
        </table>
            <?php
		...
		<?php
			...
			while ($Fila=mysqli_fetch_array($Respuesta))
			{
				...
				if (($Fila["signo"]=='N')||($Fila["signo"]=='=')||(is_null($Fila["signo"])))
				{
      ...
      <br>
      <table width="490" border="0" cellpadding="5">
        <tr>
          ...
          <td width="187"><input name="BtnSalir" type="button" id="BtnSalir" value="Salir" style="width:60" onClick="JavaScript:window.close();"></td>
        </tr>
      </table> </td>
	  </tr>
	  </table>
