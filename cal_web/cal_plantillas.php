...
function Recarga(Opcion,BuscarDetalle,BuscarPrv,CmbRutPrv,Modificando)
{
 	...
 	{	
		case"A"://AUTOMATICA O RUTINARIA 
			frm.action= "cal_plantillas.php?SolAut=S&BuscarDetalle="+BuscarDetalle+"&BuscarPrv="+BuscarPrv+"&CmbRutPrv="+CmbRutPrv+"&Modificando="+Modificando;
			frm.submit();
			break;
		case "E"://ESPECIAL
			frm.action= "cal_plantillas.php?SolEsp=S&Modificando="+Modificando;
			frm.submit();
			break;
		case "R"://SI ES MODIFICADA POR ADM. MUESTREO
			if (frm.BtnOk.value == "Ok")
			{
				frm.action= "cal_plantillas.php";
			}
			else
			{
				frm.action= "cal_plantillas.php?Modificando="+Modificando;
			}
			frm.submit();
			break;
	}
	...
	else
	{
		switch (Valor)
		{
			case "A"://SI ES AUTOMATICA O RUTINARIA	
				frm.action ="cal_plantillas01.php?Plantilla=" +Plantilla + "&SolAut=S&Rut="+RutPlant+"&BuscarDetalle="+BuscarDetalle+"&BuscarPrv="+BuscarPrv+"&CmbRutPrv="+CmbRutPrv+"&Modificando="+Modificando;
				frm.submit();
				break;	
			case "E"://SI ES ESPECIAL
				frm.action ="cal_plantillas01.php?Plantilla=" +Plantilla + "&SolEsp=S&Rut="+RutPlant+"&Modificando="+Modificando;
				frm.submit();
				break;
