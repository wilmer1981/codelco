...
function Validar(ValorMuestras,ValorPeriodo,ValorSolAut,BuscarDetalle,BuscarPrv,Modificar,CmbProductos,CmbSubProducto)
{
	var frm=document.frmingprogramador ;

	frm.action ="cal_ing_periodo_frx01.php?Muestras=" + ValorMuestras + "&Periodo=" + ValorPeriodo + "&SolAut="+ValorSolAut+"&BuscarDetalle="+BuscarDetalle+"&BuscarPrv="+BuscarPrv+"&Modificar="+Modificar+"&CmbProductos="+CmbProductos+"&CmbSubProducto="+CmbSubProducto;
	frm.submit();
}
</script>
...
<table width="603"  border="0" cellpadding="3" cellspacing="0" class="TablaInterior">
          ...
          <table width="604" border="0" cellpadding="3" cellspacing="0" class="TablaInterior">
			...
			?>
              </select>&nbsp;<strong>Hora Muestra</strong>&nbsp;
          ...
          <table width="604"  border="0" cellpadding="3" cellspacing="0" class="TablaInterior">
            <tr> 
              <td width="279"><div align="right">
                  <input name="BtnGrabar" type="button" id="BtnGrabar" style="width:70" value="Grabar" onClick="javascript:Validar('<?php echo $Muestras; ?>','<?php echo $Periodo;?>','<?php echo $SolAut; ?>','<?php echo $BuscarDetalle; ?>','<?php echo $BuscarPrv ;?>','<?php echo $Modificar;?>','<?php echo $CmbProductos;?>','<?php echo $CmbSubProducto;?>');">
                </div></td>
