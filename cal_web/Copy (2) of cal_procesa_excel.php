...
*/		//PLATA
		...
		Insertartmp($NroSolicitud,$IdMuestra,$FinoLeyAg,$UniLeyAg,$FinoLeyAu,$UniLeyAu,$RetLeyAg,$UniRetLeyAg,$RetLeyAu,$UniRetLeyAu,$PesoRetalla,$UniPesoRetalla,$CookieRut,$r_porce_cu);
/*
			if($FinoLeyAg!='' )
...
*/		}
	...
	function Insertartmp($NroSolicitud,$IdMuestra,$ley_ag,$unidad_ag,$ley_au,$unidad_au,$r_ley_ag,$r_unidad_ag,$r_ley_au,$r_unidad_au,$r_peso,$r_unidad_peso,$Rut,$r_porce_cu)
	{
