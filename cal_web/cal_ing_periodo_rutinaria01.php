			...
			if (substr($MuestraFecha,$x,2) == "~~")
				{
					...
					if ($SolAut=="S")
					{
						...
						if ($Recargo!="N")
						{
							...
							{
								case "1":
									$Actualizar = "UPDATE solicitud_analisis set cod_periodo ='".$Periodo."',fecha_muestra='$FechaI',a�o=NULL,mes=NULL,nro_semana=NULL where rut_funcionario ='".$Rut."' and fecha_hora='".$Fecha."' and id_muestra ='".$Muestra."' and recargo='".$Recargo."'";					
								...
								case "2":
									...
									$Actualizar = "UPDATE solicitud_analisis set cod_periodo ='".$Periodo."',fecha_muestra='$FechaI',a�o='$CmbAno',mes='$CmbMes',nro_semana='$NSemana' where rut_funcionario ='".$Rut."' and fecha_hora='".$Fecha."' and id_muestra ='".$Muestra."' and recargo='".$Recargo."'";					
									mysqli_query($link, $Actualizar);
									break;
								case "3":
									$Actualizar = "UPDATE solicitud_analisis set cod_periodo ='".$Periodo."',fecha_muestra='$FechaI',a�o='$CmbAno',mes='$CmbMes',nro_semana=NULL where rut_funcionario ='".$Rut."' and fecha_hora='".$Fecha."' and id_muestra ='".$Muestra."' and recargo='".$Recargo."'";					
									mysqli_query($link, $Actualizar);
									break;
								case "4":
									$Actualizar = "UPDATE solicitud_analisis set cod_periodo ='".$Periodo."',fecha_muestra='$FechaI',a�o='$CmbAno',mes='$CmbMes',nro_semana=NULL where rut_funcionario ='".$Rut."' and fecha_hora='".$Fecha."' and id_muestra ='".$Muestra."' and recargo='".$Recargo."'";					
...
else
{
	...
	{			
		echo "<script languaje='JavaScript'>";
		echo " window.opener.document.FrmSolicitudRutinaria.action='cal_solicitud_rutinaria.php?Productos=".$CmbProductos."&SubProducto=".$CmbSubProducto."&ValorCheck=".$ValCheck."&Modificar=".$Modificar."';";
	...
	{
		echo "<script languaje='JavaScript'>";
		echo " window.opener.document.FrmSolicitudRutinaria.action='cal_solicitud_rutinaria.php?ValorCheck=".$ValCheck."&Periodo=".$Periodo."&NombrePlantillaSA=".$NombrePlantillaSA."';";
		echo " window.opener.document.FrmSolicitudRutinaria.submit();";
		echo "window.close();</script>";
	}	
}
