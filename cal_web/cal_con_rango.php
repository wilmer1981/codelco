...
<?php
	...
	{
		$Pregunta="  (t1.cod_producto = '".$Fila["cod_producto"]."' and t1.cod_subproducto='".$Fila["cod_subproducto"]."' and t1.cod_leyes='".$Fila["cod_ley"]."') or";
	...
	if ($Pregunta!='')
	{
		...
		$Consulta.=" where (t2.fecha_muestra between '".$FechaIni." 00:00:00' and '".$FechaFin." 23:59:59') and t1.recargo ='0' and  (t2.estado_actual = '5' or t2.estado_actual ='6') and";
		$Consulta.=" (".$Pregunta.")";
		$Respuesta = mysqli_query($link, $Consulta);
		//echo $Consulta."</br>";
		$LargoArreglo = 0;
...
?>
	...
	for ($i = 0; $i < $LargoArreglo1; $i++)
	{
		...
		$Consulta1.=" and '".$FechaFin." 23:59:59') and t1.recargo= '0' and (not isnull(t1.nro_solicitud) or t1.nro_solicitud = '') ";
		...
		$Consulta.=" and '".$FechaFin." 23:59:59') and t1.recargo = '0' and (not isnull(t1.nro_solicitud) or t1.nro_solicitud = '') ";
