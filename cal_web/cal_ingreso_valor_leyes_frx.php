...
function Grabar(Solicitudes)
{
	...
	if (Valores!="")
	{
		Frm.action="cal_ingreso_valor_leyes_frx01.php?ValoresSA="+ValoresSA+"&Valores="+Valores+"&Tipo=L&Opcion=G";
		Frm.submit();
	}
}
...
function Seguridad(CB,ValoresSA,Tipo)
{
	...
	{
		window.open("cal_desbloquear_leyes_frx.php?ValoresSA="+ValoresSA+"&Valores="+ValoresAux+"&Tipo=L","","top=200,left=175,width=409,height=210,scrollbars=no,resizable = no");	
	}
	else
	{
		...
		if (Valor!="")
		{
			...
			Frm.action="cal_ingreso_valor_leyes_frx01.php?ValoresSA="+ValoresSA+"&Valores="+Valores+"&Tipo=L&Opcion=G&PonerCandado=S";
			Frm.submit();
		}
		else
		{
...
function Modificar(Solicitudes,Proceso)
{
	...
	if (CheckeoLeyes==true)
	{
		if (Proceso=='E')
		{
			...
			if (Respuesta==true)
			{
				Frm.action="cal_seleccion_leyes_frx01.php?ValoresSA="+ValoresSA+"&SA="+SA+"&Recargo="+Recargo+"&Ley="+Ley+"&Proceso="+Proceso;
				Frm.submit();
			}
			else
			{
		...
		{
			window.open("cal_seleccion_leyes_frx.php?ValoresSA="+ValoresSA+"&SA="+SA+"&Recargo="+Recargo+"&Ley="+Ley+"&Proceso="+Proceso,"","top=100,left=20,width=700,height=550,scrollbars=yes,resizable = no");	
		}	
	}
	else
	{
...
{
	var Frm=document.FrmIngresoValorLeyes;
	Frm.action="cal_ingreso_valor_leyes_frx01.php?Opcion=S&Valores="+Valores;
	Frm.submit();
}
</script>
    ...
    <tr>
      <td><div align="center"></div>
        ...
        <table width="490" border="0" cellpadding="5" class="TablaInterior">
          <tr> 
            <td>
			  <input name="BtnAgregar" type="button" id="BtnAgregar" style="width:60" onClick="Modificar('<?php echo $Solicitudes;?>','A');" value="Agregar"> 
              <input name="BtnEliminar" type="button" id="BtnEliminar" style="width:60" onClick="Modificar('<?php echo $Solicitudes;?>','E');" value="Eliminar"> 
              <input name="BtnModificar" type="button" value="Modificar" style="width:60" onClick="Modificar('<?php echo $Solicitudes;?>','M');"> 
              <input name="BtnGrabar2" type="button" id="BtnGrabar2" value="Grabar" style="width:60" onClick="Grabar('<?php echo $Solicitudes;?>');"> 
              ...
              <?php
				...
				$Fila=mysqli_fetch_array($RespEstado);
		...
		<?php
			...
			while ($Fila=mysqli_fetch_array($Respuesta))
			{
				...
				if (($FilaEstado["estado_actual"]!="6") && (($Fila["cod_producto"]=="16") or ($Fila["cod_producto"]=="17") or ($Fila["cod_producto"]=="18") or ($Fila["cod_producto"]=="21") or ($Fila["cod_producto"]=="20")))
				{
      ...
      <table width="490" border="0" cellpadding="5" class="TablaInterior">
          <tr> 
            <td align="LEFT" BORDER="0"> 
				<input name="BtnAgregar2" type="button" value="Agregar" style="width:60" onClick="Modificar('<?php echo $Solicitudes;?>','A');">
                <input name="BtnEliminar2" type="button" id="BtnEliminar2" style="width:60" onClick="Modificar('<?php echo $Solicitudes;?>','E');" value="Eliminar"> 
                <input name="BtnModificar2" type="button" value="Modificar" style="width:60" onClick="Modificar('<?php echo $Solicitudes;?>','M');"> 
