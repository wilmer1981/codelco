		...
		<?php
			if (($Buscar=='S') and ($TxtLeyes!=''))
			{
				...
				{				
					...
					$Consulta="select distinct t1.cod_producto,t1.cod_subproducto,t2.descripcion as producto,t3.descripcion as subproducto from cal_web.solicitud_analisis t1 ";
					...
					$Consulta=$Consulta." where not isnull(t1.nro_solicitud) and t1.estado_actual != '7' and t1.estado_actual != '16' and  t1.fecha_hora between '".$FechaI."' and '".$FechaT."' group by t2.producto,t3.subproducto";
					...
					while ($Fila=mysqli_fetch_array($Respuesta2))
					{
						...
						$Consulta="select t2.cod_leyes,count(t2.cod_leyes)as total from cal_web.solicitud_analisis t1 inner join cal_web.leyes_por_solicitud t2 on ";
						...
						$Consulta=$Consulta." where  t1.estado_actual != '7' and t1.estado_actual != '16' and t1.cod_producto=".$Fila["cod_producto"]." and t1.cod_subproducto=".$Fila["cod_subproducto"]." and (".$CodLeyes.") and t1.fecha_hora between '".$FechaI."' and '".$FechaT."' group by t2.cod_leyes";
