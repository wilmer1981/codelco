<?php 	
	...
	$MsjIdMuestra = isset($_REQUEST["MsjIdMuestra"])?$_REQUEST["MsjIdMuestra"]:'';
...
function ValidaIngreso(Valor)
{
	...
	//alert (Valor);
	//Frm.TxtObs.value = "cal_solicitud01.php?proceso=" + Valor + "&ValorAnalisis=" + V_1 + "&ValorMuestreo=" + V_2+"&Enabal="+Enabal+"&TxtMuestra="+Frm.TxtMuestra.value;
	Frm.action = "cal_solicitud01.php?proceso=" + Valor + "&ValorAnalisis=" + V_1 + "&ValorMuestreo=" + V_2+"&Enabal="+Enabal+"&TxtMuestra="+Frm.TxtMuestra.value;
	Frm.submit();	
}
	   ...
	   switch (Valor)
   		{
			case "1":
				...
				else
				{
					...
					Frm.action = "cal_solicitud01.php?proceso=M&Valor=" + Valor +"&Muestras=" + Muestras;
					Frm.submit();
					return;
					break;
				}
...
function ValidaEliminar()
{
	...
	if (CheckeoSolicitud())
	{
		...
		{
			Muestras=RecuperarDatosCheckeados();
			Frm.action = "cal_solicitud01.php?proceso=E&Muestras=" + Muestras;
			Frm.submit();
			return;
		}
		else
...
function ValidaGenerar()
{
	...
	if (CheckeoSolicitud())
	{
		...
		Muestras=RecuperarDatosCheckeados();
		Frm.action = "cal_solicitud01.php?proceso=G&Muestras=" + Muestras;
		Frm.submit();	
	}
	else
	{
...
function Recarga(Generar)
{
 var Frm=document.FrmSolicitud;
     ...
     Frm.action= "cal_solicitud.php?GenerarValidacion="+Generar;
	 Frm.submit();
}
function MostrarPeriodo(Modificar)
{
	...
	switch (Frm.CmbPeriodo.value)
   	{
 	 case "1":
		window.open("cal_ing_periodo.php?Muestras=" + Muestras + "&Periodo=1&Modificar="+Modificar+"&CmbProductos="+Frm.CmbProductos.value+"&CmbSubProducto="+Frm.CmbSubProducto.value,"","top=200,left=10,width=700,height=240,scrollbars=no,resizable = yes");		
		break;
 	 case "2":
		window.open("cal_ing_periodo.php?Muestras=" + Muestras + "&Periodo=2&Modificar="+Modificar+"&CmbProductos="+Frm.CmbProductos.value+"&CmbSubProducto="+Frm.CmbSubProducto.value,"","top=200,left=10,width=700,height=240,scrollbars=no,resizable = yes");		
		break;
 	 case "3":
		window.open("cal_ing_periodo.php?Muestras=" + Muestras + "&Periodo=3&Modificar="+Modificar+"&CmbProductos="+Frm.CmbProductos.value+"&CmbSubProducto="+Frm.CmbSubProducto.value,"","top=200,left=10,width=700,height=240,scrollbars=no,resizable = yes");		
		break;
    case "4":
		window.open("cal_ing_periodo.php?Muestras=" + Muestras + "&Periodo=4&Modificar="+Modificar+"&CmbProductos="+Frm.CmbProductos.value+"&CmbSubProducto="+Frm.CmbSubProducto.value,"","top=200,left=10,width=700,height=240,scrollbars=no,resizable = yes");				
		break;
	case "5":
		window.open("cal_ing_periodo.php?Muestras=" + Muestras + "&Periodo=5&Modificar="+Modificar+"&CmbProductos="+Frm.CmbProductos.value+"&CmbSubProducto="+Frm.CmbSubProducto.value,"","top=200,left=10,width=700,height=240,scrollbars=no,resizable = yes");				
		break;
	}
}
...
function MostrarLeyes(Modificando,Productos,SubProducto)
{
	...
	if (CheckeoSolicitud())
	{
		...
		if (EncontroRecargo())
		{
			if (TipoAnalisisQ=="1")
			{
				window.open("cal_leyes_por_solicitud.php?Valores="+Muestras+"&SolAut=S&VolverAEsp=S&Modificando="+Modificando+"&Productos="+Productos+"&SubProducto="+SubProducto,""," fullscreen=yes,width=800,height=600,scrollbars=yes,resizable = yes");		
			}
			else
			{
				window.open("cal_leyes_por_solicitud_fisico.php?Valores="+Muestras+"&SolAut=S&Modificando="+Modificando+"&Productos="+Productos+"&SubProducto="+SubProducto,"","top=20,left=20,width=800,height=600,scrollbars=yes,resizable = yes");
			}
		}
		else
		{
			if (TipoAnalisisQ=="1")
			{
				window.open("cal_leyes_por_solicitud.php?Valores="+Muestras+"&Modificando="+Modificando+"&Productos="+Productos+"&SubProducto="+SubProducto,""," fullscreen=yes,width=800,height=600,scrollbars=yes,resizable = yes");		
			}
			else
			{
				window.open("cal_leyes_por_solicitud_fisico.php?Valores="+Muestras+"&Modificando="+Modificando+"&Productos="+Productos+"&SubProducto="+SubProducto,"","top=20,left=20,width=800,height=600,scrollbars=yes,resizable = yes");
			}
		}		
	}
	else
...
{
	var Frm=document.FrmSolicitud;
	Frm.action = "cal_solicitud01.php?proceso=L";
	Frm.submit();	
}
function AsignarRecargos()
{
	...
	//{	
		...
		if (Muestras !="")
		{
					Frm.action ="cal_asignar_recargo.php?Muestras="+Muestras;			
					Frm.submit();	
																		
			//window.open("cal_asignar_recargo.php?Muestras="+Muestras,"","top=0,left=0,width=500,height=300,scrollbars=yes,resizable = yes");			
		}	
	//} 
}
...
<form name="FrmSolicitud" method="post" action="">
  ...
  <table width="730" border="0" cellpadding="3" cellspacing="0" class="TablaInterior">
    <tr> 
		 <td ><strong>Versi&oacute;n 3 </strong> </td>
		</tr> 
	<tr>	 
    ...
    <tr> 
	 	...
	 	?>
            ...
            <td height="23">&nbsp;</td>
            <td height="23"> <font color="#FFFF00"> 
            <?php 
	  ...
	  ?>
		...
		else
		{
			if ($Modificar!="")
			{
				...
				$Fila=mysqli_fetch_array($Respuesta);
				$cod_tipo_muestra = isset($Fila["cod_tipo_muestra"])?$Fila["cod_tipo_muestra"]:"";
				if (($cod_tipo_muestra=='1') or ($cod_tipo_muestra=='3'))
				{
    ...
    <tr> 
		...
		if ($Modificar!='S')
		{
			...
			echo "<select name='CmbAgrupacion' style='width:110' onChange=Recarga('S')>";
  ...
  <table width="730" border="0" cellpadding="3" cellspacing="0" bordercolor="#b26c4a" class="TablaDetalle">
    ...
    <?php  
	    ...
	    if ($CmbSubProducto!="" or $Modificar!="" )
		{
			...
			$Consulta.=" t1.rut_funcionario,t1.id_muestra,t1.cod_producto,t1.cod_subproducto, ";
			...
			while ($Fila=mysqli_fetch_array($Respuesta))
			{
				...
				if ((is_null($Fila["cod_periodo"])) or ($Fila["cod_periodo"] == ""))
					{
						echo "<td><input type='Text' name='TxtPeriodo' readonly style='width:100'><input type ='hidden' value='".$Fila["recargo"]."' ></td>";											
					}	
				else
					{
						...
						echo "<td><input type='Text' name='TxtPeriodo' readonly style='width:100' value = '".$Fila2["valor_subclase3"]." ".$FechaDMA."'><input type ='hidden' value='".$Fila["recargo"]."'></td>";					
...
<?php
 echo "<script languaje='JavaScript'>";
	if ($MsjIdMuestra=="S")
	{
		echo "alert('El Id Muestra ingresado ya existe en el sistema');";
		echo "Frm.TxtMuestra.focus();";
	}
 echo "</script>";
