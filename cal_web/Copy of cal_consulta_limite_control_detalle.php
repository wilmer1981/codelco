...
<table width="100%"  border="1" align="center" cellpadding="2" cellspacing="0" class="TablaInterior">
  ...
  <tr class="Colum01">
    ...
    <td colspan="3" bgcolor="#EFEFEF"><?php
			$Consulta="select cod_subproducto,descripcion from subproducto where cod_subproducto = '".$SubProducto."'"; 
			$Respuesta = mysqli_query($link, $Consulta);
			if($Fila=mysqli_fetch_array($Respuesta))
				echo $Fila["descripcion"];
  ...
  <tr class="Colum01">
    ...
    <tr class="Colum01">
      ...
      <td colspan="3" bgcolor="#EFEFEF"><textarea name='Descrip' cols="70" rows="3" readonly="readonly"><?php echo $Obs;?></textarea></td>
    </tr>
