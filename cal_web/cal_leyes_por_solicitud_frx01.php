...
if (!isset($Personalizar))
{
	if (!isset($SolAut))
	{
		...
		if ($Modificando=='S')
		{
			...
			echo " window.opener.document.FrmSolicitud.action='cal_solicitud_frx.php?ValorCheck=".$ValCheck."&Productos=".$Productos."&SubProducto=".$SubProducto."&Modificar=".$Modificando."';";
