...
<form name="frmPrincipal" action="" method="post">
  <table width="600" height="46" border="0" align="center" class="Titulo2">
    <tr> 
...
<p><img src="../principal/imagenes/letrasenami.gif" width="160" height="40"></p>
	...
	<tr>
	 ...
	 Division Ventanas	
	  ...
	  <?php
			...
			if($NroCert == '')
			{
				$Consulta5 = "SELECT max(nro_certificado) as numero from cal_web.certificados ";
  ...
  <table width="650" height="46" border="0" align="center" class="Titulo2">
    <?php
			...
			$Consulta ="SELECT t2.cod_producto,t3.cod_subproducto,t2.descripcion as DesProducto,t3.descripcion as DesSubProducto,t1.cod_ccosto from cal_web.solicitud_analisis t1 ";
    ...
    <tr> 
      ...
      <td>
		...
		<?php
			...
			//Carbon
          // poly if (($CodProducto == '53' && ($CodSubProducto == '4' || $CodSubProducto == '1' || $CodSubProducto == '5' || $CodSubProducto == '6')) || ($Fil["cod_area"]=='88') || ($CodProducto == '48' && ($CodSubProducto == '2')))
			...
			//Catodos
			//aqui entro
			/*poly if($CodProducto == '18' && ($senal = 0) && ($CodSubProducto == '6' || $CodSubProducto == '8' || $CodSubProducto == '9' || $CodSubProducto == '10' || $CodSubProducto == '12' || $CodSubProducto == '45'))
			//poly 2005-06-20{
  ...
  <table width="500" height="46" border="0" align="center" class="Titulo2">
	<tr>
	  <td align="center">
	  	Resultado Analitico
	  </td>	  
  ...
  <table width="400" height="46" border="0" align="center" class="Titulo2">
	<?php
		...
		if ($Tipo =='A')
		{
			...
			if (($CodProducto=='34')&&($CodSubProducto=='2'))
			{
					...
					while ($Fila3=mysqli_fetch_array($Respuesta3))
					{
						...
						else
						{
							if($CodProducto == 47 AND $CodSubProducto == 1 AND $Fila3["cod_leyes"] == 44)
								...
								if($CodProducto == 46 AND $CodSubProducto == 1 AND $Fila3["cod_leyes"] == 112)
					...
					while ($Fila4=mysqli_fetch_array($Respuesta4))											
					{
						...
						{
							if($CodProducto == 47 AND $CodSubProducto == 1 AND $Fila4["cod_leyes"] == 112)
								echo "<td>".number_format($Valor,2,'.','')."</td>";
							else	
								if($CodProducto == 46 AND $CodSubProducto == 1 AND $Fila4["cod_leyes"] == 112)
									echo "<td>".number_format($Valor,5,'.','')."</td>";
								else
									echo "<td>".$Valor."</td>";
						}
...
?>		
  ...
  <div align="center" style="position:absolute; top: 750px; left: 230px;"> 
    <table width="400" height="80" border="0" align="center" class="Titulo2">
	<tr> 
		<td colspan="2" align="right"><img src="../principal/imagenes/firma_control_calidad.JPG" width="160" height="100"></td>
	</tr>
	<tr> 
		<td>&nbsp;</td>
