...
function ValidarPersonalizar(Sol,Recargo)
{
	var frm=document.FrmIngreso;
	var LargoForm = frm.elements.length;
    var checkeoLeyes=false;
	...
	{
		frm.action="cal_leyes_por_solicitud01.php?Sol="+Sol +"&Rec="+Recargo +"&ValoresLeyes="+ValoresLeyes+"&ValoresImpurezas="+ValoresImpurezas+"&ValoresLeyesFisicas="+ValoresLeyesFisicas+"&Opcion=3";
		frm.submit();				
	}
}	
</script>
...
<td>
	<table width="600" border="0" cellpadding="0" class="ColorTabla01">
  	<tr>
            ...
            <tr> 
              ...
              <td width="381"><input name="BtnBorrar" type="SUBMIT"  value="Borrar"style="width:60">
			  	<?php
                	if ($Opcion ==3)
				{
					echo "<input name='BtnOk' type='button'  value='Ok' style='width:60' onClick=\"ValidarPersonalizar('$Sol','$Rec');\">";				
				}	
				else
				{	
	      ...
	      <table width="600" height="23" border="0" class="ColorTabla01" cellpadding="3" cellspacing="0">
            <tr> 
            ...
            <?php
				...
				?>
          <br>
          <table width="600" class="ColorTabla01" border="0" cellpadding="3" cellspacing="0">
            <tr> 
