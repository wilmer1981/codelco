...
function Validar(ValorMuestras,ValorPeriodo,ValorSolAut,BuscarDetalle,BuscarPrv,Modificar,CmbProductos,CmbSubProducto)
{
	...
	frm.action ="cal_ing_periodo01.php?Muestras=" + ValorMuestras + "&Periodo=" + ValorPeriodo + "&SolAut="+ValorSolAut+"&BuscarDetalle="+BuscarDetalle+"&BuscarPrv="+BuscarPrv+"&Modificar="+Modificar+"&CmbProductos="+CmbProductos+"&CmbSubProducto="+CmbSubProducto;
	frm.submit();
}
</script>
