...
<html>
<head>
<title>Clasificacion Catodos EW STD</title>
		...
		case "E"://ELIMINAR
			...
			else
			{
				if (confirm("�Desea Eliminar este Elemento?"))
				{
					...
					f.action = "sec_clasificacion_catodos_ew01.php?Proceso=E&Valores="+Valores;
					f.submit();
				}
			}
			break; 
		case "N":	
			var URL = "sec_clasificacion_catodos_ew_proceso.php?Proceso=N";
		...
		case "M":
			...
			else
			{
				if (contador == 1)
				{
					...
					Valores=Valores.substring(0,Largo-2);
					f.ValoresAux.value=Valores;
					var URL = "sec_clasificacion_catodos_ew_proceso.php?Proceso=M&Valores="+Valores;
					window.open(URL,"","top=120,left=30,width=500,height=250,menubar=no,resizable=yes,scrollbars=yes");
...
<?php	
	...
	while ($Fila=mysqli_fetch_array($Resp))
	{
		...
		echo "<td >".$Fila["ley"]."</td>\n";
		/*echo "<td >".$Fila["uni"]."</td>\n";*/
		echo "<td >".$Fila["std_1"]."</td>\n";
		echo "<td >".$Fila["std_2"]."</td>\n";
		echo "<td >".$Fila["std_3"]."</td>\n";
		echo "</tr>\n";
	}		
?>	
</table>	  
