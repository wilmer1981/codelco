...
<tr class="ColorTabla01">
	...
	<td align="center">Fec.Muestra.</td>
	<td>Recep.Mue</td>
	<td>Recep.Lab</td>
...
<?php
	...
	$Consulta = "select distinct t1.cod_producto, t1.cod_subproducto, t1.id_muestra,t1.rut_proveedor,t1.nro_solicitud,t3.descripcion as nom_subprd,t4.descripcion as nom_prod,t1.estado_actual,t1.fecha_muestra ";
	if($Ano<2009 && $Ano>0)
	...
	{
		//SOLICITUD DEL LOTE
		$Consulta = "select distinct t1.nro_solicitud ,t1.recargo , t1.estado_actual, t2.nombre_subclase";
		if($Ano<2009 && $Ano>0)
			$Consulta.= " from cal_histo.solicitud_analisis_a_".$Ano." t1 ";
			else
			$Consulta.= " from cal_web.solicitud_analisis t1 ";
