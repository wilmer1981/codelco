...
//echo " Fin ".$data->sheets[$Hoja]['numRows'];
	...
	/*
		...
		{*/	
			...
			$r_porce_cu=$data->sheets[$Hoja]['cells'][$i][22];
...
*/		//PLATA
		...
		Insertartmp($NroSolicitud,$IdMuestra,$FinoLeyAg,$UniLeyAg,$FinoLeyAu,$UniLeyAu,$RetLeyAg,$UniRetLeyAg,$RetLeyAu,$UniRetLeyAu,$PesoRetalla,$UniPesoRetalla,$CookieRut,$r_porce_cu,$link);
/*
			if($FinoLeyAg!='' )
...
*/		}
	...
	function Insertartmp($NroSolicitud,$IdMuestra,$ley_ag,$unidad_ag,$ley_au,$unidad_au,$r_ley_ag,$r_unidad_ag,$r_ley_au,$r_unidad_au,$r_peso,$r_unidad_peso,$Rut,$r_porce_cu,$link)
	{

		$Insertar="insert into tmp_solicitud_excel(nro_solicitud,id_muestra,ley_ag,unidad_ag,ley_au,unidad_au,";
		$Insertar.="r_ley_ag,r_unidad_ag,r_ley_au,r_unidad_au,r_peso,r_unidad_peso,fecha_registro,run_registro,r_porce_cu)";
