...
<input type="hidden" name="Rut1" value="<?php echo $Rut1; ?>">
  ...
  <tr>
	...
	<table width="950" border="1" cellpadding="0" cellspacing="0" >
		...
		<td width="50"><div align="center!">Nº Muestra</div></td>  	
	...
	if ($Mostrar=="S")
	{
	 	$Consulta ="select STRAIGHT_JOIN t1.fecha_hora,1,10,t1.id_muestra,t1.descripcion,t1.cod_ccosto,t2.abreviatura as DesP,t3.abreviatura as DesSub,t1.cod_area from cal_web.plantilla_solicitud_analisis t1 ";
