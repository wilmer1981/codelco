...
if ($Row = mysqli_fetch_array($Respuesta))
{
	...
	$Consulta = "select count(*) as num_solicitudes from cal_web.solicitud_analisis where nro_solicitud = ".$SA;
	$Respuesta2 = mysqli_query($link, $Consulta);
	$TxtRecargo = '';
	if ($Row2 = mysqli_fetch_array($Respuesta2))
		$TxtRecargo = $Row2["num_solicitudes"];
	...
	$Consulta = "select * from proyecto_modernizacion.sub_clase where cod_clase = 1002 and cod_subclase = ".$Row["estado_actual"];
	$Respuesta2 = mysqli_query($link, $Consulta);
	//echo "2".$Consulta;
	if ($Row2 = mysqli_fetch_array($Respuesta2))
...
while ($Fila =mysqli_fetch_array($Respuesta))
{
	...
	if(isset($Fila["centro_costo"])){
		$CC = $Fila["centro_costo"];
	}else{
		$CC = "";
	}
...
/*$Consulta = " select t1.cod_periodo,t3.nombre_subclase as estado,t1.nro_semana,t1.a�o,t1.mes,t1.fecha_muestra  from cal_web.periodos_solicitud_analisis t1 ";
...
<form name="FrmDetalle" method="post" action="">
  <table width="770"  border="0" cellpadding="5" cellspacing="0" class="TablaPrincipal" left="5" >
    <tr>
      <td width="748" align="center"><table width="744"  border="0" cellpadding="3" cellspacing="0" class="ColorTabla01">
          <tr> 
	  ...
	  ?>
            ...
            <td><input name='TxtSALIMS' type='text' readonly    style='width:104' value='<?php  echo $TxtSALIMS  ?>'>
          ...
          <tr> 
            ...
            <td width="252"><input name="TxtMuestra" type="text" readonly style='width:250' id="TxtMuestra" value="<?php  echo $TxtMuestra ?>"> 
            </td>
            <td width="96"><strong>Cant Recargos</strong></td>
            <?php
	  		if ($TxtRecargo =='1')
	  		{
	  			$TxtRecargo=' ';	
	  		...
	  		?>
            <td width="265"><input name="TxtRecargo" type="text" readonly style='width:250' id="TxtRecargo" value="<?php echo $TxtRecargo ?>"></td>
          </tr>
          <tr> 
        ...
        <table width="746" border="0" cellspacing="0" cellpadding="3" class="TablaDetalle">
          ...
          <?php	
	$Consulta = "select * from cal_web.registro_leyes where nro_solicitud = ".$SA." order by fecha_hora, recargo, cod_leyes";
	//echo $Consulta."<br>";
	$Respuesta = mysqli_query($link, $Consulta);
	while ($Row = mysqli_fetch_array($Respuesta))
	{
		...
		else	echo "<td align='center'><img src='../principal/imagenes/cand_cerrado.gif'></td>\n";	
		echo "</tr>\n";
	}
?>
        </table>
