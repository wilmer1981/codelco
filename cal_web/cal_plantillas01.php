...
else//S.A ESPECIAL
{
	...
	{			
		echo "<script languaje='JavaScript'>";
		echo " window.opener.document.FrmSolicitud.action='cal_solicitud.php?Productos=".$TxtProducto."&SubProducto=".$TxtSubProducto."&ValorCheck=".$ValCheck."&Modificar=".$Modificando."';";
