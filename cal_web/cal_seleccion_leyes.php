...
function Validar(ValoresSA,SA,Recargo,Ley,Proceso,Pantalla)
{
	...
	{
		frm.action="cal_seleccion_leyes01.php?Pantalla="+Pantalla+"&ValoresSA="+ValoresSA+"&LeyNueva="+LeyNueva+"&UnidadNueva="+UnidadNueva+"&SA="+SA+"&Ley="+Ley+"&Recargo="+Recargo+"&Proceso="+Proceso;
		frm.submit();
	}
	else
	{
          ...
          <table width="600" border="0" cellpadding="0" class="TablaInterior">
            <tr> 
              ...
              <td width="381"><input name="BtnBorrar" type="SUBMIT"  value="Borrar"style="width:60">
                <input name="BtnOk" type="button"  value="Ok" style="width:60" onClick="JavaScript:Validar('<?php echo $ValoresSA;?>','<?php echo $SA;?>','<?php echo $Recargo;?>','<?php echo $Ley;?>','<?php echo $Proceso;?>','<?php echo $Pantalla;?>');">
