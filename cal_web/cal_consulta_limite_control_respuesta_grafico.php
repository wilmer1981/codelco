...
#grey color (0xc0c0c0)
$c->setPlotArea(80, 60, 900, 350, 0xffffff, -1, -1, 0xCCCCCC, -1);
...
$titleObj = $c->addTitle("GRAFICO LIMITE CONTROL ".$Producto." - ".$SubProducto." - Ley ".$LeyDES, "arialbd.ttf",9, 0xffffff);
...
$dataSetObj = $layer->addDataSet($ArregloSolicitudValor, 0x0000FF, "Limite Inicial =".$LimitIniVALOR."     Limite Final =".$LimitFinVALOR);
//$dataSetObjf = $layer->addDataSet($ArregloInicial, 0xFFFF00, "Inicial ");
//$dataSetObji = $layer->addDataSet($ArreglFinal, 0xFF0000,"Final");$LimitIniVALOR;
	//		$ArreglFinal[$Cont]=$LimitFinVALOR;
