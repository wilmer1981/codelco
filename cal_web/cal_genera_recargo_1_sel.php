...
function Generar()
{
	...
	frm.action="cal_generacion_recargo01.php?Proceso=S";
	frm.submit();
}
function Salir()
{
      ...
      <td width="779" align="center" valign="top"><br>
        <br>        <table width="740" border="1" cellpadding="3" cellspacing="0" class="TablaInterior">
          <tr align="center" class="ColorTabla01">
            <td colspan="4"><em><strong>CREAR RECARGO &quot;1&quot; SELENIO </strong></em></td>
          </tr>
          <tr> 
...
<?php
		...
		if ($MensajeLey=='S')
		{
			echo "alert('Ud ha ingresado con exito  las leyes del recargo 1 ');";
		}
		if ($MensajeGenerar=='S')
		{
			echo "alert('Ud ha generado con exito el recargo 1 ');";
		}
		if ($Mostrar=='S')
		{
			echo "alert('Ya existe  recargo 1 para esta solicitud');";
		}
		if ($Encontro=='N')
		{
