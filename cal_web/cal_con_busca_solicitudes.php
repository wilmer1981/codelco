...
<input type="hidden" name="LimitIni" value="<?php echo $LimitIni; ?>">
  ...
  <table width="760" border="0" class="TablaDetalle">
    <tr> 
      ...
      <td width="260"><input name="NumFin" type="text" id="NumFin3" value="<?php echo $NumFin; ?>" size="10" maxlength="15"></td>
    </tr>
    <tr> 
    ...
    <?php  
      ...
      <td colspan="2"><input name="LimitFin" type="text" id="LimitFin" value="<?php echo $LimitFin;?>" size="12" maxlength="12"></td>
    </tr>
...
<?php
	...
	{
		$Consulta.= " where (t1.nro_solicitud between '".$SolIni."' and '".$SolFin."') or (t1.nro_sa_lims between '".$NumIni."' and '".$NumFin."') and  t1.cod_producto <> 1 ";
	}
	if ($CmbPeriodo!='-1')
	{
