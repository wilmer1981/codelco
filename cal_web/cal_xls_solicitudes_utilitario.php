...
<?php
	...
	$Consulta.= " where t1.fecha_hora between '".$FechaIni."' and '".$FechaFin."' and t1.estado_actual != 16 ";
...
?>
  ...
  <?php
 	$var1 = 0;$var2 = 0;
 	$consulta1="SELECT t1.recargo,t1.nro_solicitud as Nro_Soli,t1.id_muestra,t1.fecha_hora,t1.cod_tipo_muestra,t1.rut_funcionario,t1.cod_ccosto,t1.cod_analisis,t1.cod_periodo";
	...
	$consulta1.=" where t1.estado_actual !='16' and ";
	if($CmbSolFinal=='NF')//PARA SOLICITUDES NO FINALIZADAS EN CONTROL DE CALIDAD Y LABORATORIO FRX.
		$consulta1.=" t1.estado_actual !='6' and t1.estado_actual!='32' and";
	$consulta1.=" (t1.fecha_hora between '".$FechaIni."' and '".$FechaFin."') order by t1.nro_solicitud, t1.recargo ";
	//echo $consulta1;
...
<?php
function FechasProceso($SA,$Recargo,$Estado,$link)
{
	$FechaEstSA="";
