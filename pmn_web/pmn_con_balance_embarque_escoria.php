...
<table width="600" border="1" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
  <tr> 
    ...
    <td width="468" align="left">Embarque Escoria De Fusion</td>
  </tr>
  <tr> 
    <td>Periodo</td>
...
<table width="1000" border="1" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
  <tr class="ColorTabla01"> 
    ...
    <td width="86" rowspan="2" align="center">N&ordm; Cajon</td>
...
?>		
  ...
  <?php
	...
	{   
		...
		$consulta.= " t1.peso AS peso_humedo, IFNULL(t5.valor,0) AS humedad, ROUND((t1.peso - (t1.peso * IFNULL(t5.valor,0) / 100)) + 0.0001,3) AS peso_seco, 'N' AS bloqueado,";												
		...
		$consulta.= " '' AS peso_total, '' AS peso_muestra, t3.cod_leyes, t3.valor, ROUND((t3.valor * ROUND((t1.peso - (t1.peso * IFNULL(t5.valor,0) / 100)) + 0.0001,3) / CASE WHEN t3.cod_leyes IN ('04','05') THEN 1000 ELSE 100 END) + 0.0001,3) AS fino";				
	...
	$consulta = "SELECT t1.fecha AS fecha_venta,t1.num_cajon AS numero,t1.lote AS id_analisis, t1.cod_leyes, t1.valor, t1.peso_seco, t1.peso_humedo, t1.humedad, t1.conversion AS unidad, t1.fino";
