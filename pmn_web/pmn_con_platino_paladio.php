...
{
	var f=document.frm1;
	f.action="pmn_xls_platino_paladio.php?FechaIni="+FechaI + "&FechaFin="+FechaT + "&Turno="+T;
	f.submit();
}
...
<table width="749" border="0" cellspacing="0" cellpadding="3">
    <tr> 
      ...
      <td width="477" align="center" valign="middle"><strong>PLATINO PALADIO</strong></td>
  ...
  <table width="850" border="1" cellspacing="0" cellpadding="0" class="TablaDetalle">
    <tr class="ColorTabla01">
      ...
      <td width="84" align="center">N&ordm; Lote</td>
      <td width="94" align="center">Peso</td>
      <td width="91" align="center">Fecha Venta</td>
      <td width="53" align="center">Pd<br>
        % <br></td>
      <td width="56" align="center">Pt<br>
        % <br></td>
      <td width="53" align="center">Cu<br>
        % <br></td>
      <td width="55" align="center">Zn<br>
        % <br></td>
      <td width="52" align="center">Fe<br>
        % <br></td>
      <td width="54" align="center">Pb<br>
        % <br></td>
      <td width="49" align="center">Ag<br>
        % <br></td>
      <td width="48" align="center">Au<br>
        % <br></td>
      <td width="50" align="center">H20<br>
        %</td>
    </tr>
<?php	
	$consulta = "SELECT * FROM pmn_web.produccion_subproductos";
	$consulta.= " WHERE cod_producto = '33' AND cod_subproducto = '2'";
	...
	while ($row = mysqli_fetch_array($rs))
	{
		...
		//LEYES.
		$leyes = array('38'=>'', '37'=>'', '02'=>'','10'=>'','31'=>'', '39'=>'','04'=>'','05'=>'','01'=>'');
		...
		$consulta.= " AND t2.cod_leyes IN ('38', '37', '02', '10', '31','39','04','05','01')";
