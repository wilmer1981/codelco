...
<table width="900" align="center"  border="0" cellpadding="0"  cellspacing="0">
  ...
  <tr>
   ...
   <td align="center"><table width="100%" border="0" cellpadding="0"  cellspacing="0">
     <tr>
	 <td align="center" colspan="7" class="TituloCabecera2"><strong>Modulo de Control inventario</strong></td>
	 </tr>
	 <tr>       
     ...
     <tr>
	   ...
	   <td class="formulario"><select name="select">
          <?php
	   ...
	   <td class="formulario">Proceso</td>
	   <td class="formulario"><select name="select5">
         <?php
				echo"<option value='-1' selected>Seleccionar</option>";
				if($cmbturno == "A")
					echo"<option value='A' selected>A</option>";
	   ...
	   <td width="177" class="formulario">&nbsp;</td>
       </tr>
     <tr>
       <td colspan="3" class="formulario">Desde</td>
       <td width="338" class="formulario"><select name="select2">
         <?php
				echo"<option value='-1' selected>Seleccionar</option>";
				if($cmbturno == "A")
					echo"<option value='A' selected>A</option>";
       ...
       <td width="74" class="formulario">Hasta</td>
       <td width="265" class="formulario"><select name="select4">
         <?php
				echo"<option value='-1' selected>Seleccionar</option>";
				if($cmbturno == "A")
					echo"<option value='A' selected>A</option>";
  ...
  <tr>
    ...
    <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="19%" align="center" class="LineasBordesAba">Valor Sistema </td>
        <td width="16%" align="center" class="LineasBordesAba">Valor F&iacute;sico </td>
        <td align="center" class="LineasBordesAba">Diferencia</td>
        <td width="25%" align="center" class="LineasBordesAba">% de Desviaci&oacute;n </td>
      </tr>
      <tr>
        <td colspan="3" class="LineasBordesAlmedio">&nbsp;</td>
        <td class="LineasBordesAlmedio">&nbsp;</td>
        <td class="LineasBordesAlmedio">&nbsp;</td>
        <td class="LineasBordesAlmedio">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
