...
<table width="600" border="1" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
  <tr> 
    ...
    <td width="468" align="left">Produccion Platino - Paladio</td>
  </tr>
  <tr> 
    <td>Periodo</td>
...
?>
  ...
  <?php  
	...
	$consulta = "SELECT t1.fecha AS fecha_produccion, t1.lote AS numero, t1.cod_leyes, t1.valor, CASE WHEN t1.cod_leyes IN ('37','38') THEN 1 ELSE 2 END AS orden, t1.humedad, t1.peso_humedo, t1.peso_seco, t1.conversion AS unidad";
