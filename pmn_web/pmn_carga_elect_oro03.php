...
function Proceso(opt)
{
	...
	switch (opt)
	{
		case "E":
			...
			window.opener.document.frmPrincipalRpt.action ="pmn_principal_reportes.php?VerElOro=K&DiaElectOro2=" + StrDia + "&MesElectOro2=" + StrMes + "&AnoElectOro2=" + StrAno+"&Tab4=true";
		...
		case "S":
			...
			break;
		case "C":
			f.action = "pmn_carga_elect_oro03.php";
			f.submit();
			break;
	}
...
{   /*var f = document.frmConsulta;*/
	...
	else
	{
		...
		{
			f.action = "pmn_carga_elec_oro01.php?Proceso=S&parametros=" + valores;
			f.submit();
		}
	}
}
  ...
  <table width="620" border="1" cellpadding="0" cellspacing="0" class="TablaDetalle">
    <tr align="center" class="TituloCabeceraAzul"> 
      <td width="183" height="20" align="center"> Consultar - Eliminar&nbsp; 
        <?php //<input type="checkbox" name="checkbox" value="" onClick="SeleccionarTodos(this.form)"> ?>
      <td width="181"><strong>Fecha</strong></td>
      <td width="117"><strong>Num. Electrolisis.</strong></td>
      <td width="128"><strong>Colada</strong></td>
      <td width="128"><strong>N&ordm; de Anodos</strong></td>
    </tr>
    <?php  
	...
	while ($Row = mysqli_fetch_array($Respuesta))
	{
		...
		{
			$Consulta="select count(*) as total from pmn_web.carga_electrolisis_oro "; 
