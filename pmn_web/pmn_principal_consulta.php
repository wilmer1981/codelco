      ...
      <td colspan="5"><table width="100%"  border="0"  align="center" cellpadding="0"  cellspacing="0" bgcolor="#F7F2EB">
          ...
          <tr>
			...
			<?php
			   ...
			   $ConsultaP="select * from proyecto_modernizacion.acceso_menu where cod_sistema='6' and cod_pant_agrup='120' and nivel='".$CodNivel."' order by cod_pantalla";
			   //echo $ConsultaP."<br>";
			   ...
			   while($FilaP=mysqli_fetch_array($RespP))
			   {
				   ...
				   while($Fila=mysqli_fetch_array($Resp))
				   {
					  $Pant=substr($Fila[links],11);
				   	  ...
				   	  if($Pant!='pmn_consultas_principal.php?Pag=2'&&$Pant!='pmn_consultas_principal.php?Pag=4')
					  {	
						  ?>
