<?php 	
	...
	if ($CreaArchivo=="S")
		HrCreaArchivoAntecedentesPago(&$NomArchivo);	
	?>
<html>
<head>
...
<form name="frmFicoProcomi" method="post" action="">
  <table width="90%"  border="0" align="center">
    <tr>
      <td colspan="3" class="titulo_cafe">Antecedentes Pagos </td>
    </tr>
    <tr>
      <td width="4%">1.-</td>
      ...
      <input name="imageField22" type="image" class="SinBorde" onClick="Enviar(this.form,'inter_menu.php?CreaArchivo=S&Pagina=hr_antece_pago.php','');" src="archivos/crear_archivo.gif" align="middle" width="113" height="26" border="0"></td>
    </tr>
    <tr align="center">
      <td>&nbsp;</td>
      <td>&nbsp;</td>
