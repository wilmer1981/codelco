...
<form name="frmFicoProcomi" method="post" action="">
  <table width="90%"  border="0" align="center">
    <tr>
      <td colspan="3" class="titulo_cafe">Facturas de Proveedores Pendientes </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td><input name="imageField222" type="image" class="SinBorde" onClick="Enviar(this.form,'inter_menu.php?CargaArchivo=S&Pagina=fico_fac_prv.php','');" src="archivos/aceptar.gif" align="middle" width="113" height="26" border="0"></td>
    </tr>
    <tr>
      <td width="4%">2.-</td>
      <td width="21%">Nombre Archivo: </td>
      <td width="75%"><input name="NomArchivo" type="text" id="NomArchivo" value="<?php echo $NomArchivo; ?>">
      <input name="imageField22" type="image" class="SinBorde" onClick="Enviar(this.form,'inter_menu.php?CreaArchivo=S&Pagina=fico_fac_prv.php','');" src="archivos/crear_archivo.gif" align="middle" width="113" height="26" border="0"></td>
    </tr>
    <tr align="center">
      <td>&nbsp;</td>
      <td>&nbsp;</td>
