...
{
	var f=document.frm1;
	f.action="pmn_xls_electrolisis_oro.php?FechaIni="+FechaI + "&FechaFin="+FechaT + "&Turno="+T;
	f.submit();
}
...
<table width="749" border="0" cellspacing="0" cellpadding="3">
    ...
    <td width="477" align="center" valign="middle"><strong class="titulo_azul">ELECTROLISIS DE ORO</strong></td>
...
<br>
  <table width="913" border="1" cellpadding="3" cellspacing="0" class="TituloCabeceraAzul">
