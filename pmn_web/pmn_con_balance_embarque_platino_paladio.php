...
<html>
<head>
<title>Produccion Paladio-Platino</title>
...
function Guardar()
{
	...
	{	
		f.action = "pmn_con_balance_produccion_platino_paladio.php?proceso=G";
		f.submit();
	}
}
/******************/
...
<table width="600" border="1" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
  <tr> 
    ...
    <td width="468" align="left">Embarque Platino - Paladio</td>
  </tr>
  <tr> 
    <td>Periodo</td>
...
<br>
<table width="918" border="1" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
  <tr class="ColorTabla01"> 
    <td width="48" rowspan="2" align="center">Fecha</td>
    <td width="58" rowspan="2" align="center">N&ordm; Lote</td>
    <td width="60" rowspan="2" align="center">Peso Humedo</td>
    <td width="40" rowspan="2" align="center">H<sub>2</sub>O (%)</td>
    <td width="55" rowspan="2" align="center">Peso Seco</td>
  ...
  <tr class="ColorTabla01"> 
	...
	{
?>
    <td width="37" align="center">Pt (%)</td>
    <td width="39" align="center">Pd (%)</td>
    <td width="45" align="center">Cu (ppm)</td>
    <td width="43" align="center">Zn (ppm)</td>
    <td width="45" align="center">Fe (ppm)</td>
    <td width="44" align="center">Pb (ppm)</td>
    <?php
	}
	else
	{
?>
    <td width="38" align="center">Pt (Kg)</td>
    <td width="40" align="center">Pd (Kg)</td>
    <td width="41" align="center">Cu (Kg)</td>
    <td width="38" align="center">Zn (Kg)</td>
    <td width="40" align="center">Fe (Kg)</td>
    <td width="68" align="center">Pb (Kg)</td>
    <?php
	}
?>
  </tr>
  <?php  
	...
	{   
		...
		$consulta.= " t9.flujo, '' AS num_lixiviacion, '' AS lixiviador, 'Ajuste' AS lote, '' AS tambor, '' AS id_muestra,";
