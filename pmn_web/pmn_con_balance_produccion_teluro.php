...
<table width="600" border="1" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
  <tr> 
    ...
    <td width="468" align="left">Produccion Teluro Electrolitico</td>
  </tr>
  <tr> 
    <td>Periodo</td>
...
?>	
  ...
  <?php  
	...
	$consulta = "SELECT t1.fecha AS fecha_produccion, t1.lote AS numero, t1.peso_seco AS peso, t1.cod_leyes, t1.valor, CASE WHEN t1.cod_leyes = '44' THEN 1 ELSE 2 END AS orden, t1.conversion AS unidad, t1.fino";
