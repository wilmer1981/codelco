...
<table width="749" border="0" cellspacing="0" cellpadding="3">
    ...
    <td width="477" align="center" valign="middle" colspan="10"><strong>ELECTROLISIS DE PLATA</strong></td>
...
<br>
  <table width="1000" border="1" cellpadding="3" cellspacing="0" class="TablaDetalle">
    <tr class="ColorTabla01"> 
      <td width="73" rowspan="2" align="center">FECHA</td>
      <td width="37" rowspan="2" align="center">N. ELECT.</td>
	...
	while ($row = mysqli_fetch_array($rs))
	{
		...
		$consulta.= " WHERE fecha BETWEEN '".$FechaIni."' AND '".$FechaFin."'";
		$consulta.= " AND num_electrolisis = '".$row[num_electrolisis]."'";
