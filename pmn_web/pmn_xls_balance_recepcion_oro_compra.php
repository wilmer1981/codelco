...
<br>
<strong>
Informe: Recepcion Bullion De Oro<br>
...
<table width="500" border="1" cellspacing="0" cellpadding="3" class="TablaInterior">
  <tr class="ColorTabla01"> 
    <td width="101" rowspan="2" align="center">Fecha</td>
      <td width="123" rowspan="2" align="center">Num. Barra</td>
    <td width="141" rowspan="2" align="center">Peso Seco</td>
...
<?php  
	if ($Activar == "S")
	{
		...
		$consulta.= " t9.flujo, '' AS num_lixiviacion, '' AS lixiviador, '".$FechaIni."' AS lote, '' AS tambor, '' AS id_muestra,";
