...
function Chequear(r)
{		
	var vector = r.value.split('~'); //0:cod_producto, 1:cod_subproducto, 2:identificacion, 3:numero, 4:peso, 5:fecha_prod, 6:fecha_ven, 7:id_analisis. 
	
	var linea = "producto=" + vector[0] +"&subproducto=" + vector[1] + "&id=" +vector[2]  + "&num=" + vector[3] + "&peso=" + vector[4] + "&fecha_prod=" + vector[5] + "&fecha_ven=" + vector[6] + "&id_analisis=" + vector[7];
	window.opener.document.frmPrincipal.action = "pmn_ing_produccion_subproductos01.php?proceso=B&" + linea;
...
?>
  <div style="position:absolute; left: 15px; top: 15px; width: 521px; height: 26px;" id="div0"> 
    <table width="720" height="25" border="0" cellspacing="0" cellpadding="3" class="TablaInterior">
      <tr>
        <td align="center">Consulta De Datos</td>
  </tr>
</table>
</div>
  ...
  <div style="position:absolute; left: 16px; top: 55px; width: 727px; height: 33px;" id="div3"> 
    <table width="720" height="25" border="0" cellspacing="0" cellpadding="3" class="TablaInterior">
      <tr> 
        <td width="72" align="left">Fecha Inicio</td>
	...
	?>
        ...
        <td width="84" align="left">Fecha Termino</td>
  ...
  <div style="position:absolute; left: 80px; top: 100px; width: 623px; height: 198px;OVERFLOW: auto;" id="div";> 
    <table width="600" height="25" border="1" cellspacing="0" cellpadding="3" class="TablaInterior">
      <tr class="ColorTabla01"> 
        ...
        <td width="120" align="center">Peso</td>
      </tr>
      <?php
	 	if ($recargapag1 == "S")	
		{
			...
			{			
				echo '<tr>';
				echo '<td align="left"><input type="radio" name="radiobutton" value="'.$row["cod_producto"].'~'.$row["cod_subproducto"].'~'.$row[identificacion].'~'.$row["numero"].'~'.$row["peso"].'~'.$row[fecha_produccion].'~'.$row[fecha_venta].'~'.$row[id_analisis].'" onClick="Chequear(this)">'.$row["numero"].'</td>';
