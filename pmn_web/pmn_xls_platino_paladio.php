...
{
	var f=document.frm1;
	f.action="pmn_xls_teluro.php?FechaIni="+FechaI + "&FechaFin="+FechaT + "&Turno="+T;
	f.submit();
}
...
<table width="749" border="0" cellspacing="0" cellpadding="3">
    <tr> 
      ...
      <td width="477" align="center" valign="middle" colspan="13"><strong>PLATINO PALADIO</strong></td>
  ...
  <table width="850" border="1" cellspacing="0" cellpadding="0" class="TablaDetalle">
    <tr class="ColorTabla01">
      ...
      <td width="84" align="center">N. Lote</td>
