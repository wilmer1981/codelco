  ...
  <tr>
    ...
    <td align="center"><table width="100%" border="0" cellpadding="0"  cellspacing="0">
      <tr>
        ...
        <td colspan="4" align="center" valign="top" class="formulario Estilo7">Producci&oacute;n Circulantes</td>
        <td width="214" align="right" class="formulario">
		<a href="JavaScript:Proceso('B','9')"><img src="archivos/Btn_buscar.gif"   alt="Buscar" width="25" height="27"  border="0" align="absmiddle" /></a>&nbsp;
		<a href="javascript:Proceso('E','9')"><img src="archivos/excel.png" alt='Excel' width="25" height="25" border="0" align="absmiddle" /></a> &nbsp;
