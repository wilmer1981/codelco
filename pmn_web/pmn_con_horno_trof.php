...
{
	var f=document.frm1;
	f.action="pmn_xls_horno_trof.php?FechaIni="+FechaI + "&FechaFin="+FechaT + "&Turno="+T;
	f.submit();
}
...
<table width="749" border="0" cellspacing="0" cellpadding="3">
    <tr> 
	  ...
	  <td width="477" align="center" valign="middle"><strong class="titulo_azul">HORNO TROF</strong></td>
