...
function Guardar()
{
	...
	{
		f.action = "pmn_con_balance_recepcion_bad_ventana.php?proceso=G";
		f.submit();
	}
}
/******************/
...
<table width="600" border="1" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
  <tr> 
    ...
    <td width="468" align="left">Ingreso Barro Anodico Descobrizado Por Refineria</td>
  </tr>
  <tr> 
    <td>Periodo</td>
...
<?php	
	...
	$consulta.= " WHERE YEAR(lote) = '".$ano1."' AND MONTH(lote) = '".$mes1."' AND bloqueado = 'S'";
	...
	if ($Activar == "S")
	{
		...
		$eliminar.= " WHERE YEAR(lote) = '".$ano1."' AND MONTH(lote) = '".$mes1."'";
		$eliminar.= " AND cod_producto = '".$cmbproducto."' AND cod_subproducto = '".$cmbsubproducto."' AND tipo_mov IN ('".$cmbmovimiento."')";			
		//echo $eliminar."<br>";
...
<br>
<table width="700" border="1" align="center"  cellspacing="0" cellpadding="3" class="TablaInterior">
