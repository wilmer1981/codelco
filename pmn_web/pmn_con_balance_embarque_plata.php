...
function Guardar()
{
	...
	{	
		f.action = "pmn_con_balance_embarque_plata.php?proceso=G";
		f.submit();
	}
}
/******************/
...
<table width="600" border="1" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
  <tr> 
    ...
    <td width="468" align="left">Embarque De Plata</td>
  </tr>
  <tr> 
    <td>Periodo</td>
...
<br>
  <table width="868" border="1" align="center"  cellspacing="0" cellpadding="3" class="TablaInterior">
    <tr class="ColorTabla01"> 
      <td width="45" rowspan="2" align="center">Fecha</td>
      <td width="32" rowspan="2" align="center">N&ordm; Acta</td>
      <td width="48" rowspan="2" align="center">Cantidad</td>
      <td width="56" rowspan="2" align="center">Elect.</td>
      <td width="44" rowspan="2" align="center">Peso </td>
  ...
  <tr class="ColorTabla01"> 
	...
	{
?>
    <td width="28" align="center">Ag (%)</td>
    <td width="37" align="center">Cu (ppm)</td>
    <td width="37" align="center">Bi (ppm)</td>
    <td width="36" align="center">Fe (ppm)</td>
    <td width="37" align="center">Pb (ppm)</td>
    <td width="37" align="center">Se (ppm)</td>
	<td width="37" align="center">Cd (ppm)</td>
    <?php
	}
	else
	{
?>
    <td width="30" align="center">Ag (Kg)</td>
    <td width="31" align="center">Cu (Kg)</td>
    <td width="31" align="center">Bi (Kg)</td>
    <td width="30" align="center">Fe (Kg)</td>
    <td width="31" align="center">Pb (Kg)</td>
    <td width="30" align="center">Se (Kg)</td>
	<td width="56" align="center">Cd (Kg)</td>
    <?php
	}
?>
    </tr>
