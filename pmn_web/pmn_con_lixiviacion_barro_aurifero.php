...
{
	var f=document.frm1;
	f.action="pmn_xls_lixiviacion_barro_aurifero.php?FechaIni="+FechaI + "&FechaFin="+FechaT + "&Turno="+T;
	f.submit();
}
...
<table width="749" border="0" cellspacing="0" cellpadding="3">
    <tr> 
      ...
      <td width="477" align="center" valign="middle"><strong class="titulo_azul">LIXIVIACION BARRO 
        AURIFERO </strong></td>
...
<br>
  <table width="1200" border="1" cellpadding="3" cellspacing="0" class="TituloCabeceraAzul">
    <tr class="ColorTabla01"> 
      <td width="72" rowspan="3" align="center">N&ordm; Electrolisis</td>
