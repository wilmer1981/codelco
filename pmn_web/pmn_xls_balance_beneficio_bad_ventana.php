...
<br>
<strong>
Informe: Beneficio Barro Anodico Descobrizacion En PLASEL<br>
...
<br>
  <table width="850" border="1" cellspacing="0" cellpadding="3" class="TablaInterior">
    <tr class="ColorTabla01"> 
      <td width="85" rowspan="2" align="center">Num. Lixiviacion</td>
      <td width="61" rowspan="2" align="center">Prod.</td>
      <td width="77" rowspan="2" align="center">Hornada</td>
      <td width="77" rowspan="2" align="center">Fecha</td>
      <td width="78" rowspan="2" align="center">Peso Seco </td>
      <td width="85" rowspan="2" align="center">Total Benef.</td>
      <td width="80" rowspan="2" align="center">Total Disp.</td>
	...
	{
?>
      <td width="79" align="center">Cu (%)</td>
      <td width="75" align="center">Ag (K/T)</td>
...
<?php
	...
	{
?>
    <td width="79" align="center">Cu (Kg)</td>
    <td width="75" align="center">Ag (Kg)</td>
...
?>	
	...
	{   
		...
		$consulta.= " GROUP BY t1.fecha, t1.referencia, t3.cod_leyes";
		$consulta.= " ORDER BY t1.fecha, t1.referencia, t3.cod_leyes";	
		//echo $consulta."<br><br>";					
	...
	$consulta.= " ORDER BY t1.num_lixiviacion, t1.hornada, t1.cod_leyes";
	...
	while($row = mysqli_fetch_array($rs))
	{
		if ($ReferenciaAnt != $row[referencia])
		{
			...
			$consulta = "SELECT IFNULL(COUNT(DISTINCT hornada),0) AS filas";
			$consulta.= " FROM pmn_web.resultado_productos AS t1";
