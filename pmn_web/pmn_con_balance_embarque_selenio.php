...
<table width="600" border="1" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
  <tr> 
    ...
    <td width="468" align="left">Embarque Selenio Comercial</td>
  </tr>
  <tr> 
    <td>Periodo</td>
...
<br>
  <table width="950" border="1"   align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
    <tr class="ColorTabla01"> 
      ...
      <td width="76" rowspan="2" align="center">N&ordm; Lote</td>
      <td width="73" rowspan="2" align="center">Peso Humedo</td>
      <td width="50" rowspan="2" align="center">H<sub>2</sub>O (%)</td>
      <td width="67" rowspan="2" align="center">Peso Seco</td>
	...
	{
?>	
      <td width="61" align="center">Se (%)</td>
      <td width="65" align="center">Cu (ppm)</td>
      <td width="60" align="center">Ag (g/T)</td>
      <td width="65" align="center">Au (g/T)</td>
      <td width="71" align="center">Sb (ppm)</td>
      <td width="67" align="center">Fe (ppm)</td>
      <td width="59" align="center">Pb (ppm)</td>
      <td width="54" align="center">Te (ppm)</td>
    <?php
	}
	else
	{
?>
      <td width="61" align="center">Se (Kg)</td>
      <td width="65" align="center">Cu (Kg)</td>
      <td width="60" align="center">Ag (Kg)</td>
      <td width="65" align="center">Au (Kg)</td>
      <td width="71" align="center">Sb (Kg)</td>
      <td width="67" align="center">Fe (Kg)</td>
      <td width="59" align="center">Pb (Kg)</td>
      <td width="54" align="center">Te (Kg)</td>
    <?php
	}
?>	  
    </tr>
	...
	$consulta = "SELECT t1.fecha AS fecha_venta, t1.lote AS numero, t1.cod_leyes, t1.valor, CASE WHEN t1.cod_leyes = '40' THEN 1 ELSE 2 END AS orden, t1.humedad, t1.peso_humedo, t1.peso_seco, t1.conversion, t1.fino";
	...
	$consulta.= " ORDER BY t1.fecha_venta, t1.numero, orden, t1.cod_leyes";
	//echo $consulta."<br>";		
	   
	//---.
	$Finos = array('40'=>0, '02'=>0, '04'=>0, '05'=>0,'09'=>0, '31'=>0, '39'=>0, '44'=>0); //La Posicion Cero(0), es para almacenar el peso. 
	$Unidad = array('40'=>100, '02'=>1000000, '04'=>0, '05'=>0, '09'=>1000000, '31'=>1000000, '39'=>1000000, '44'=>1000000);
	$TotalPesoHumedo = 0;
	$TotalPesoSeco = 0;
	$TotalHumedad = 0;
	$CantidadReg = 0; 
