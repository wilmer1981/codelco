...
<table width="900" align="center"  border="0" cellpadding="0"  cellspacing="0">
  ...
  <tr>
   ...
   <td align="center"><table width="100%" border="0" cellpadding="0"  cellspacing="0">
     <tr>
	 <td align="center" colspan="7" class="TituloCabecera2">GR&Aacute;FICO PROCESO </td>
	 </tr>
	 <tr>       
     ...
     <tr>
       <td colspan="3" align="left" class="formulario">Proceso</td>
	   <td colspan="3" class="formulario"><select name="select">
          <?php
  ...
  <tr>
    ...
    <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="51%" colspan="3" align="center" class="LineasBordesAba">Valor F&iacute;sico </td>
        </tr>
      <tr>
