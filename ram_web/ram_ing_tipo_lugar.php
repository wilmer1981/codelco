...
<html>
<head>
<title>Creación de Tipo de Lugares</title>
...
<table width="770" height="330" border="0" cellpadding="5" cellspacing="0" class="TablaPrincipal">
  <tr>
	 ...
	 <table width="88%" class="TablaDetalle" cellpadding="3" cellspacing="0">
          <tr> 
            <td width="146"><img src="../principal/imagenes/left-flecha.gif" width="11" height="11">&nbsp;Código Tipo Lugar</td>
            <td width="103">
			<?php			
			if($buscar == "S")			 
          ...
          <tr> 
            <td><img src="../principal/imagenes/left-flecha.gif" width="11" height="11">&nbsp;Descripcion Tipo Lugar</td>
            <td colspan="2">
			<?php			
			if($buscar == "S")			 
          ...
          <tr> 
            <td colspan="3"><div align="center"> 
				...
				?>
                <input name="detalle" type="button"  value="Ver Detalle" onClick="mostrar();" style="width:80px">
	    ...
	    <table width="88%" class="TablaDetalle" cellpadding="3" cellspacing="0" border="1">
		  <tr class="ColorTabla01">
            <td width="4%">&nbsp;</td>
            <td width="36%"><div align="center">Codigo Tipo</div></td>
            <td width="60%"><div align="center">Descripci&oacute;n Lugar</div></td>
          </tr>
        <?php
if($Proceso == "V")
{
