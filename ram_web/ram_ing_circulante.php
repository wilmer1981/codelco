...
<table width="770" height="330" border="0" cellpadding="5" cellspacing="0" class="TablaPrincipal">
 <tr> 
  ...
  <table width="700" border="0" cellpadding="3" cellspacing="0" class="TablaDetalle">
          <tr> 
            <td width="49"><img src="../principal/imagenes/left-flecha.gif" width="11" height="11">&nbsp;Fecha 
            </td>
...
?>
		...
		<table width="700" border="0" cellpadding="5" cellspacing="0" class="TablaDetalle">
          <tr> 
            ...
            <td width="458"><input name="buscar" type="button" style="width:70" value="Buscar" onClick="Buscar_Conjunto();"></td>
          </tr>
          <tr> 
		...
		<table width="700" border="1" cellpadding="5" cellspacing="0" class="TablaDetalle">
          <tr class="ColorTabla02"> 
            <td colspan="6"><div align="center"><strong>Datos Ingresados</strong></div></td>
          </tr>
          <tr class="ColorTabla01"> 
            <td width="22">&nbsp;</td>
            <td width="76"><div align="center">Nro. Conj.</div></td>
            <td width="217"><div align="center">Descripci&oacute;n Conjunto</div></td>
            <td width="93"><div align="center">Peso Humedo</div></td>
            <td width="229"><div align="center">Lugar Destino</div></td>
			<td width="80"><div align="center">Tipo Ingreso</div></td>
          </tr>
