	...
	switch ($Proceso)
	{
		case "G":
			...
			if ($Fila["valor"] == "0")
			{
				...
				header("location:ram_con_anexo_cir.php?Mostrar=S&Ano=".$Ano."&Mes=".$Mes."");
			}			
			break;		
		case "AM":
			//VALIDA PASSWORD
			...
			else
			{
				...
				echo "window.opener.document.frm1.action='ram_con_anexo_cir.php?Mostrar=S&Ano=".$Ano."&Mes=".$Mes."';";
