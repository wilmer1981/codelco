...
if ($FinoLeyes=="L") echo "(pmm)"; else echo "(Kg)";
echo "</td>\n";
echo "<td width='40'>Hg<br>";
if ($FinoLeyes=="L") echo "(pmm)"; else echo "(Kg)";
echo "</td>\n";
echo "<td width='40'>Cd<br>";
if ($FinoLeyes=="L") echo "(pmm)"; else echo "(Kg)";
echo "</td>\n";
echo "<td width='40'>Ni<br>";
if ($FinoLeyes=="L") echo "(pmm)"; else echo "(Kg)";
echo "</td>\n";
...
{		
	...
	if ($TipoMovimiento == "T")
	{
		...
		echo "<td colspan='16'><strong>".$Fila1["cod_subclase"].".-".strtoupper($Fila1["nombre_subclase"])."</strong></td>\n";
		echo "</tr>\n";
	}	
	switch ($Agrup)
	{
		case "C":
			switch ($Fila1["cod_subclase"])	
			{
				case 3://BENEFICIO DIRECTO
					...
					$Consulta.= " Sum(t1.fino_au) AS fino_au, Sum(t1.fino_as) AS fino_as, Sum(t1.fino_s) AS fino_s, Sum(t1.fino_pb) AS fino_pb, Sum(t1.fino_sb) AS fino_sb, Sum(t1.fino_fe) AS fino_fe, Sum(t1.fino_hg) AS fino_hg, Sum(t1.fino_cd) AS fino_cd, Sum(t1.fino_mgo) AS fino_ni";
	...
	while ($Fila = mysqli_fetch_array($Respuesta))
	{
		if ($CodConjuntoAnt != $Fila["cod_conjunto"])
		{
			if ($Cont != 1)
			{
				...
				if ($FinoLeyes == "L")
				{
					if ($SubTotalHg > 0 && $SubTotalSeco > 0)
						echo number_format(($SubTotalHg/$SubTotalSeco)*100,$CantDec,",",".");
					else
						echo "0";
				}
				else
				{
					echo number_format($SubTotalHg,$CantDec,",",".");
				}
				echo "</td>\n";
				echo "<td>\n";
				if ($FinoLeyes == "L")
				{
					if ($SubTotalCd > 0 && $SubTotalSeco > 0)
						echo number_format(($SubTotalCd/$SubTotalSeco)*100,$CantDec,",",".");
					else
						echo "0";
				}
				else
				{
					echo number_format($SubTotalCd,$CantDec,",",".");
				}
				echo "</td>\n";
				echo "<td>\n";
				if ($FinoLeyes == "L")
				{
					if ($SubTotalNi > 0 && $SubTotalSeco > 0)
						echo number_format(($SubTotalNi/$SubTotalSeco)*100,$CantDec,",",".");
					else
						echo "0";
				}
				else
				{
					echo number_format($SubTotalNi,$CantDec,",",".");
				}
				echo "</td>\n";
		...
		switch ($FinoLeyes)
		{
			case "L":
				...
				if ($Fila["fino_fe"]>0 && $Fila["peso_seco"]>0)
					...
					$Fe = 0;
				if ($Fila["fino_hg"]>0 && $Fila["peso_seco"]>0)
					$Hg =  ($Fila["fino_hg"]/$Fila["peso_seco"])*100;
				else
					$Hg = 0;
				if ($Fila["fino_cd"]>0 && $Fila["peso_seco"]>0)
					$Cd =  ($Fila["fino_cd"]/$Fila["peso_seco"])*100;
				else
					$Cd = 0;
				if ($Fila["fino_ni"]>0 && $Fila["peso_seco"]>0)
					$Ni =  ($Fila["fino_ni"]/$Fila["peso_seco"])*100;
				else
					$Ni = 0;
		...
		echo "<td align='right'>".number_format($Hg,$CantDecHg,",",".")."</td>\n";
		echo "<td align='right'>".number_format($Cd,$CantDecCd,",",".")."</td>\n";
		echo "<td align='right'>".number_format($Ni,$CantDecNi,",",".")."</td>\n";		
		echo "</tr>\n";
		//SUBTOTALES
		...
		$SubTotalHg = $SubTotalHg + $Fila["fino_hg"];
		$SubTotalCd = $SubTotalCd + $Fila["fino_cd"];
		$SubTotalNi = $SubTotalNi + $Fila["fino_ni"];
		//TOTALES
		...
		$TotalHg = $TotalHg + $Fila["fino_hg"];
		$TotalCd = $TotalCd + $Fila["fino_cd"];
		$TotalNi = $TotalNi + $Fila["fino_ni"];
	...
	{
		if ($SubTotalHg > 0 && $SubTotalSeco > 0)
			echo number_format(($SubTotalHg/$SubTotalSeco)*100,$CantDecHg,",",".");
		else
			echo "0";
	}
	else
	{
		echo number_format($SubTotalHg,$CantDecHg,",",".");
	}
	echo "</td>\n";
	echo "<td>\n";
	if ($FinoLeyes == "L")
	{
		if ($SubTotalCd > 0 && $SubTotalSeco > 0)
			echo number_format(($SubTotalCd/$SubTotalSeco)*100,$CantDecCd,",",".");
		else
			echo "0";
	}
	else
	{
		echo number_format($SubTotalCd,$CantDecCd,",",".");
	}
	echo "</td>\n";
	echo "<td>\n";
	if ($FinoLeyes == "L")
	{
		if ($SubTotalNi > 0 && $SubTotalSeco > 0)
			echo number_format(($SubTotalNi/$SubTotalSeco)*100,$CantDecNi,",",".");
		else
			echo "0";
	}
	else
	{
		echo number_format($SubTotalNi,$CantDecNi,",",".");
	}
	echo "</td>\n";
	...
	if ($FinoLeyes == "L")
	{
		if ($TotalHg > 0 && $TotalSeco > 0)
			echo number_format(($TotalHg/$TotalSeco)*100,$CantDecHg,",",".");
		else
			echo "0";
	}
	else
	{
		echo number_format($TotalHg,$CantDecHg,",",".");
	}
	echo "</td>\n";
	echo "<td>\n";
	if ($FinoLeyes == "L")
	{
		if ($TotalCd > 0 && $TotalSeco > 0)
			echo number_format(($TotalCd/$TotalSeco)*100,$CantDecCd,",",".");
		else
			echo "0";
	}
	else
	{
		echo number_format($TotalCd,$CantDecCd,",",".");
	}
	echo "</td>\n";
	echo "<td>\n";
	if ($FinoLeyes == "L")
	{
		if ($TotalNi > 0 && $TotalSeco > 0)
			echo number_format(($TotalNi/$TotalSeco)*100,$CantDecNi,",",".");
		else
			echo "0";
	}
	else
	{
		echo number_format($TotalNi,$CantDecNi,",",".");
	}
	echo "</td>\n";
