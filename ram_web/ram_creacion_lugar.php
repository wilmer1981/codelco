...
<table width="770" height="330" border="0" cellpadding="5" cellspacing="0" class="TablaPrincipal">
  <tr>
	...
	<table width="88%" class="TablaDetalle" cellpadding="3" cellspacing="0">
          <tr> 
            <td width="102"><img src="../principal/imagenes/left-flecha.gif" width="11" height="11">&nbsp;Tipo Lugar</td>
            <td width="224"> 
              <?php
          ...
          <tr> 
            <td><img src="../principal/imagenes/left-flecha.gif" width="11" height="11">&nbsp;N�mero Lugar</td>
            <td colspan="2">
			<?php			
			if($buscar == "S")			 
          ...
          <tr> 
            <td><img src="../principal/imagenes/left-flecha.gif" width="11" height="11">&nbsp;Descripci&oacute;n</td>
            <td colspan="2">
			<?php
			if($buscar == "S")			 
          ...
          <tr> 
            <td><img src="../principal/imagenes/left-flecha.gif" width="11" height="11">&nbsp;Estado</td>
            <td colspan="2"> 
              <?php
		...
		<br>      
          ...
          <tr class="ColorTabla01"> 
            <td width="44">&nbsp;</td>
            <td width="149"><div align="center">Num Lugar</div></td>
            <td width="270"><div align="center">Descripci&oacute;n Lugar</div></td>
            <td width="169"><div align="center">Estado</div></td>
          </tr>
          <?php
			if($Proceso == "V")
			{
				$consulta = "SELECT * FROM lugar_conjunto WHERE cod_tipo_lugar = $cmbtipo ORDER BY num_lugar";
				include("../principal/conectar_ram_web.php");
				$rs = mysqli_query($link, $consulta);
