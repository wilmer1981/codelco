...
<table width="770" height="330" border="0" cellpadding="5" cellspacing="0" class="TablaPrincipal">
  <tr>
	...
	<table cellpadding="3" cellspacing="0" width="666" align="center" border="0" bordercolor="#b26c4a" class="TablaPrincipal" >
          <tr class="ColorTabla02"> 
            <td colspan="5"><div align="center">Consulta de Conjuntos</div></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td height="26"><img src="../principal/imagenes/left-flecha.gif" width="11" height="11">&nbsp;Producto</td>
            <td colspan="2"> 
              <?php
            ...
            <td><input name="buscar" type="button" style="width:70" value="Buscar" onClick="buscar_conjunto();"></td>
            <td>&nbsp;</td>
          </tr>
          <tr> 
            <td width="120" height="26"><img src="../principal/imagenes/left-flecha.gif" width="11" height="11">&nbsp;N&deg; 
              Conjunto</td>
            <td width="102"> 
              <?php
			if($Proceso == "B2")
            ...
            <td width="103"><input name="buscar2" type="button" style="width:70" value="Buscar" onClick="buscar_conjunto2();"></td>
            <td width="144">&nbsp;</td>
            <td width="171"> <input name="btnimprimir2" type="button" style="width:70" value="Imprimir" onClick="Imprimir();"> 
