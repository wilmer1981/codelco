...
<body class="TablaPrincipal">
	...
	$consulta = "SELECT distinct COD_LUGAR_DESTINO FROM movimiento_conjunto WHERE FECHA_MOVIMIENTO BETWEEN '$Fecha_Ini' AND '$Fecha_Ter' order by COD_LUGAR_DESTINO ASC ";
