...
<table width="544"  border="1" align="center" cellpadding="2" cellspacing="0" class="TablaInterior">
  <tr class="ColorTabla02" align="center">
    <td colspan="4"><strong>ALIMENTACION A TOLVAS DE CONVERTIDOR TENIENTE </strong></td>
  </tr>
  <tr class="Colum01">
  ...
  <tr align="center" class="Colum01">
	...
	<td>Polvo<br>
Convert.</td>
	<td>Mazamorra<br>Carga Fria</td>
	<td>Total<br>Cir.a CT</td>
	<td>Minerales<br>Au - Cu .</td>
	<td>Otros<br>P.M.N </td>
	<td>Carb&oacute;n<br>Coque </td>
	<td>Silice</td>
