    ...
    <form name="frmPrincipal" action="" method="post">
        ...
        <table width="770" height="315" border="0" cellpadding="3" cellspacing="3" class="TablaPrincipal">
			...
			?>
                        ...
                        <tr>
                            <td>NUM. CONJUNTO </td>
                            <td><input name="TxtConjunto" type="text" id="TxtConjunto"
                                    value="<?php echo $TxtConjunto; ?>" size="15" maxlength="10"></td>
                        </tr>
                        <tr align="center">
                            <td colspan="2">
                                <?php
			...
			?></td>
                        ...
                        <tr align="center">
                            <td colspan="2"><input name="ChkPMineros" type="checkbox" id="ChkPMineros" value="S"
                                    checked>
                                PROD. MINEROS
                    ...
                    <br>
                    <table width="76%" border="0" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
                        <tr>
				...
				?>
                    ...
                    <table width="76%" border="0" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
                        <tr>
                            <td width="100%" align="center"><input name="BtnConsultar2" type="button" value="Consultar"
                                    style="width:70px" onClick="Proceso('C');">
                                <input name="BtnExcel2" type="button" id="BtnExcel2" style="width:70px"
                                    onClick="Proceso('E');" value="Excel">
                                <?php
	if ($ConsComun=="S")
	{
?>
                                <input name="BtnSalir2" type="button" value="Salir" style="width:70px"
                                    onClick="Proceso('S2');">
                            </td>
                            <?php
	}
