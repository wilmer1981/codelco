	...
	switch (opt)
	{
		...
		case "XLS":
			if(f.OptAnulados.checked==true)
				...
				f.action = "rec_adm_lote_excel_2.php?VerAnulados=S&TipoCon=<?php echo $TipoCon; ?>&Orden=<?php echo $Orden; ?>";
			else
		...
		case "M":
			...
			switch(f.CmbTipoRegistro.value)
			{
				...
				case "O":
					...
					break;		
				case "C":
					window.open("rec_adm_lote06.php?TipoConsulta=<?php echo $TipoCon; ?>&Proc=M&TxtCorr="+TxtCorr,"","top=10,left=30,width=750,height=400,scrollbars=yes,resizable=yes");
					break;		
			}
			break;
		case "E":
		...
		case "I":
			if(confirm('Esta Seguro de Imprimir Boleta'))
			{
				...
				TxtLotes = TxtLotes.substring(0,(TxtLotes.length-2));
				//alert(TxtLotes);
				f.action = "rec_adm_lote01.php?Proceso=I&TxtValores="+TxtLotes+"&TipoRegistro="+f.CmbTipoRegistro.value+"&TxtNumRomana="+TxtNumRomana;
				f.submit();
			}	
			break;
	}
	  ...
	  <td width="770" height="340" align="center" valign="top"><br>
		  <table width="750"  border="1" cellpadding="2" cellspacing="0" class="TablaInterior">
            ...
            <tr>
			  ...
			  <input type="hidden" name="TxtNumRomana" value="<?php echo $TxtNumRomana;?>">			  </td>
            </tr>
            <tr>
              <td width="">Entre Fechas:</td>
              <td width=""><input name="TxtFechaIni" type="text" class="InputCen" value="<?php echo $TxtFechaIni; ?>" size="15" maxlength="10" readOnly>
            ...
            <tr>
              <td>Por Lote: </td>
              <td><input name="TxtLoteIni" type="text" class="InputDer" id="TxtLoteIni" value="<?php echo $TxtLoteIni; ?>" size="10" maxlength="10" onKeyDown="TeclaPulsada2('S',false,this.form,'TxtLoteFin');"> 
                Al
                  <input name="TxtLoteFin" type="text" class="InputDer" id="TxtLoteFin" value="<?php echo $TxtLoteFin; ?>" size="10" maxlength="10" onKeyDown="TeclaPulsada2('S',false,this.form,'');">
...
lineas</td>
			  ...
			  {
			  ?>
			  <input name="TxtConjunto" type="text" class="InputCen" value="<?php echo $TxtConjunto;?>" size="7" maxlength="4" onKeyDown="TeclaPulsada2('S',false,this.form,'');">
