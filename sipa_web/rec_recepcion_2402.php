	...
	switch (opt)
	{
		case "G"://ACTUALIZAR RECEPCION
			if(ValidarCampos('G'))
			{
				...
				f.action = "rec_recepcion01_2402.php?Proceso="+opt2;
				f.submit();	
			}
			break;
		case "B"://BUSCA LOTE NUEVO O LOTE EXISTENTE
			if(ValidarCampos(''))
			{
				if(f.CmbLotes.value=='-1')//ES LOTE NUEVO
					f.action = "rec_recepcion_2402.php?Proceso=B1";
				else
					f.action = "rec_recepcion_2402.php?Proceso=B2";//LOTE INGRESADO
				f.submit();	
			}
			break;
		case "BC":
			...
			{
				f.action = "rec_recepcion_2402.php?Proceso=BC&ObjFoco="+ObjFoco.name;//BUSCAR CORRELATIVO
				f.submit();	
			}	
			break;	
		case "I"://IMPRIMIR
			f.action = "rec_recepcion01_2402.php?Proceso=I";
			f.submit();	
		...
		case "S"://SALIR
			...
			break;
		case "C"://CANCELAR
			f.action = "rec_recepcion01_2402.php?Proceso=C";
			f.submit();	
			break;
		case "M"://MODIFICAR
			f.TipoProceso.value="S";
			...
			{
				f.action = "rec_recepcion01_2402.php?Proceso=M";
				f.submit();	
			}	
			break;
		case "A"://ANULAR
			...
			{
				f.action = "rec_recepcion01_2402.php?Proceso=A";
				f.submit();	
			}	
			break;
	}
...
function Recarga(ObjFoco,Tipo)
{
	...
	if(f.TxtPatente.value==''&&Tipo=='S')
		return;
	f.action = "rec_recepcion_2402.php?ObjFoco="+ObjFoco.name;
	f.submit();		
}
...
function BuscarProveedor()
{
	...
	if(f.CmbProveedor.value!='S'&&f.CmbProveedor.value!='')
	{
		f.action = "rec_recepcion_2402.php?BuscarPrv=S";
		f.submit();		
	}	
}
...
<table width="700"  border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="TablaInterior">
  ...
  <tr>
	...
	<input <?php echo $EstadoInput; ?> name="TxtPesoBruto" type="text" class="InputCen" value="<?php echo $TxtPesoBruto; ?>" size="10" maxlength="10" onBlur="CalculaPNeto()" readonly="true" ></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<SELECT name="CmbSubProducto" style="width:300" onChange="Recarga(CmbProveedor)" onkeypress="buscar_op(this,CmbProveedor,0,'S')" onBlur="borrar_buffer()" onclick="borrar_buffer()" <?php echo $HabilitarCmb;?>>
      ...
      <input name="TxtHumedad" type="text" class="InputCen" value="<?php echo $TxtHumedad; ?>" size="2" readonly="true">
  ...
  <tr>
    ...
    <td colspan="5" class="ColorTabla02">
      ...
      Venc.Padron:	<input name="TxtVencPadron" type="text" class="InputCen" id="TxtVencPadron" value="<?php echo $TxtVencPadron; ?>" size="12" maxlength="10" readonly="true" >
	  </td>
	  <?php }
	  else
	  {
  ...
  <tr>
    ...
    <td colspan="5" class="ColorTabla02">
	<SELECT name="CmbMinaPlanta" style="width:570" onChange="ObtenerFecPadronConj()" onKeyDown="TeclaPulsada2('N',false,this.form,'BtnPBruto');" <?php echo $HabilitarCmb;?>>
      <option value="S" SELECTed class="NoSelec">Seleccionar</option>
	  <?php
  ...
  <tr>
	...
	//echo $CmbConjunto."<br>";
	//echo $Consulta;?>
    <input name="CmbConjunto" type="text" class="InputCen" value="<?php echo $CmbConjunto; ?>" size="12" maxlength="10" readonly="true" >	</td>
  ...
  <tr>
    ...
    <td colspan="2" class="ColorTabla02"><input name="TxtLeyes" type="text" value="<?php echo $TxtLeyes; ?>" size="24" readonly="true" >
  ...
  <tr>
    ...
    <td class="ColorTabla02"><input name="TxtImpurezas" type="text" value="<?php echo $TxtImpurezas; ?>" size="24" readonly="true" ></td>
    <td align="left" class="ColorTabla02">&nbsp;</td>
    <td align="right" class="ColorTabla02">&nbsp;</td>
  ...
  <tr>
	...
	<input type="text" name="TxtPNetoTot" value="<?php echo $TxtPNetoTot;?>" class="InputDer" size="8" readonly="true">
	 </td>
  </tr>
	</table>
	<br>
