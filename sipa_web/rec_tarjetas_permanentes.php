...
<html>
<head>
<title>Tarjetas Permanentes</title>
...
function Proceso(opt)
{
	...
	switch (opt)
	{
		...
		case "I"://IMPRIMIR
			...
			break;
		case "C"://CONSULTAR
			f.action = "rec_tarjetas_permanentes.php";
			f.submit();
			break; 
		case "E"://ELIMINAR
			var Valores="";
			...
			else
			{
				if (confirm("¿Desea Eliminar este Elemento?"))
				{
					...
					f.action = "rec_tarjetas_permanentes01.php?Proceso=E&Valores="+Valores;
					f.submit();
				}
			}
			break; 
		case "R"://RECARGA
			...
			break;
		case "N":	
			var URL = "rec_tarjetas_permanentes_proceso.php?Proceso=N";
		...
		case "M":
			...
			else
			{
				if (contador == 1)
				{
					...
					Valores=Valores.substring(0,Largo-2);
					f.ValoresAux.value=Valores;
					var URL = "rec_tarjetas_permanentes_proceso.php?Proceso=M&Valores="+Valores;
					window.open(URL,"","top=120,left=30,width=500,height=250,menubar=no,resizable=yes,scrollbars=yes");
  ...
  <table width="770" border="0" cellpadding="5" cellspacing="0" class="TablaPrincipal">
    <tr> 
	  ...
	  <table width="500" border="1" cellspacing="0" cellpadding="3" class="TablaInterior">
        <tr align="center">
          <td class="ColorTabla02"><strong>TARJETAS</strong></td>
        </tr>
        <tr align="center">
    ...
    <tr class="ColorTabla01">
	  ...
	  <td width="100">Codigo Mop</td>
      </tr>
<?php	
	$Consulta = "SELECT * from sipa_web.tarjetas_permanentes order by tarjeta";
	$Resp = mysqli_query($link, $Consulta);
	while ($Fila=mysqli_fetch_array($Resp))
	{
		echo "<tr bgcolor=\"#FFFFFF\">\n";
		$ClaveChk=$Fila["patente"];
		echo "<td ><input type=\"checkbox\" name=\"ChkAsig\" value=\"".$ClaveChk."\"></td>\n";
		echo "<td >".$Fila["patente"]."</td>\n";
		echo "<td >".$Fila["tarjeta"]."</td>\n";
		echo "<td >".$Fila["cod_mop"]."</td>\n";
		echo "</tr>\n";
	}		
?>	
</table>	  
