<?php
	...
	foreach($Datos as $c => $v)
	{
		...
		if ($Fila = mysqli_fetch_array($Resp))
		{
			...
			$pdf->addTextWrap(310,705,70,9,str_pad($TxtNumRomana,2,'0',STR_PAD_LEFT),$justification='center',0,0);
			$pdf->addTextWrap(420,705,80,9,$Fila["bascula_entrada"],$justification='center',0,0);
