        ...
        <?php
			...
			switch($OrigenDatosGuia)
			{
				case "C":
						...
						$Consulta = "SELECT distinct rut_prv as rut_cliente, nombre_prv as sigla_cliente from sipa_web.proveedores ";
						$Consulta.= " where rut_prv = '".$VarProv."'";
                        //echo "aaaaaaa".$Consulta;
						$Resp=mysqli_query($link, $Consulta);
						if ($Fila = mysqli_fetch_array($Resp))
						{
