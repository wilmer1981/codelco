...
<html>
<head>
<title>Sistema de Recepci&oacute;n</title></head>

<body>
<table width="700" border="0" cellspacing="1" cellpadding="1">
  <tr> 
    <td width="109" colspan="2">Tipo Consulta:</td>
    <td width="570" colspan="5"><?php
	switch ($TipoConsulta)	
	{
		case "R":
			echo "Recepciones";
  ...
  <tr>
    <td colspan="2">Fecha Consulta:</td>
    <td colspan="5"><?php
...
<?php
	...
	{
		echo "<tr>\n"; 
		echo "<td colspan='2'>Lote Consulta:</td>\n";
		echo "<td colspan='5'>".$TxtLote."&nbsp;</td>\n";
		echo "</tr>\n";
	}
?>  
</table>
...
<?php
	...
	switch ($TipoConsulta)
	{
		case "R": // CONSULTA RECEPCIONES
			...
			{
				$ConsLote = "S";
				$Consulta = "SELECT * from sipa_web.recepciones where ";
				$Consulta.= " lote_a = '".$TxtLote."'";
				$Consulta.= " order by fecha_a, hora_a";
				//TITULOS DIARIO POR LOTE
				echo "<table width='2300' border='1' cellspacing='0' cellpadding='0'>\n";
				echo "<tr>\n";
				echo "<td>LOTE</td>\n";
				echo "<td>RECARGO</td>\n";					
				echo "<td>FECHA</td>\n";
			...
			else
			{
				...
				else
				{
					...
					$Consulta.= " from sipa_web.recepciones where ";
					$Consulta.= " fecha_a between '".$FechaIni."' and '".$FechaFin."' ";
					if ($Producto != "S")
						$Consulta.= " and c_prod_a = '".$Producto."'";
					if ($RutProveedor != "S")
