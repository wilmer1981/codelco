...
<html>
<head>
<title>Consulta Multiple Recepciones Y Despachos Excel</title>
...
?>		  
  <tr>
    <td width="150"  ><span class="Estilo1">Fecha</span></td>
...
?>	
  <tr>
    <td width="150"  ><span class="Estilo1">Rango de Lote:</span></td>
...
?>  
  <tr>
    <td width="150"  ><span class="Estilo1">Grupo Producto:</span></td>
    <td>
	<?php
	if ($CmbGrupoProd == "S")
	{
  ...
  <tr>
    <td width="150"  ><span class="Estilo1">SubProducto:</span></td>
    <td><?php
	if ($CmbSubProducto == "S")
	{
		echo "Todos";
...
?>
  ...
  <tr>
    <td width="150"  ><span class="Estilo1">Proveedor:</span></td>
    <td>
      <?php
	if ($CmbProveedor == "S")
		echo "Todos";
...
?>
  ...
  <tr>
    <td width="150"  ><span class="Estilo1">Ver Datos: </span></td>
    <td height="18">
<?php
	if ($OpcTR=="T")
...
{	
		...
		case "P":
			...
			switch($CmbTipoRegistro)	
			{
				...
				case "D":
					...
					ObtenerProveedorDespacho('D',$Fila01["rut_prv"],$Fila01["correlativo"],$Fila01["guia_despacho"],&$RutProved,&$NombreProved);
	...
	while ($FilaAux = mysqli_fetch_array($RespAux))
	{
		...
		//SUB-TOTAL 
		echo "<tr>\n";
		echo "<td colspan='".$ColSpanSubTotal."' align='left'><strong>";
		switch ($OpcConsulta)
		{			
			case "F":		
		...
		echo "</strong></td>\n";
		echo "<td align='center'><strong>".number_format($SubTotalPesoHum,$Decimales,",",".")."</strong></td>\n";
		echo "</tr>\n";
	...
	{
		case "F":
			echo "<tr><td colspan=\'".$ColSpanSubTotal."\' align='left'><strong>Total Dia&nbsp;".substr($Fila01["fecha"],8,2)."/".substr($Fila01["fecha"],5,2)."</strong></td>\n";
			break;
		case "P":
			echo "<tr><td colspan=\'".$ColSpanSubTotal."\' align='left'><strong>Total Proveedor</strong></td>\n";
			break;
		default:
			echo "<tr><td colspan=\'".$ColSpanSubTotal."\' align='left'><strong>Total Consulta</strong></td>\n";
			break;
	}
