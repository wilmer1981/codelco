<?php
	...
	/************************************************************* */
	//TipoConsulta=&TxtFechaIni=2024-02-02&TxtFechaFin=2024-02-02&Producto=&RutProveedor=&OptAcumulado=N
...
<input name="BtnSalir" type="button" id="BtnSalir" value="Salir" style="width:70px;" onClick="Proceso('S')">
  ...
  <tr> 
	...
	if ((($TipoConsulta == "R") || ($TipoConsulta == "D"))  && ($RutProveedor != "S"))
	{
		$Respuesta = mysqli_query($link, $Consulta);
		if ($Row = mysqli_fetch_array($Respuesta))
			echo $Row["rut_prv"]." - ".strtoupper($Row["nombre_prv"]);
		else
			echo "NO DEFINIDO";
	}
	?>
