<?php
	function ImprimirRecepcion($Correlativo,$Romana)
	{
		...
		$Consulta.= "t6.fecha_padron,t6.nombre_mina as nom_faena, t6.sierra,t6.comuna,t6.comuna,t1.cod_mina,t1.cod_clase,";
		...
		if($Fila=mysqli_fetch_array($Resp))
		{
			...
			fwrite($Archivo,$Fila["bascula_entrada"]." - ".$Fila["bascula_salida"]."\r\n");
			fwrite($Archivo,strtoupper(substr($Fila["nombres"],0,1)).strtoupper(substr($Fila["apellido_paterno"],0,1)).strtoupper(substr($Fila["apellido_materno"],0,1))."\r\n");
	...
	function ImprimirDespachos($Correlativo,$Romana)
	{
		$Consulta = "SELECT t1.correlativo,t1.bascula_entrada , t1.bascula_salida, t1.rut_operador, t1.lote, t1.correlativo, t1.peso_bruto, ";
		...
		$Consulta.= "t1.observacion, t1.patente, t1.guia_despacho,t6.nombre_subclase as tipo_despacho,t9.apellido_paterno,t9.apellido_materno,t9.nombres ";
	...
	function ImprimirOtrosPesajes($Correlativo,$Romana)
	{
