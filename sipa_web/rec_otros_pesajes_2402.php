	...
	switch (opt)
	{
		case "G"://ACTUALIZAR RECEPCION
			if(ValidarCampos())
			{
				...
				f.action = "rec_otros_pesajes01_2402.php?Proceso="+opt2;
				f.submit();	
			}
			break;
		case "B"://BUSCA LOTE NUEVO O LOTE EXISTENTE
			if(f.CmbLotes.value=='-1')//ES LOTE NUEVO
				f.action = "rec_otros_pesajes_2402.php?Proceso=B1";
			else
				f.action = "rec_otros_pesajes_2402.php?Proceso=B2";//LOTE INGRESADO
			f.submit();	
			break;
		case "BC":
			if(f.TxtCorrelativo.value!='S')
			{
				f.action = "rec_otros_pesajes_2402.php?Proceso=BC&ObjFoco="+ObjFoco.name;//BUSCAR CORRELATIVO
				f.submit();	
			}	
			break;	
		case "I"://IMPRIMIR
			...
			{*/
				f.action = "rec_otros_pesajes01_2402.php?Proceso=I";
				f.submit();	
			//}					
			break;	
		case "S"://SALIR
			...
			break;
		case "C"://CANCELAR
			f.action = "rec_otros_pesajes01_2402.php?Proceso=C";
			f.submit();	
			break;
		case "M"://MODIFICAR
			f.TipoProceso.value="S";
			...
			{
				f.action = "rec_otros_pesajes01_2402.php?Proceso=M";
				f.submit();	
			}	
			break;
		case "A"://ANULAR
			...
			{
				f.action = "rec_otros_pesajes01_2402.php?Proceso=A";
				f.submit();	
			}	
			break;
	}
...
function Recarga(ObjFoco,Tipo)
{
	...
	if(f.TxtPatente.value==''&&Tipo=='S')
		return;
	f.action = "rec_otros_pesajes_2402.php?ObjFoco="+ObjFoco.name;
	f.submit();		
}
...
<input name="TxtPesoHistorico" type="hidden" class="InputCen" value="<?php echo $TxtPesoHistorico; ?>" size="8" readonly="true">
</strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="ColorTabla02"><input <?php echo $EstadoInput; ?> name="TxtConjunto" type="text" class="InputIzq" value="<?php echo $TxtConjunto; ?>" onKeyDown="TeclaPulsada2('N',true,this.form,'TxtNombre');" size="20" maxlength="12" >
	</td>
