...
function Procesos(TipoProceso)
{
	...
	{
		case 'N'://GRABAR
			f.action='rec_ingreso_conjuntos_proceso01.php?Proceso=N';
			f.submit();
			break;
		case 'M'://MODIFICAR
			f.action='rec_ingreso_conjuntos_proceso01.php?Proceso=M';
			f.submit();
			break;
		case 'S'://SALIR
			window.close();
...
<input type="hidden" name="Valores" value="<?php echo $Valores;?>">
	    <table width="461" border="1" cellpadding="2" cellspacing="0" bgcolor="#000000" class="TablaInterior">
          ...
          <tr align="center" bgcolor="#FFFFFF">
            <td width="71" align="right">Conjunto:</td>
			<td width="375"><div align="left">
			  <input name="TxtConjunto" type="text" onKeyDown="TeclaPulsada(false)" value='<?php echo $TxtConjunto;?>' size="6" maxlength="4" <?php echo $Habilitar;?>>
			</div></td> 
          </tr>
          <tr align="center" bgcolor="#FFFFFF">
