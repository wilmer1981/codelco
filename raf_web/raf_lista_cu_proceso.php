...
var f = document.FrmPrincipal;
	...
	{
		case "W": 
				f.action="raf_con_cu_proceso.php";
				f.submit();
			break;

		case "E": 
			f.action="raf_con_cu_proceso_xls.php";
			f.submit();
			break;		
		case "S":
...
<tr> 
	<td height="313" align="center" valign="top">
	  ...
	  <table width="600" border="1" cellspacing="0" cellpadding="3" class="TablaDetalle">
          ...
          <tr align="center"> 
            <td height="50" colspan="2"><input type="button" name="BtnWeb" value="List Web" style="width:70px" onClick="Proceso('W');">
