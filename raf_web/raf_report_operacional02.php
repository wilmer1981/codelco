...
include("../principal/conectar_raf_web.php");
	...
	$Hornada_new = $Anito."".$MesJ."".$Hornada;
	//$Consulta = "SELECT * FROM raf_web.movimientos WHERE SUBSTRING(hornada,7) = '".$Hornada."' and left(hornada,4) = '".$Anito."'";
...
<form name="FrmPrincipal" method="post" action="">
  ...
  <table width="900" border="1" cellspacing="0" cellpadding="0" class="TablaDetalle">
	...
	{	
		...
		$dif = date("H:i",mktime(0,$mm));
		//DIFERENCIA ACUM. CON PROG REAL
		$mm =  abs(((substr($AcumHora,0,2) * 60) + substr($AcumHora,3,2)) - 270);	
		$AcumHora_Dif =  date("H:i",mktime(0,$mm));	
		$AcumHora_Dif2 =  date("H:i",mktime(0,$mm));		
	}
	else
	...
	{	
		...
		$dif = date("H:i",mktime(0,$mm));
		//DIFERENCIA ACUM. CON PROG REAL
		$mm =  abs(((substr($AcumHora,0,2) * 60) + substr($AcumHora,3,2)) - 480);	
		$AcumHora_Dif =  date("H:i",mktime(0,$mm));	
		$AcumHora_Dif2 =  date("H:i",mktime(0,$mm));		
	}
	else
	...
	{	
		...
		$dif = date("H:i",mktime(0,$mm));
		//DIFERENCIA ACUM. CON PROG REAL
		$mm =  abs(((substr($AcumHora,0,2) * 60) + substr($AcumHora,3,2)) - 540);	
		$AcumHora_Dif =  date("H:i",mktime(0,$mm));	
		$AcumHora_Dif2 =  date("H:i",mktime(0,$mm));		
	}
	else
	...
	{			
		...
		$dif = date("H:i",mktime(0,$mm));
		//DIFERENCIA ACUM. CON PROG REAL
		$mm =  abs(((substr($AcumHora,0,2) * 60) + substr($AcumHora,3,2)) - 720);	
		$AcumHora_Dif =  date("H:i",mktime(0,$mm));	
		$AcumHora_Dif2 =  date("H:i",mktime(0,$mm));		
	}
	else
  ...
  <table width="900" border="1" cellspacing="0" cellpadding="0" class="TablaDetalle">
	...
	{	
		...
		$dif = date("H:i",mktime(0,$mm));
		//DIFERENCIA ACUM. CON PROG REAL
		$mm =  abs(((substr($AcumHora,0,2) * 60) + substr($AcumHora,3,2)) - 780);	
		$AcumHora_Dif =  date("H:i",mktime(0,$mm));	
		$AcumHora_Dif2 =  date("H:i",mktime(0,$mm));		
	}
	else
	...
	{	
		...
		$dif = date("H:i",mktime(0,$mm));
		//DIFERENCIA ACUM. CON PROG REAL
		$mm =  abs(((substr($AcumHora,0,2) * 60) + substr($AcumHora,3,2)) - 930);	
		$AcumHora_Dif =  date("H:i",mktime(0,$mm));	
		$AcumHora_Dif2 =  date("H:i",mktime(0,$mm));		
	}
	else
	...
	{	
		...
		$dif = date("H:i",mktime(0,$mm));
		//DIFERENCIA ACUM. CON PROG REAL
		$mm =  abs(((substr($AcumHora,0,2) * 60) + substr($AcumHora,3,2)) - 1050);	
		$AcumHora_Dif =  date("H:i",mktime(0,$mm));	
		$AcumHora_Dif2 =  date("H:i",mktime(0,$mm));		
	}
	else
	...
	{	
		...
		$dif = date("H:i",mktime(0,$mm));
		//DIFERENCIA ACUM. CON PROG REAL
		$mm =  abs(((substr($AcumHora,0,2) * 60) + substr($AcumHora,3,2)) - 1080);	
		$AcumHora_Dif =  date("H:i",mktime(0,$mm));	
		$AcumHora_Dif2 =  date("H:i",mktime(0,$mm));		
	}
	else
	...
	{	
		...
		//DIFERENCIA CON PROG REAL
		$mm =  abs(((substr($real,0,2) * 60) + substr($real,3,2)) - 402);		  
		$dif = date("H:i",mktime(0,$mm));
		//DIFERENCIA ACUM. CON PROG REAL
		$mm =  abs(((substr($AcumHora,0,2) * 60) + substr($AcumHora,3,2)) - 1482);	
		$AcumHora_Dif =  date("H:i",mktime(0,$mm));	
		$AcumHora_Dif2 =  date("H:i",mktime(0,$mm));		
	}
	else
	...
	{	
		...
		$dif = date("H:i",mktime(0,$mm));
		//DIFERENCIA ACUM. CON PROG REAL
		$mm =  abs(((substr($AcumHora,0,2) * 60) + substr($AcumHora,3,2)) - 1512);	
		$AcumHora_Dif =  date("H:i",mktime(0,$mm));	
		$AcumHora_Dif2 =  date("H:i",mktime(0,$mm));		
	}
	else
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 4500;
			  $Acum_Dif2 = $Acum_Comb2 - 4500;
		  }
		  else
		  {
			  $real = '';
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 8100;
			  $Acum_Dif2 = $Acum_Comb2 - 8100;
		  }
		  else
		  {
			  $real = '';
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 11700;
			  $Acum_Dif2 = $Acum_Comb2 - 11700;
		  }
		  else
		  {
			  $real = '';
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 14400;
			  $Acum_Dif2 = $Acum_Comb2 - 14400;
		  }
		  else
		  {
			  $real = '';
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 16200;
			  $Acum_Dif2 = $Acum_Comb2 - 16200;
		  }
		  else
		  {
			  $real = '';
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 21600;
			  $Acum_Dif2 = $Acum_Comb2 - 21600;
		  }
		  else
		  {
			  $real = '';
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 23400;
			  $Acum_Dif2 = $Acum_Comb2 - 23400;
		  }
		  else
		  {
			  $real = '';
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 25650;
			  $Acum_Dif2 = $Acum_Comb2 - 25650;
		  }
		  else
		  {
			  $real = '';
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 27450;
			  $Acum_Dif2 = $Acum_Comb2 - 27450;
		  }
		  else
		  {
			  $real = '';
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 29850;
			  $Acum_Dif2 = $Acum_Comb2 - 29850;
		  }
		  else
		  {
			  $real = '';
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 30750;
			  $Acum_Dif2 = $Acum_Comb2 - 30750;
		  }
		  else
		  {
			  $real = '';
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 39550;
			  $Acum_Dif2 = $Acum_Comb2 - 39550;
		  }
		  else
		  {
			  $real = '';
    ...
    <tr> 
      ...
      <? 	
		  ...
		  {	
			  ...
			  $Acum_Dif = $Acum_Comb - 39850;
			  $Acum_Dif2 = $Acum_Comb2 - 39850;
		  }
		  else
		  {
			  $real = '';
