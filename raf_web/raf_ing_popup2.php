...
if($Proceso == "G")
{
	...
	$Insertar.= " values($Hornada,'$Fecha','$Report','$Seccion','$etapa','$inicio','$final')";	
...
function Proceso(opc)
{
	...
	switch (opc)
	{
		case "G":
			...
			f.action = "raf_ing_popup2.php?Proceso=G";
			f.submit();
			break							
		...
		case "B":
			...
			f.action = "raf_ing_popup2.php?Proceso=B";
			f.submit();
			break							
		...
		case "E":
			...
			f.action = "raf_ing_popup2.php?Proceso=E";
			f.submit();
			break							
    ...
    <tr> 
      <td width="285" height="154" align="center">
        <table width="282" border="0" cellspacing="0" cellpadding="0" class="TablaDetalle">
          ...
          <tr> 
            <td width="73">Inicial</td>
            <td width="206"><input name="inicio" size="10" value="<? echo $inicio; ?>"> 
            </td>
          </tr>
          <tr> 
            <td>Final</td>
            <td><input name="final" size="10" value="<? echo $final; ?>"></td>
          </tr>
        </table>
		<br>
        <br>	
