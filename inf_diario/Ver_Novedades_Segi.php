...
{     
   echo "<Script>
     ...
     JavaScript:window.location ='Novedades_Segi.php';
	</Script>"; 
...
{
        var Fecha;
		FrmPrincipal.action='Modificar_Novedades_Segi.php';
        FrmPrincipal.submit();
}

function elim_info()
{
        FrmPrincipal.action='Eliminar_Novedades_Segi.php';
        FrmPrincipal.submit();
}
...
function ver_nov()
{
        ...
        FrmPrincipal.action='Ver_Novedades_Segi.php?Proceso=V';
        FrmPrincipal.submit();
...
<form name="FrmPrincipal" method="post">
  <div align="center">
    <table width="87%" border="0" cellpadding="1" cellspacing="1" bgcolor="#F4D284">
      <tr bgcolor="#006699"> 
        <td width="39%" height="20" bgcolor="#6666CC"><div align="center"><strong><font color="#FFFFFF" size="4">Novedades</font></strong></div>
