...
{     
   echo "<Script>
     ...
     JavaScript:window.location ='Novedades_Pol.php';  
	</Script>"; 
...
{
        var Fecha;
		FrmPrincipal.action='Modificar_Novedades_Pol.php';
        FrmPrincipal.submit();
}

function elim_info()
{
        FrmPrincipal.action='Eliminar_Novedades_Pol.php';
        FrmPrincipal.submit();
}
