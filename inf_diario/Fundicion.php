...
?>
        ...
        <input name="novedades" type="submit" id="novedades" value="Novedades" onClick="ver_nov()";"></td></tr>
    </table>
    <table width="87%" border="0" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF" class="TablaDetalle">
      <tr bgcolor="#6666CC" class="ColorTabla01"> 
...
Ollas        </font></td>
    ...
    <table width="87%" border="0" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF" class="TablaDetalle">
	  ...
	  <tr > 
        ...
        <td><font color="#000000" size="1">
          <input name="Campo36" type="text" id="Campo36" value="0,00" size="8" onClick="FrmPrincipal.Campo36.value=''">
Ollas        </font></td>
	  </tr>
      <tr bgcolor="#6666CC" class="ColorTabla01"> 
        <td colspan="6">&nbsp;</td>
      ...
      <tr> 
		...
		<? //poly 14-09-2010 ?>
      <tr> 
        <td><font color="#000000" size="1"><strong>Ollas Scrap </strong></font></td>
        <td colspan="2"><font color="#000000" size="1"> 
          <input name="Campo37" type="text" id="Campo37" value="00,0" size="8" onClick="FrmPrincipal.Campo37.value=''">
          Ollas/d </font></td>
        <td><font color="#000000" size="1"><strong>Tonelaje Scrap</strong></font></td>
        <td colspan="2"><font color="#000000" size="1"> 
         <input name="Campo38" type="text" id="Campo38" value="00,0" size="8" onClick="FrmPrincipal.Campo38.value=''">
          T/d </font></td>
      </tr>
      ...
      <tr align="center"> 
        <td height="40" colspan="6"><div align="center"> 
          ...
          <input name="Salir" type="button" value="Salir" onClick=" window.location='http://<? echo HTTP_SERVER; ?>/proyecto/index.php?Pagina=index_inf_diario2.php'" style="width:70px">
          </div>
        <div align="center"></div></td>
      </tr>
    </table>
