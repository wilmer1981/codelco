...
{     
   echo "<Script>
     ...
     JavaScript:window.location ='Novedades_Prod_Finales.php';  
	</Script>"; 
...
{
        var Fecha;
		FrmPrincipal.action='Modificar_Novedades_Prod_Finales.php';
        FrmPrincipal.submit();
}

function elim_info()
{
        FrmPrincipal.action='Eliminar_Novedades_Prod_Finales.php';
        FrmPrincipal.submit();
}
    ...
    <table width="87%" border="0" cellpadding="1" cellspacing="1" bgcolor="#F4D284">
      <tr bgcolor="#006699"> 
        <td width="39%" height="20" bgcolor="#6666CC"><div align="center"><strong><font color="#FFFFFF" size="4">Novedades 
            Productos Finales </font></strong></div>
