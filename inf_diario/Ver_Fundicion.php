...
%        </font></td>
    ...
    <table width="87%" border="0" cellspacing="1" cellpadding="1" bgcolor="#F4D284">
	  ...
	  <tr> 
        <td bgcolor="#F4D284"><font color="#000000" size="1"><strong>Ollas Scrap</strong></font></td>
        <td colspan="2" bgcolor="#F4D284"><font color="#000000" size="1">
          <input name="Campo37" type="text" id="Campo37" value="<? echo $Campo37 ?>" size="8">
          Ollas/d </font></td>
        <td bgcolor="#F4D284"><font color="#000000" size="1"><strong>Tonelaje 
          Scrap </strong></font></td>
        <td colspan="2"><font color="#000000" size="1">
          <input name="Campo38" type="text" id="Campo38" value="<? echo $Campo38 ?>" size="8">
          T/d </font></td>
      </tr>
      <tr> 
