...
function ing_user()
{
        ...
        FrmPrincipal.action='Ingreso_Novedades_Segi.php';
        FrmPrincipal.submit();
}
...
<form name="FrmPrincipal" method="post">
  <div align="center">
    <table width="87%" border="0" cellpadding="1" cellspacing="1" bgcolor="#F4D284">
      <tr bgcolor="#006699"> 
        <td height="20" bgcolor="#6666CC"><div align="center"><strong><font color="#FFFFFF" size="4">Novedades</font></strong></div></td>
