...
function ing_user()
{
        ...
        FrmPrincipal.action='Ingreso_Novedades_Prod_Met.php';
        FrmPrincipal.submit();
}
...
function ver_nov()
{
        ...
        FrmPrincipal.action='Ver_Novedades_Prod_Met.php?Proceso=V';
        FrmPrincipal.submit();
    ...
    <table width="87%" border="0" cellpadding="1" cellspacing="1" bgcolor="#F4D284">
      <tr bgcolor="#006699"> 
        <td height="20" bgcolor="#6666CC"><div align="center"><strong><font color="#FFFFFF" size="4">Novedades 
            Productos Intermedios</font></strong></div></td>
