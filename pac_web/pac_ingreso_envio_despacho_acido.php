...
{
	var Frm=document.FrmIngEnvioDespAcido;
	var Valores="";
...
function MostrarPopupProceso(Proceso)
{
	...
	{
		case "N":
			window.open("pac_ingreso_envio_despacho_acido_proceso.php?Proceso="+Proceso,"","top=110,left=140,width=520,height=330,scrollbars=no,resizable = no");
			break;
		case "M":
			if (SeleccionoCheck()) 
			{
				if (SoloUnElementoCheck())
				{
					...
					window.open("pac_ingreso_envio_despacho_acido_proceso.php?Proceso="+Proceso+"&Valores="+Valores,"","top=110,left=140,width=520,height=330,scrollbars=no,resizable = no");		
				}	
			}	
			break;
		case "E":
			if (SeleccionoCheck()) 
			{
				...
				{
					Valores=RecuperarValoresCheckeado();
					Frm.action="pac_ingreso_envio_despacho_acido_proceso01.php?Proceso="+Proceso+"&Valores="+Valores;
					Frm.submit();
				}			
			}	
			break;	
...
<title>Ingreso Envio a Despacho de Acido</title>
<link href="../principal/estilos/css_cal_web.css" type="text/css" rel="stylesheet">
<body leftmargin="3" topmargin="5" marginwidth="0" marginheight="0">
<form name="FrmIngEnvioDespAcido" method="post" action="">
    ...
    <tr> 
      <td align="center" valign="top"><br> 
        <?php
			...
			echo "<td width='50' align='center'>EK</td>";
			...
			$Consulta = $Consulta." inner join proyecto_modernizacion.sub_clase t4 on t1.tipo_movimiento=t4.cod_subclase and t4.cod_clase=9000 and t4.cod_subclase=3 order by fecha_hora";
