...
function MostrarPopupProceso(Proceso)
{
	...
	{
		case "N":
			window.open("pac_guia_despacho_proceso.php?Proceso="+Proceso +"&Ver=C","","top=60,left=0,width=760,height=480,scrollbars=yes,resizable = yes");
			break;
		case "M":
			if (SeleccionoCheck()) 
			{
				if (SoloUnElementoCheck())
				{
					...
					window.open("pac_guia_despacho_proceso.php?Proceso="+Proceso +"&Valores="+Valores,"","top=60,left=0,width=760,height=480,scrollbars=yes,resizable = yes");
				}	
			}	
			break;
		case "A":
