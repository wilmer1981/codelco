...
function Grabar(Proceso,Valores,FechaHora)
{
	...
	/*if (Frm.CmbHora.value > Frm.CmbHoraFinal.value)
	{
	...
	if (Frm.CmbHora.value == Frm.CmbHoraFinal.value)
	{
		if (Frm.CmbMinuto.value>Frm.CmbMinutoFinal.value)
		{
	...
	{
		alert("Debe Seleccionar Estanque Destino")
		Frm.CmbEstanqueDestino.focus();
		return;
	}
	if (Frm.CmbEstanqueOrigen.value == Frm.CmbEstanqueDestino.value )
	{
		alert("Estanque Origen debe ser distinto a Estanque Destino")
		Frm.CmbEstanqueDestino.focus();
		return;
	}
	...
	Frm.action="pac_recepcion_envio_acido_pta_acido_proceso01.php?Proceso="+Proceso+"&Valores="+Valores+"&FechaHora="+FechaHora;
	Frm.submit();						
...
<form name="FrmProceso" method="post" action="">
  <table width="510" height="157" border="0" cellpadding="5" cellspacing="0" class="TablaPrincipal" left="5">
    ...
    <td><table width="500" border="0" cellpadding="5" class="TablaInterior">
          <tr> 
            <td width="113">Fecha Inicio</td>
            <td width="361"><font size="1"> 
              <?php
				if ($Proceso=="M")
				{
					echo $FechaHora;
          ...
          <tr> 
            ...
            <td><font size="1"><font size="1"> 
              <?php
					echo "<select name='CmbDiaT' id='select7' size='1' style='width:40px;'>";
					for ($i=1;$i<=31;$i++)
					{
						if (isset($CmbDiasT))
						{
  				  ...
  				  echo "</select>";
				  echo "<select name='CmbMesT' size='1' style='width:90px;'>";
				  for($i=1;$i<13;$i++)
				  {
						if (isset($CmbMesT))
						{
				   ...
				   echo "</select>";
  				   echo "<select name='CmbAnoT' size='1' style='width:70px;'>";
					for ($i=date("Y")-1;$i<=date("Y")+1;$i++)
					{
						if (isset($CmbAnoT))
						{
          ...
          <tr> 
            ...
            <td> 
              <?php	
				...
				$Consulta ="select * from proyecto_modernizacion.sub_clase where cod_clase=9001";
				$Respuesta=mysqli_query($link, $Consulta);
