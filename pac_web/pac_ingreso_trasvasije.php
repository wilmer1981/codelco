...
{
	var Frm=document.FrmIngTrasvasije;
	var Valores="";
...
function MostrarPopupProceso(Proceso)
{
	...
	{
		case "N":
			window.open("pac_ingreso_trasvasije_proceso.php?Proceso="+Proceso,"","top=110,left=140,width=520,height=290,scrollbars=no,resizable = no");
			break;
		case "M":
			if (SeleccionoCheck()) 
			{
				if (SoloUnElementoCheck())
				{
					...
					window.open("pac_ingreso_trasvasije_proceso.php?Proceso="+Proceso+"&Valores="+Valores,"","top=110,left=140,width=520,height=290,scrollbars=no,resizable = no");		
				}	
			}	
			break;
		case "E":
			if (SeleccionoCheck()) 
			{
				...
				{
					Valores=RecuperarValoresCheckeado();
					Frm.action="pac_ingreso_trasvasije_proceso01.php?Proceso="+Proceso+"&Valores="+Valores;
					Frm.submit();
				}			
			}	
			break;	
...
<title>Ingreso Trasvasije</title>
<link href="../principal/estilos/css_cal_web.css" type="text/css" rel="stylesheet">
<body leftmargin="3" topmargin="5" marginwidth="0" marginheight="0">
<form name="FrmIngTrasvasije" method="post" action="">
    ...
    <tr> 
      <td align="center" valign="top"><br> 
        <?php
			...
			echo "<td width='90' align='left'>Cant(Ton)</td>";
			echo "<td width='50' align='left'>EK Orig</td>";
			echo "<td width='50' align='left'>EK Dest</td>";
			echo "<td width='90' align='left'>Operario</td>";
			//echo "<td width='70' align='center'>Tipo Mov.</td>";
			echo "</tr>";
			$Consulta = "select t1.fecha_hora,t1.toneladas,t2.nombre_subclase as estanque_origen,t5.nombre_subclase as estanque_destino,t3.valor_subclase1 as operario,t4.nombre_subclase as movimiento " ;
			...
			$Consulta = $Consulta." inner join proyecto_modernizacion.sub_clase t4 on t1.tipo_movimiento=t4.cod_subclase and t4.cod_clase=9000 and t4.cod_subclase=4 order by fecha_hora";
			...
			while ($Fila=mysqli_fetch_array($Resultado))
			{
				...
				echo "<td width='90' align='rigth'>".str_replace(".",",",$Fila["toneladas"])."</td>";
				echo "<td width='50' align='left'>".$Fila["estanque_origen"]."</td>";
				echo "<td width='50' align='left'>".$Fila["estanque_destino"]."</td>";
				echo "<td width='90' align='left'>".$Fila["operario"]."</td>";
				//echo "<td width='70' align='right'>".$Fila["movimiento"]."</td>";				
				echo "</tr>";
			}
			echo "</table>";
		?>
