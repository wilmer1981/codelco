...
//ESTE ES EL CODIGO PARA CODBAR 39
function EAN13($x, $y, $barcode, $h=15, $w=.65)
{
    $this->Barcode($x,$y,$barcode,$h,$w,13);
}
function EAN10($x, $y, $barcode, $h=5, $w=.30)
{
    $this->Barcode($x,$y,$barcode,$h,$w,13);
}
...
function Code39_v2($xpos, $ypos, $code, $baseline=0.5, $height=5){
