...
function MostrarPopupProceso(Proceso)
{
	...
	{
		case "N":
			window.open("pac_ingreso_clientes_proceso.php?Proceso="+Proceso,"","top=110,left=180,width=610,height=430,scrollbars=no,resizable = no");
			break;
		case "M":
			if (SeleccionoCheck()) 
			{
				if (SoloUnElementoCheck())
				{
					...
					window.open("pac_ingreso_clientes_proceso.php?Proceso="+Proceso+"&Valores="+Valores,"","top=110,left=180,width=610,height=430,scrollbars=no,resizable = no");		
				}	
			}	
			break;
		case "E":
			if (SeleccionoCheck()) 
			{
				...
				{
					Valores=RecuperarValoresCheckeado();
					Frm.action="pac_ingreso_clientes_proceso01.php?Proceso="+Proceso+"&Valores="+Valores;
					Frm.submit();
				}			
			}	
			break;	
    ...
    <tr> 
      <td align="center" valign="top"><br> 
        <?php
			...
			echo "<td width='50' align='left'>Referencia</td>";
			echo "<td width='150' align='left'>Nombre</td>";
			echo "<td width='150' align='left'>Direcci&oacute;n</td>";
			echo "<td width='60' align='left'>Ciudad</td>";
			echo "<td width='60' align='center'>Telefonos</td>";
			echo "<td width='60' align='center'>Fax</td>";
			echo "<td width='60' align='center'>Precio</td>";
			echo "<td width='60' align='center'>Divisi&oacuten&nbspSAP</td>";
			echo "<td width='60' align='center'>Almac&eacuten&nbspSAP</td>";
			echo "<td width='160' align='center'>Giro Clientes</td>";
			echo "<td width='250' align='center'>Contrato</td>";
			echo "<td width='180' align='center'>Indicador de Traslado</td>";
			echo "</tr>";
			$Consulta = "select * from pac_web.clientes order by nombre";
			$Resultado=mysqli_query($link, $Consulta);
			echo "<input type='hidden' name='CheckCliente'><input type='hidden' name ='TxtRutO'>";
			while ($Fila=mysqli_fetch_array($Resultado))
			{
				echo "<tr>"; 
				echo "<td align='left'><input type='checkbox' name='CheckCliente' value='checkbox'></td>";
				echo "<td width='90' align='right'>".$Fila["rut_cliente"]."<input type='hidden' name ='TxtRutO' value ='".$Fila["rut_cliente"]."~".$Fila["corr_interno_cliente"]."'></td>";
				echo "<td width='20' align='left'>".$Fila["referencia"]."</td>";
				...
				echo "<td width='60' align='right'>".$Fila["telefonos"]."&nbsp;</td>";
				echo "<td width='60' align='right'>".$Fila["fax"]."&nbsp;</td>";
				echo "<td width='60' align='right'>".$Fila["precio_us"]."&nbsp;</td>";
				echo "<td width='60' align='right'>".$Fila["div_sap"]."&nbsp;</td>";
				echo "<td width='60' align='right'>".$Fila["almacen_sap"]."&nbsp;</td>";
				echo "<td width='250' align='right'>".$Fila["giro_cliente"]."&nbsp;</td>";
				echo "<td width='60' align='right'>".$Fila["contrato"]."&nbsp;</td>";
