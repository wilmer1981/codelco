<?php
	...
	if ($proceso == "M") 
	 {	
		 ...
		 {
		    $muestra = "&produccion_mfci=".$row1[txt_mfci1]."&produccion_mdb=".$row1[txt_mdb1]."&produccion_mco=".$row1[txt_mco1]."&observacion=".$row1[txt_observacion1]."&txt_rechazo_cat_ini_a=".$row1[rechazo_cat_ini_turno]."&txt_rechazo_lam_ini_a=".$row1[rechazo_lam_ini_turno]."&txt_catodos_en_renovacion_a=".$row1[catodos_en_renovacion_turno]."";
		 }
		    if(($txt_mfci1 <> '') or ($txt_mdb1 <> '') or ($txt_mco1 <> ''))
			{
