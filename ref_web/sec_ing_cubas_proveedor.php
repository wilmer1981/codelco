...
{
    var  f=document.frm1;
	var URL ="../ref_web/Informe_proveedor.php?";
    window.open(URL,"","menubar=no resizable=no top=50 left=200 width=800 height=500 scrollbars=yes");
...
<table width="500" border="0" cellspacing="0" cellpadding="3" class="TablaDetalle">
  ...
  <tr>
	...
	<?php
		if ($recargapag1 == "S")
		{
			$consulta = "SELECT distinct cod_grupo FROM ref_web.grupo_electrolitico2";
  ...
  <tr>
	...
	<?php
		if ($recargapag2 == "S") 
		{	
			$consulta = "SELECT distinct cod_grupo,num_cubas_tot FROM ref_web.grupo_electrolitico2";
...
<table width="500" border="0" cellspacing="0" cellpadding="3" class="TablaDetalle">
  <tr>
    <td align="center"><input name="btngrabar" type="button" value="Grabar" style="width=70" onClick="Grabar(this.form)">
              ...
              <input name="btnsalir" type="button" value="Salir" style="width=70" onClick="Salir()">
              <input name="btnlistar" type="button" value="Listar Proveedores " style="width=120" onClick="Listado()"></td>
  </tr>
</table>
