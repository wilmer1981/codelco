...
function Eliminar(cod_novedad)
{
	...
	{
	  f.action = "ing_general_jefe_pte01.php?cod_novedad=" + cod_novedad;
	  f.submit();
	}  
}
function Imprimir()
        ...
        <TD colSpan=6 bgcolor="#0066CC"> 
         <TABLE width="100%" border=0 cellPadding=2 cellSpacing=2>
          <TBODY>
           ...
           <?php
                 $consulta ="select t1.COD_NOVEDAD,t1.NOVEDAD,T1.FECHA,T1.TURNO, t1.usuario,t2.valor_subclase1 ";
                 $consulta .="from ref_web.novedades_jefe_pte as t1 ";
         ...
         <TABLE width="100%" border=0 cellPadding=2 cellSpacing=2>
            <TBODY>
              <TR class=lcol> 
                ...
                <TD width="15%"><font size="6"><strong>FECHA EMISION</strong></font></TD>
              ...
              <?php
                 $consulta ="select t1.COD_NOVEDAD,t1.NOVEDAD,t1.usuario,T1.TURNO,t1.compromiso,t1.area,t1.Condicion_insegura,t2.valor_subclase1 ";
                 $consulta .="from ref_web.novedades_jefe_pte as t1 ";
                 $consulta .="inner join proyecto_modernizacion.sub_clase as t2 "; 
                 $consulta .="on t1.TURNO=t2.nombre_subclase and t2.cod_clase = '1' ";
                // $consulta .="WHERE fecha = '".$fecha."' and mantencion in ('S') and estado='1'"; 
				 $consulta .="WHERE  mantencion in ('S') and estado='1'"; //PENDIENTES HASTA QUE SEAN REALIZADAS
                ...
                if(!$row = mysqli_fetch_array($respuesta))
                   {
                      ...
                      while($row = mysqli_fetch_array($respuesta))
						...
						else
						{
							...
							//$condicion =' ';
							//echo'<td> <div align="center"><B>'.$condicion.'<img src="archivos/'.$ico.'" width="12"></B></div></td>';
						}
         ...
         <TABLE width="100%" border=0 cellPadding=2 cellSpacing=2>
            <TBODY>
              <TR class=lcol> 
                ...
                <TD width="32%"><div align="center"><font size="6"><strong>OBSERVACIONES</strong></font></div></TD>
              </TR>
              <?php
