...
function Proceso(opt)
{
	...
	switch (opt)
	{
		...
		case "E":
			f.action ="ref_ponderados2_excel.php";
			f.submit();
			break;
...
<br>
      <table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
			<td align="center"> <input name="btnexcel" type="button" style="width:70" onClick="JavaScript:Proceso('E')" value="Excel"> 
