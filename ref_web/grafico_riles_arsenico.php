<?phpphp
   include("../principal/conectar_ref_web.php");
	...
	$consulta.="and t2.cod_leyes in ('08') ";
...
#grey color (0xc0c0c0)
$c->setPlotArea(55, 45, 680, 650, 0xffffff, -1, -1, 0xc0c0c0, -1);
...
#border.
$titleObj = $c->addTitle("Grafico Analisis de As Riles (Ultimos 15 dias)", "arialbi.ttf", 11, 0xffffff);
$titleObj->setBackground(0x800000, -1, 1);

#Add a title to the y axis
$c->yAxis->setLinearScale(0, 400, 10);
