         ...
         <TR> 
          ...
          <TABLE border=0  class=hdrtbl  cellPadding=0 cellSpacing=0 width=100%>
              <TR> 
                ...
                <TD width="42" align=middle  class=<?php echo $seleccionado15; ?>><font color="#3366FF"><A class=tabstext href="Inicio_jt_poly.php?pagina=15&amp;  fecha=<?php echo $fecha; ?>"><B >Informaci�n</B></A></font></TD>
				<TD width="7"  align=middle  class=tabsoff> <IMG alt="" border=0 height=40 src="archivos/<?php echo $ImgInt9; ?>" width=7></TD>
                <TD width="42"  align=middle  class=<?php echo $seleccionado16; ?>><font color="#3366FF"><A class=tabstext href="Inicio_jt_poly.php?pagina=16&amp;  fecha=<?php echo $fecha; ?>"><B >Gruas</B></A></font></TD>
          ...
          <TABLE border=1 cellPadding=3  class=hdrtbl  width=100%>
              <TR> 
				...
				<INPUT name=buscar3 onclick=JavaScript:Recarga(document.FrmPrincipal,'Inicio_jt_poly.php?pagina=<?php echo $pagina; ?>') type=button value=Buscar>
				...
				<TD width=300 align="left"><strong>Consulta :</strong>
					<INPUT name=buscar23 onclick=JavaScript:Recarga_fecha_anterior(document.FrmPrincipal,'Inicio_jt_poly.php?pagina=<?phpphp echo $pagina; ?>','<?phpphp echo $fecha_atras; ?>') type=button value="<< Anterior">
                	<INPUT name=buscar222 onclick=JavaScript:Recarga_fecha_siguiente(document.FrmPrincipal,'Inicio_jt_poly.php?pagina=<?phpphp echo $pagina; ?>','<?phpphp echo $fecha_adelante; ?>') type=button value="Siguiente>>" >
				</TD>
              </TR>
          </TABLE>
