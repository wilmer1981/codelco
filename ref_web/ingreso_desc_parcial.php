...
<html>
<head>
<title>Ingreso Descobrizacion Parcial</title>
...
function Agregar(f,fecha)
{
	...
	f.action = "ingreso_desc_parcial.php?" + linea+"&fecha="+fecha;
	f.submit();
}
/*******************/
function Grabar()
...
function Limpiar()
{
	document.location = "ingreso_desc_parcial.php";
}
/******************/
...
function Buscar(f)
{
	f.action = "proceso_dp.php?buscar=S&txtbuscar=" + f.txtbuscar.value;
	f.submit();
}
</script>
</head>
    ...
    <td width="762" align="center" valign="middle"> <br>
      <table width="506" height="10" border="0" align="center" cellpadding="5" cellspacing="0" class="TablaPrincipal">
	     <tr class="ColorTabla01"> 
            <td align="center" >Ingreso de Traspasos a descobrizaci�n Parcial</td>
        </tr>
        <tr> 
      ...
      <?php
		...
		?>
		      <td width="63">
			   <!-- <td colspan="4"><select name="cmbturno" onChange="JavaScript:BuscarRechazo(this.form)"> 
              ...
              <table width="498" border="0" cellspacing="0" cellpadding="3" class="tablainterior">
                <tr> 
                  <td width="489" height="29" align="center"> <div align="center">&nbsp; 
                      ...
                      <font face="Arial, Helvetica, sans-serif"> </font> 
                      <input name="btngrabar2" type="button" value="Grabar" style="width:60" onClick="JavaScript:Grabar()">
