							        ...
							        while (list($c,$v)=each($cod_leyes))
								          {
											...
											$Consulta_electrolitos=$Consulta_electrolitos."where t1.id_muestra='$b' and t1.cod_producto='41' and left(t1.fecha_hora,10)='".$Fila_fecha[fecha2]."' and t1.cod_leyes='$v'";
						 ...
						 while (list($a,$b)=each($HM))
						 	{ 
							   ...
							   $Fila_fecha = mysqli_fetch_array($Respuesta_fecha);
								...
								$Consulta_hm=$Consulta_hm."where t1.id_muestra='$b' and t1.cod_producto='41' and left(t1.fecha_hora,10)='".$Fila_fecha[fecha2]."'";
						 ...
						 while (list($a,$b)=each($e100))
						 	{
								...
								$Consulta_e=$Consulta_e."where t1.id_muestra='$b' and t1.cod_producto='41' and left(t1.fecha_hora,10)='".$Fila_fecha[fecha2]."'";
						      			...
						      			while (list($c,$v)=each($cod_leyes))
							   				{
												...
												$Consulta_v=$Consulta_v."where t1.id_muestra='$idmuestra' and t1.cod_producto='41' and left(t1.fecha_hora,10)='".$Fila_fecha[fecha2]."' and t1.cod_leyes='$v'";
