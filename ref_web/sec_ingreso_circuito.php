...
function Proceso(f,opc)
{
	...
	window.open("sec_ingreso_circuito_proceso.php?"+linea,"","top=195,left=160,width=410,height=223,scrollbars=no,resizable = no");
}
/*****************/
function Eliminar(f)
{
	...
	else
	{
		...
		{
			f.action = "sec_ingreso_circuito_proceso01.php?proceso=E&parametros=" + valores;
			f.submit();
		}
	}
}
  ...
  <tr>
	  ...
	  <table width="700" border="0" cellpadding="0" cellspacing="0" bordercolor="#b26c4a" class="TablaDetalle">
          <tr class="ColorTabla01"> 
            <td width="72"><input type="checkbox" name="checkbox" value="" onClick="SeleccionarTodos(this.form)">
              Todos</td>
            <td width="86" align="center">Cod. Circuito</td>
            <td width="206" align="left">Descripcion Circuito</td>
            <td width="59" align="center">Nros. de Grupos</td>
            <td width="81" align="center">Nros de Celdas Grupo</td>
            <td width="72" align="center">Rectificador</td>
            <td width="66" align="center">Nave</td>
          </tr>
        </table>
		<?php
			echo '<table width="700" border="0" cellpadding="0" cellspacing="0" class="TablaDetalle">';
