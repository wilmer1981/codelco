...
{ var f=document.frmPrincipal;
  ...
  if (TextoSelec=='')
     {alert('Debe selecionar Ley');}
  else{f.action = "ref_proceso_informe_impurezas.php?cmbleyes="+TextoSelec+"&proceso="+proceso+"&AnoIni="+AnoIni+"&MesIni="+MesIni+"&DiaIni="+DiaIni+"&AnoFin="+AnoFin+"&MesFin="+MesFin+"&DiaFin="+DiaFin+"&cmbcircuito="+cmbcircuito;} 
  f.submit();
...
function Buscar()
{
	...
	if (cmbcircuito=='-1')
	{
	   alert('Debe Selecionar Circuito');
	}
	else
	{
		if (cmbcircuito=='GB')
		...
		{
			f.action="ref_informe_impurezas.php?mostrar=S"+"&limpiar=N"+"&AnoIni="+AnoIni+"&MesIni="+MesIni+"&DiaIni="+DiaIni+"&AnoFin="+AnoFin+"&MesFin="+MesFin+"&DiaFin="+DiaFin+"&cmbcircuito="+cmbcircuito;;
	    	f.submit();
		}
	}   
