...
function Guardar(f,cod_novedad)
{
	...
	Mensaje = confirm("Esta Seguro de la Operacion");
        ...
        else
        {
				...
				f.action = "ing_general_jefe_hm01.php?Proceso=G"+"&cod_novedad="+cod_novedad+"&mantencion="+Mantencion+"&Condicion_insegura="+Condicion_insegura;
				f.submit();
	    }
}
function salir() // RECARGA PAGINA DE FROMULARIO
{
	...
	frm.action = "general_jefe_hm.php";
	frm.submit();
}
      ...
      <TD style="BACKGROUND-REPEAT: repeat-x" background="archivos/bg_grad3.gif" bgColor=#d7dce8> <TABLE id=tbl cellSpacing=0 cellPadding=0 width="100%"                   border=0>
        <TR> 
		  ...
		  <TABLE cellSpacing=0 cellPadding=0 width="86%" border=0>
                ...
                <TR> 
                  <TD width="2">&nbsp;</TD>
                  <TD width="46"><b><FONT size="1" style="FONT-WEIGHT: bold; COLOR: #000000">TURNO:</FONT><font face="Arial, Helvetica, sans-serif"> 
                    </font></b></TD>
                  <TD width="121"> 
                    <?php
	if (!isset($cmbturno))
		...
		if ($Fila = mysqli_fetch_array($Respuesta))
			$cmbturno = $Fila["turno"];
			 ...
			 ?>
                  ...
                  <TD width="231"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><FONT size="1" style="FONT-WEIGHT: bold; COLOR: #000000">FECHA 
                    :&nbsp;&nbsp;&nbsp;
                    <?phpphp  echo $fecha; ?>
                    </FONT></b></b> </TD>
                              ...
                              <TD> <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                                  ...
                                  <TR> 
                                    <TD width="100%" colSpan=3> <TABLE style="BORDER-RIGHT: #6b8ec6 1px solid; BORDER-LEFT: #6b8ec6 1px solid"  cellSpacing=0 cellPadding=0 width="100%"  border=0>
                                        <TR> 
                                          <TD width="0%">&nbsp; </TD>
                                          <TD width="2%"><div align="center"><IMG height=1 src="archivos/spaceit.gif" width=10 border=0></div></TD>
                                          <TD width="60%"><p><FONT style="FONT-WEIGHT: bold; COLOR: #000000">Observaciones:</FONT></p>
                                            <p align="center"> 
