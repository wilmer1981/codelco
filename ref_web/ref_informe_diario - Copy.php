...
function ObtenerKAHEfect($Grupo,$FechaCons)
{
	//echo $FechaCons."<br>";
	$FechaSep=explode('-',$FechaCons);
	$FechaIniTurno =date("Y-m-d", mktime(1,0,0,$FechaSep[1],$FechaSep[2]-10,$FechaSep[0]));
	$FechaIniTurno2 =date("Y-m-d", mktime(1,0,0,$FechaSep[1],$FechaSep[2]-8,$FechaSep[0]));	
	$FechaFinTurno =date("Y-m-d", mktime(1,0,0,$FechaSep[1],$FechaSep[2]-1,$FechaSep[0]));
...
function ObtenerTpoDescXRenov($Grupo,$FechaCons,$Tipo)//TIPO:A FECHA ACTUAL , B 8 DIAS ANTES
{
	...
	{
		$FechaIniTurno =date("Y-m-d", mktime(1,0,0,$FechaSep[1],$FechaSep[2]-9,$FechaSep[0]));	
...
function ObtenerTpoRealConex($Grupo,$FechaCons)
{
	...
	$FechaSep=explode('-',$FechaCons);
	$FechaIniTurnoD =date("Y-m-d", mktime(1,0,0,$FechaSep[1],$FechaSep[2]-10,$FechaSep[0]));	
...
function ObtenerTpoDescXParcial($Grupo,$FechaCons)
{
	$Valor=0;
	$FechaSep=explode('-',$FechaCons);
	$FechaIniTurnoD =date("Y-m-d", mktime(1,0,0,$FechaSep[1],$FechaSep[2]-9,$FechaSep[0]));	
	$FechaFinTurnoD =date("Y-m-d", mktime(1,0,0,$FechaSep[1],$FechaSep[2]-7,$FechaSep[0]));
	$FechaIniTurnoH =date("Y-m-d", mktime(1,0,0,$FechaSep[1],$FechaSep[2],$FechaSep[0]));	
	$FechaFinTurnoH =date("Y-m-d", mktime(1,0,0,$FechaSep[1],$FechaSep[2]+1,$FechaSep[0]));
