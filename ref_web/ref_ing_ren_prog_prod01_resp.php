<?php
	...
	header("location:ref_ing_ren_prog_prod_res.php?Proceso=M&Dia=".intval($Dia)."&Mes=".intval($Mes)."&Ano=".intval($Ano));
		echo "<script languaje='JavaScript'>";
		echo "window.opener.document.frmPrincipal.action = 'Renovacion_grupos_resp.php?opcion=H';";
