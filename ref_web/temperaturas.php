       ...
       if ($turno<>'Todo') 
		{
		  ...
		  echo'<TD width="5%" ><div align="center"><B>'.$row[TEMP17].'</B></div></TD>';
		  echo'<TD width="5%" ><div align="center"><B>'.$row[TEMP18].'</B></div></TD>';
		  ...
		  $promedio17 = $row[TEMP17]+$row2[TEMP17]+$row3[TEMP17];
		  $promedio18 = $row[TEMP18]+$row2[TEMP18]+$row3[TEMP18];
          $i=3;
				   ...
				   while ($fila_instante=mysqli_fetch_array($respuesta_instante))
					   {
					    ...
					    echo'<TD width="5%" class=lcol><div align="center"><B>'.$row[TEMP17].'</B></div></TD>';
					    echo'<TD width="5%" class=lcol><div align="center"><B>'.$row[TEMP18].'</B></div></TD>';
						...
						$suma17=$suma17+$row[TEMP17];
						$suma18=$suma18+$row[TEMP18];
						 $i=3;
