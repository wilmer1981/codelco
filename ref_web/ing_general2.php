...
function Guardar(f,cod_novedad)
{
	...
	Mensaje = confirm("Esta Seguro de la Operacion");
        ...
        {
			f.action = "ing_general01.php?Proceso=G"+"&cod_novedad="+cod_novedad+"&gerencia="+Gerencia+"&mantencion="+Mantencion;
			f.submit();
	    }
    //alert(Gerencia);
	//alert(Mantencion);		
		  ...
		  <TABLE cellSpacing=0 cellPadding=0 width="86%" border=0>
			 ...
			 ?>
				  ...
				  <?php if ($fila_codigo[mantencion]<>'')
				       { ?>
					     <td width="348" height="12"> <input type="checkbox" name="checkbox" value="<?php echo $fila_codigo[mantencion]; ?>" checked>  
					<?php }
					 else { ?>
					       <td width="348" height="12"> <input type="checkbox" name="checkbox" value="Mantencion" >
					   <?php } ?>
                ...
                <TR>
				  <?php if ($fila_codigo[gerencia]<>'')
				        { ?>
                         <td height="13"><input type="checkbox" name="checkbox2" value="<?php echo $fila_codigo[mantencion]; ?>" checked>
					  <?php }
					 else { ?>
					  	 <td height="13"><input type="checkbox" name="checkbox2" value="Gerencia">
					   <?php } ?>
                    Informe Gerencia</td>
                </TR>
                <TR> 
                                        ...
                                        <TR> 
                                          ...
                                          <TD width="63%"><p><FONT style="FONT-WEIGHT: bold; COLOR: #000000">Observaciones:</FONT></p>
                                           ...
                                           <?php if ($fila_codigo[mantencion]<>'')
                                            ...
                                            <p><strong>Area Mantencion</strong> 
                                            </p>
                                            <p> 
                                              <select name="Area" size="1" >
                                                <?php 
													...
													for ($i = 1;$i <= 4; $i++)
													{$obras=array('M.Mecanica','M.Instrumentista','M.Obras y Serv.','M.Electrica');
														if (isset($Area))
														{
															if ($Area == $i)
                                            ...
                                            <p> 
                                              ...
                                              <?php } 
                                                   ...
                                                   <TD width="15%"><p><IMG height=1 src="archivos/spaceit.gif" width=10 border=0></p>
										   	  <?php } ?>  
                                            </p></TD>
                                        </TR>
                                      </TABLE></TD>
