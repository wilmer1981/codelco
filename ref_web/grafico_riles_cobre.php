...
#border.
$titleObj = $c->addTitle("Grafico Analisis de Cu Riles (Ultimos 15 dias)", "arialbi.ttf", 11, 0xffffff);
$titleObj->setBackground(0x800000, -1, 1);

#Add a title to the y axis
$c->yAxis->setLinearScale(0, 120, 4);
...
$layer->addDataSet($data0, -1, "Cu");
$layer->addDataSet($data1, -1, "Valor ");
