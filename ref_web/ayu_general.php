...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
 <TR> 
   ...
   <TD align=middle bgColor=#6b8ec6><FONT style="FONT-WEIGHT: bold; FONT-SIZE: 11px; COLOR: #ffffff; FONT-FAMILY: Arial; LETTER-SPACING: 3px; TEXT-ALIGN: center; TEXT-DECORATION: none" size=3><strong>AYUDA 
       <!-- : NOVEDADES--></strong></FONT></TD>
        ...
        <TR> 
          ...
          <TR> 
            ...
            <TR> 
              ...
              <TD width="49%"><p>&nbsp;</p>
              <p align="center"><img alt="AYUDA" border=0 src="archivos/enconstruccion2.gif" width="100" height="150"></p>
              <p align="center"><strong><font color="#FF0000">En Construccion</font></strong></p></TD>
