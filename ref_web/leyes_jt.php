...
function Buscarant()
{
	...
	f.action='turno_b.php?mostrar=S&Ant=S';
	f.submit();
	//alert(f.dia1.value);
	//alert(f.mes1.value);
	//alert(f.ano1.value);	
...
function Buscarsig()
{
	...
	f.action='turno_b.php?mostrar=S&Sig=S';
	f.submit();
	//alert(f.dia1.value);
	//alert(f.mes1.value);
	//alert(f.ano1.value);	
...
<form action="" method="post" name="form1">
 ...
 <tr>
 	<td width="760" align="center" valign="middle">
 		<table width="750" border="0" cellpadding="3" class="TablaInterior"></table>
					...
					while ($Fila = mysqli_fetch_array($Respuesta))
					  {
						...
						else{$Consulta_fecha="select left(fecha_hora,10) as fecha2 from cal_web.solicitud_analisis ";
				        ...
				        if (($Fila["cod_grupo"]=='01') or ($Fila["cod_grupo"]=='02') or ($Fila["cod_grupo"]=='03') or ($Fila["cod_grupo"]=='04') or ($Fila["cod_grupo"]=='05') or ($Fila["cod_grupo"]=='06') or ($Fila["cod_grupo"]=='07') or ($Fila["cod_grupo"]=='08') or($Fila["cod_grupo"]=='09'))
						   {
    				        $Consulta_electrolitos="select  t1.valor as valor,t1.candado,t1.cod_unidad,t1.cod_leyes,signo from cal_web.leyes_por_solicitud as t1 ";
						...
						//echo "consulta".$Consulta_electrolitos;
					 ...
					 if ($mostrar == "S")
					   {
						 	...
						 	while ($Fila2 = mysqli_fetch_array($Respuesta2))
							  {
							   if ($Fila2["calculo"] >= $limites[$l])
						  	   ...
						  	   else echo "<td align='center'>".number_format($Fila2["calculo"],"",",","")."&nbsp</td>\n";
							   $l=$l+1;
							}
							echo "</tr>\n";
						}
						...
						?>
						    <tr> 
                  <td  colspan="12" align="center">Sin Grupo Electrol&iacute;tico</td>
                </tr>				
              ...
              <table width="87%" height="12" border="1" cellpadding="2">
                ...
                <?php  
					if ($mostrar == "S")
					{
						...
						$circuitos=array('1','2','3','4','5','6','DP','DT','RETORNO','G.49');
						reset($circuitos);
						foreach($circuitos as $a => $b)
							{
							  $Consulta_fecha="select left(fecha_hora,10) as fecha2 from cal_web.solicitud_analisis ";
                              $Consulta_fecha=$Consulta_fecha." where left(fecha_muestra,10)='".$fecha."' and ";
							  if($b=='G.49')
								  $Consulta_fecha=$Consulta_fecha." (id_muestra like '%49' and cod_producto = '41' and cod_subproducto = '22') ";
							  else
							  	  $Consulta_fecha=$Consulta_fecha." id_muestra='$b' and cod_producto='41'  ";  
							  ...
							  foreach($cod_leyes as $c => $v)
								 {
									...
									if($b=='G.49')
										$Consulta_electrolitos=$Consulta_electrolitos." where t2.id_muestra like '%49'and t1.cod_producto = '41' and t1.cod_subproducto='22'  ";
										
																						
									else
										$Consulta_electrolitos=$Consulta_electrolitos." where t2.id_muestra='$b' and  t2.cod_producto='41' ";  
									...
									$Consulta_electrolitos=$Consulta_electrolitos."  and left(t1.fecha_muestra,10)='".$fecha."' and t2.cod_leyes='$v' and t2.candado='1'";
