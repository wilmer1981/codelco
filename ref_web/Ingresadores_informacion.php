...
function Proceso(f,opc,fecha)
{
	...
	if (opc == 'G')
	{
		...
		for(i=5;i<=11;i++)
		{
			...
			//if (val_control < 10 || val_control > 25 || val_control ==0.00) poly 29-01-09 solicitado por rivillo
			if (val_control < 0 || val_control > 25) // || val_control ==0.00) poly 29-01-09 solicitado por rivillo
			
			{
				alert ("Valor fuera de Rango, debe estar entre 0 y 25");
...
<p>&nbsp;</p><form name="frmPopup" action="" method="post">
  <table width="76%" border="1" align="center">
    ...
    <tr>
      <td height="25" colspan="10"> <strong>Fecha Ingreso</strong>
	...
	?>
	 ...
	 ?>
          ...
          ?>
          <input type="button" name="TxtGrabar" value="Grabar" onClick="Proceso(this.form,'G','')&nbsp &nbsp">
</td>
    </tr>
    <tr>
      <td height="25" colspan="10"><span class="Estilo1"> &nbsp;</span></td>
    ...
    <tr class="ColorTabla02">
      <td width="54" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000">Rect. 1</font></td>
      <td width="62" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000">Rect. 2</font></td>
      <td width="69" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000">Rect. 3</font></td>
      <td width="69" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000">Rect. 4</font></td>
      <td width="63" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000">Rect. 5</font></td>
      <td width="63" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000"> Rect. 6</font></td>
	  <td width="89" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000"> Gru.49</font></td>
      <td width="112" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000"> Fecha Ultima Modif.</font></td>
      <td width="146" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000"> Jefe de Turno</font></td>
    </tr>			
...
?>
	<tr>
      <td align="center"> <input name="Txtrect1" type="text" id="Txtrect1"  value="<?php echo number_format($Txtrect1,1,',',''); ?>"  size="4" onKeyDown="TeclaPulsada1('Txtrect2')"  maxlength="4"></td>
      <td align="center"><input name="Txtrect2"  type="text" id="Txtrect22"  value="<?php echo number_format($Txtrect2,1,',',''); ?>"  size="4" onKeyDown="TeclaPulsada1('Txtrect3')" maxlength="4"></td>
      <td align="center"><input name="Txtrect3"  type="text" id="Txtrect3"  value="<?php echo number_format($Txtrect3,1,',',''); ?>" size="4" onKeyDown="TeclaPulsada1('Txtrect4')" maxlength="4" ></td>
      <td align="center"><input name="Txtrect4"  type="text" id="Txtrect4"  value="<?php echo number_format($Txtrect4,1,',',''); ?>"  size="4" onKeyDown="TeclaPulsada1('Txtrect5')" maxlength="4" ></td>
      <td align="center"><input name="Txtrect5"  type="text" id="Txtrect5"  value="<?php echo number_format($Txtrect5,1,',',''); ?>"  size="4" onKeyDown="TeclaPulsada1('Txtrect6')"maxlength="4" ></td>
      <td align="center"><input name="Txtrect6"  type="text" id="Txtrect6"  value="<?php echo number_format($Txtrect6,1,',',''); ?>"  size="4" onKeyDown="TeclaPulsada1('Txtgrupo49')"maxlength="4" ></td>
	  <td align="center"><input name="Txtgrupo49"  type="text" id="Txtgrupo49"  value="<?php echo number_format($Txtgrupo49,1,',',''); ?>"  size="4" onKeyDown="TeclaPulsada1('Txtcir1')"maxlength="4" ></td>
	 <?php
		if ($nombre=="")
		{
			$fecha1=$fecha_hoy;
    ...
    <tr class="ColorTabla02">
      <td width="54" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000">Cir. 1</font></td>
      <td width="62" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000">Cir. 2</font></td>
      <td width="69" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000">Cir. 3</font></td>
      <td width="69" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000">Cir. 4</font></td>
      <td width="63" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000">Cir. 5</font></td>
      <td width="40" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000"> Cir. 6</font></td>
	    <td width="67" align="center"> &nbsp;</span></td>
	  <td width="89" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000"> Fecha Ultima Modif.</font></td>
      <td width="112" align="center"><font style="FONT-WEIGHT: bold; COLOR: #000000"> Jefe de Turno</font></td>
	  </tr>
...
?>
    <tr>
      <td align="center"><input name="Txtcir1" type="text" id="Txtcir1" onKeyDown="TeclaPulsada1('Txtcir2')" value="<?php echo number_format($Txtcir1,0,'',''); ?>" size="4" maxlength="4"></td>
      <td align="center"><input name="Txtcir2" type="text" id="Txtcir2" onKeyDown="TeclaPulsada1('Txtcir3')" value="<?php echo number_format($Txtcir2,0,'',''); ?>" size="4" maxlength="4"></td>
      <td align="center"><input name="Txtcir3" type="text" id="Txtcir3" onKeyDown="TeclaPulsada1('Txtcir4')" value="<?php echo number_format($Txtcir3,0,'',''); ?>" size="4" maxlength="4" ></td>
      <td align="center"><input name="Txtcir4" type="text" id="Txtcir4" onKeyDown="TeclaPulsada1('Txtcir5')" value="<?php echo number_format($Txtcir4,0,'',''); ?>" size="4" maxlength="4" ></td>
      <td align="center"><input name="Txtcir5" type="text" id="Txtcir5" onKeyDown="TeclaPulsada1('Txtcir6')" value="<?php echo number_format($Txtcir5,0,'',''); ?>" size="4" maxlength="4" ></td>
      <td align="center"><input name="Txtcir6" type="text" id="Txtcir6" onKeyDown="TeclaPulsada1('TxtGrabar')" value="<?php echo number_format($Txtcir6,0,'',''); ?>" size="4" maxlength="4" ></td>
	 <?php
