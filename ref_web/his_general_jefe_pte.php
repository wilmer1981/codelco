...
function Buscar()
{
    ...
    f.action = "his_general_jefe_pte.php?buscar=S"+"&campo="+f.campo.value+"&fecha="+fecha;
	f.submit();
}
function Imprimir()
{
...
<TD vAlign=bottom> <H4><B>BUSCAR EN NOVEDADES </B></H4></TD>
<?php 
				...
				if($page=="")
				{
				 ...
				 $resultado=mysqli_query($link, $consulta);
				  while($row1 = mysqli_fetch_array($resultado))
                    ...
                    if($page != 1) { echo'<A href="his_general_jefe_pte.php?page='.($page - 1).'&buscar=S&fecha='.$fecha.'&campo='.$campo.'"><strong>&lt;&lt;&lt;</strong></A>&nbsp; &nbsp; &nbsp;'; }
                      $in = 1;
                    while($in <= $paginas)
                       {
                         if($in==$page)
                         ...
                         else
                         {
                           ...
                           echo '&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;<A href="his_general_jefe_pte.php?ingreso='.$ingreso.'&amp;page='.$in.'&buscar=S&fecha='.$fecha.'&campo='.$campo.'"><FONT class=tiny>'.$in.'</FONT></A>&nbsp;&nbsp;&nbsp;';

                           if($in==$paginas)
                           {
                             echo '&nbsp; &nbsp; &nbsp; <A href="his_general_jefe_pte.php?page='.($page + 1).'&buscar=S&fecha='.$fecha.'&campo='.$campo.'">&gt;&gt;&gt;</A>';
                           }
