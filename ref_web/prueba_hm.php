           ...
           <?php
			  if ($mostrar == "S")
			   {		   
				...
				echo "<td align='center' class=lcol><font color='blue'>".$row13[recuperado]."&nbsp</font></td>\n";
				if (($total_unidades==0) or ($total2==0))
				{$porc_tot_rec=0;
			 	}
				else {$porc_tot_rec=(($row13[recuperado]/$total_unidades)*100);};
 ...
 <TBODY>
      ...
      <table width="100%" height="53" border="0">
		...
		<?php 
		   ...
		   echo "<tr class=lcol>\n";
		   echo "<td align='center'>".$row["fecha"]."&nbsp</td>\n";
		   echo "<td align='center'>".$row[ajuste]."&nbsp</td>\n";
		   echo "<td align='center'>".$row["tipo"]."&nbsp</td>\n";
		   echo "</tr>\n";
