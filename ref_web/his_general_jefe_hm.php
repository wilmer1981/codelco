...
function Buscar()
{
    ...
    f.action = "his_general_jefe_hm.php?buscar=S"+"&campo="+f.campo.value+"&fecha="+fecha;
	f.submit();
}
function Imprimir()
{
				  ...
				  while($row1 = mysqli_fetch_array($resultado))
				    {
  					...
  					$sql="select * from ref_web.novedades_jefe_hm where fecha between '".$fecha."-01' and '".$fecha."-31'";
