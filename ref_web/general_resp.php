...
function Eliminar(cod_novedad)
{
	...
	{
	  f.action = "ing_general01.php?cod_novedad=" + cod_novedad;
	  f.submit();
	}  
}
function Imprimir()
...
function EliminarSelec()//MANTENCIONES PENDIENTES
{
	...
	else
	{
		...
		{
		  f.action = "ing_general01.php?Proceso2=E&ValoresElim="+ValoresElim+"&Marca="+MarcaAnt;
		  f.submit();
		}  		
	}
         ...
         <TABLE width="100%" border=0 cellPadding=2 cellSpacing=2>
            <TBODY>
              <TR class=lcol> 
				...
				<TD colspan="3"><div align="center"><font size="6"><strong><input type="button" name="BtnEliminar" value="Eliminar" onClick="EliminarSelec()"></strong></font></div></TD>
              </TR>
              <?php
                ...
                if(!$row = mysqli_fetch_array($respuesta))
                   {
                      ...
                      while($row = mysqli_fetch_array($respuesta))
						 ...
						 if ($condicion == 'S')
						{
						 ...
						 echo "<a href=\"JavaScript:Modificar('$fecha','$cod_novedad','$turno')\">";
						 echo '<img src="archivos/modificar.gif" width="15" height="15"></A></div></TD>';
 						 echo"<td><input type='checkbox' name='CheckElim' value='$cod_novedad'></td>";
						 echo'</TR>';
					    }
					}	
                //}
