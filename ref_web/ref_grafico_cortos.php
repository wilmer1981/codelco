<?php
   ...
   while ($row_fecha=mysqli_fetch_array($respuesta_fecha))
      { 
		...
		$consulta_datos.="where fecha ='".$row_fecha["fecha"]."' and cod_circuito='".$circuito."' ";
...
#grey color (0xc0c0c0)
$c->setPlotArea(55, 45, 820, 450, 0xffffff, -1, -1, 0xc0c0c0, -1);
...
#border.
$titleObj = $c->addTitle("Grafico Cortociruitos desde ".$fecha1." al ".$fecha2." Circuito N� ".$circuito."", "arialbi.ttf", 11, 0xffffff);
