...
<tr> 
	<td align="center" valign="top">
	  <p><b>C R E A C I O N  &nbsp;&nbsp;D E &nbsp;&nbsp;A S I G N A C I O N </b></p>
		...
		<tr>
		  <td>RUT PROVEEDOR</td>
		  <td><input type="text" name="rut" style="width:80px" value="<? echo $rut; ?>"></td>  
		</tr>
		<tr>
		  <td>ASIGNACION</td>
		  <td><input type="text" name="asigna" style="width:80px" value="<? echo $asigna; ?>"></td>
		</tr>
		<tr>
		  <td>ENTRADA</td>
		  <td><input type="text" name="entra" style="width:80px" value="<? echo $entra; ?>"></td>
		</tr>
		<tr>
		  <td>SALIDA</td>
		  <td><input type="text" name="sale" style="width:80px" value="<? echo $sale; ?>"></td>
		</tr>
	  </table>
	  <br>
	  <table width="320" border="1" cellspacing="0" cellpadding="0" class="TablaDetalle">
