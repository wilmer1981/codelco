...
<table width="600" border="1" align="center" cellpadding="3" cellspacing="0" class="TablaInterior">
  <tr>
    <td width="76">Informe</td>
    <td width="307"><? echo $TituloInforme; ?></td>
  </tr>
  <tr>
    <td>Periodo</td>
    <td><? echo $Periodo; ?></td>
  ...
  <tr>
    <td>Peso Olla </td>
    <td><? echo number_format($PesoBase,0,",","."); ?></td>
  </tr>
  <? 
	if ($TipoInforme == 1)
	{
...
<?  
	...
	echo "<tr align='center' bgcolor='#FF6600'>\n";
