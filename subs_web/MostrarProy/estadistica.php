...
<head>
	...
	<script language="JavaScript">
		...
		function popup_grafico(letra)
		{
			...
			<!------------------  Valor  UF por Año  ------------------------------------------------------------------->
			if (letra =="A"){
				window.open("graficos/graf_valor_uf.php",""," fullscreen=no,left=165,top=100,width=540,height=340,scrollbars=yes,resizable = no");
			}
			<!------------------  Nª de Accidentes por Centro de Costo  ------------------------------------------------------------------->
			if (letra =="B"){
				window.open("graficos/graf_acc_x_cc.php",""," fullscreen=no,left=165,top=100,width=600,height=360,scrollbars=yes,resizable = no");
			}
