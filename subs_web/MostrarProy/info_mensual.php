...
<head>
	...
	<!---------------------------------  FUNCIONES  -------------------------------->
		...
		{
			var f = document.form1;
			window.open("popup_registrar.php?&mes1="+f.mes1.value+"&ano1="+f.ano1.value+"&valor_uf="+f.valor_uf.value,""," fullscreen=no,left=250,top=200,width=250,height=208,scrollbars=yes,resizable = no");			
		}		
		<!-----------  Guardar U.F -------->		
		function guardar_uf()
		...
		{
			var f = document.form1;			
			window.open("popup_valor_uf.php",""," fullscreen=no,left=165,top=100,width=200,height=350,scrollbars=yes,resizable = no");	
		}
		<!----------- Proceso (Salir) -------->		
					...
					<tr> 
					  <td width="75">
					    ...
					    if ($muestra_fec_ini=='s'){// me muestra el mes actual con su valor para la primera vez que entra //
							$fecha_ingreso=date("Y")."-".date("m")."-01";							
							$muestra_fec_ini='n';
						} else {	
