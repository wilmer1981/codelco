...
<head>
	...
	<!---------------------------------  FUNCIONES  -------------------------------->
		...
		// Funcion que me permite abrir una ventana nueva para Listar los Valores (Afp o Isapre)
		{
			...
			//-----------  AFP  -------------------//
			if (letra =="A"){
				window.open("popup_afp.php","afp"," fullscreen=no,left=165,top=100,width=330,height=370,scrollbars=yes,resizable = no");
			}
			//-----------  ISAPRE  -------------------//
			if (letra =="I"){
				window.open("popup_isapre.php","isapre"," fullscreen=no,left=165,top=100,width=330,height=370,scrollbars=yes,resizable = no");
			}
		}
		<!-------- Proceso (Salir) ---------->
