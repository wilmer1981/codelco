...
function Proceso(opt,valor)
{
	...
	{
		case "DU":
			window.open("ing_usuario.php?Proceso=NS&Sistem=" + valor,"","top=50,left=30,width=600,height=450,scrollbars=yes,resizable = yes");					
			break;
		case "DN":
			window.open("ing_niveles.php?Proceso=NS&Sistem=" + valor,"","top=50,left=30,width=600,height=450,scrollbars=yes,resizable = yes");					
			break;
		case "NS":
