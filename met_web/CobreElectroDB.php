...
{	
	...
	{
		case "W":
			f.action="CobreElectroDB.php?buscarOPT=S" ;
			f.submit();
			break;
		case "E":
			f.action="CobreElectroDB_excel.php?buscarOPT=S" ;
			f.submit();
			break;
	}
      ...
      <table width="531" border="1" cellpadding="1" class="TablaDetalle">
		...
		$fechafinal=$ano."-"."12"."-31";
			while ($fechainicio <= $fechafinal)
			{
				...
				$consulta= "SELECT Sum(F_COBRE) AS SUMA FROM ENABAL_BASE WHERE ((FECHA BETWEEN '$fechaini' AND '$fechafin')  AND T_MOV=2 AND
				(N_FLUJO=171 Or N_FLUJO=125 Or N_FLUJO=126 Or N_FLUJO=235 or N_FLUJO=196 Or N_FLUJO=214 Or N_FLUJO=162 Or N_FLUJO=163))";
