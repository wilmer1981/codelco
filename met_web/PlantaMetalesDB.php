...
{
	var f=document.form1;
	f.action="PlantaMetalesDB.php?buscarOPT=S&txtflujo="+f.productos.value ;
	f.submit();
}
...
{	
	var f=document.form1;
	f.action="PlantaMetalesDB.php?buscarproOPT=S" ;
	f.submit();
}
</script>
<body>
...
<table width="770" height="330" border="0" class="TablaPrincipal">
  <tr>
    <td width="762" align="center" valign="top"><table width="747" height="123" border="1" align="center">
      <tr align="center" class="Detalle03">
        <td height="21" colspan="5"><strong>Flujos Historicos Planta de Metales Nobles</strong></td>
      </tr>
      <tr>
        <td width="109" height="22">N&uacute;mero de Flujo </td>
        <td colspan="2"><input name="txtflujo" type="text" id="txtflujo" size="2" value="<? echo $txtflujo;?>">
            <input name="Button" type="submit" id="Button" value="Buscar Producto" onClick="buscarpro()"></td>
        <td width="389" colspan="2"><select name="productos" onChange="Rescatar()">
            <?
		$sql1 = "SELECT DISTINCT NOM_PRODUCTO,N_FLUJO FROM enabalpmn_base ";
		if($txtflujo!='')
	...
	?>
      ...
      <tr>
        <td height="22" align="left">Tipo Movimiento: </td>
        <td width="146" colspan="-2"><select name="select2" size="1">
<?
	switch ($select2)
	{
		case "2":
...
?>		</td>
        <td width="75" colspan="-3" align="center"> Desde:</td>
        <td colspan="2"><input name="txtfecha3" type="text" value="<? echo $txtfecha3;?>" size="12">
            <img src="ico_cal.gif" alt="Pulse Aqui ParaSeleccionar Fecha" width="16" height="16" border="0" align="top" onClick="popFrame.fPopCalendar(txtfecha3,txtfecha3,popCal);return false"> </td>
      </tr>
      <tr>
        <td height="19">&nbsp;</td>
        <td colspan="-2">&nbsp;</td>
      ...
      <tr>
        <td height="22" colspan="5" align="center"><input name="BtnBusca" type="button" id="BtnBusca" onClick="Buscar('W')" value="Buscar">
	...
	?>
      ...
      <table width="700" border="1" class="TablaDetalle">
        <tr align="center" class="ColorTabla01">
          ...
          <td width="104">Peso Seco (Kg) </td>
          <td width="110">Fino Cobre (Kg) </td>
          <td width="93">Fino Plata (gr) </td>
          <td width="91">Fino Oro (gr) </td>
        </tr>
        <?
	if ($buscarOPT=="S")
	{	
